"""Turn a reviewed Science script workbook into a builder override file.

The workbook produced by tools/export-ehel-science-scripts.py flattens each
...
which underlying field each edit belongs to and records it in
    ...
    src/prototypes/ehel-academy/science/data/script-review.json

which tools/build-ehel-science-runtime.js applies on top of every rebuild. The
science data directory is generated, so reviewed prose has to live outside it
...
Usage:
    python tools/apply-ehel-science-script-review.py --workbook <reviewed.xlsx>
...
DEFAULT_OUT = SCIENCE / "data" / "script-review.json"

_spec = importlib.util.spec_from_file_location(
    "export_science_scripts", ROOT / "tools" / "export-ehel-science-scripts.py")
...
LAYOUTS: dict[str, list[tuple[str, str, str]]] = {
    ...
    "Reference:term": [("Science word", "term", "text"), ("Meaning", "meaning", "text")],
...
def main() -> None:
    ...
    for sheet in wb.sheetnames:
        ...
        if args.grades and grade not in args.grades:
            continue
        grade_dir = SCIENCE / f"grade-{grade}" / "data"
    ...
    payload = {
        "note": "Reviewer corrections applied over generated Science content by "
                "tools/build-ehel-science-runtime.js. Regenerate with "
                "tools/apply-ehel-science-script-review.py.",

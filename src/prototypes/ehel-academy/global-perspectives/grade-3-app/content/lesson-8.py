    ...
    "steps": [
        step("demo", "How the six skills grew", "\U0001F9E9", "Six skills", ["3Fv.01"],
             ...
             {"frames": [
                 ...
                 {"pic": "\U0001FA9E", "cap": "<b>Looking back.</b> How my ideas changed, and which kinds of activity helped me learn. This lesson.", "say": "Looking back. How my ideas changed, and which kinds of activity helped me learn. That is this lesson.", "sound": "tada"},
             ]},
        ...
        step("lookback", "What I learned, how my ideas changed, what helped", "\U0001FA9E", "I looked back", ["3Fv.01", "3Fl.01"],
        ...
        step("know", "Present what you learned", "\U0001F3A4", "Learning presenter", ["3Mi.01"],
             ...
             {"mode": "structured", "topic": "what I learned about finding things out", "tag": "findingout", "topicPic": "\U0001F50D",
              "slots": [slot("start", "Start", "Say what your talk is about"), slot("middle", "Middle", "Give what you learned"), slot("end", "End", "Say what you will do next, and finish")],
              "cards": [
                  ...
                  dict(tagged("I learned that a conclusion is a sentence the data proves", "findingout", "\U0001F4CA"), say="I learned that a conclusion is a sentence the data proves", part="middle"),
             ...
             {"asker": YASMIN,
              "rounds": [
                  {"ask": "What did Mr Bello think about dogs in the park, and what did Mrs Adams think?", "about": "the park views", "pic": "\U0001F415",
                   "opts": [tagged("He wanted leads; she wanted dogs to run free on the field.", "the park views"), tagged("They both wanted a fence.", "a fence"), tagged("I had toast.", "breakfast")],
                  ...
                  {"ask": "What is a strength and what is a limitation of your teamwork?", "about": "strengths", "pic": "\U0001F4AA",
                   "opts": [tagged("A strength is what I did well; a limitation is what took more than one go.", "strengths"), tagged("A strength is being tall.", "height"), tagged("My shoes are blue.", "shoes")],
                  ...
                  {"ask": "Do people who know the same facts always think the same?", "about": "thinking differently", "pic": "\U0001F4AD",
                   "opts": [tagged("No. They can know the same facts and still think different things.", "thinking differently"), tagged("Yes, always.", "always"), tagged("The sea is salty.", "the sea")],
        ...
        step("sort", "Which skill was it?", "\U0001F9E9", "Skill sorter", ["3Fv.01"],
             ...
             {"ask": "Which skill was this?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F4A1", "label": "suggesting CDs to scare the birds off the garden", "bin": "team", "why": "Bringing an idea to the team is working together."},
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star reflector", ["3Fv.01", "3Fl.01", "3Ap.01", "3Mi.01"],
             ...
             {"items": [
                 q("A question helps you understand a topic when…", "\U0001F9E0", "you cannot answer it yet and it is about how the topic works", ["everybody knows the answer", "it is about you", "it is short"], "Lesson one."),
                 q("What is a conclusion?", "\U0001F4A1", "a sentence the data proves", ["a guess", "an opinion", "a chart"], "Lesson three."),
                 ...
                 q("What is a limitation of your teamwork?", "\U0001F914", "something that took more than one go, or that you could do better", ["being the tallest", "a job you did not have", "something you did well"], "Lesson six."),
                 q("What are the three parts of a talk?", "\U0001F3A4", "start, middle, end", ["facts, facts, facts", "hello, goodbye", "loud, quiet"], "Lesson seven."),
                 q("Which kind of activity is counting at the gate?", "\U0001F440", "observing and measuring", ["presenting a talk", "reading a source", "listening"], "Looking and counting for yourself."),
                 q("Looking back at Stage 3 asks…", "\U0001FA9E", "what I learned, how my ideas changed, and what kind of activity helped", ["only what I liked", "nothing", "who won"], "Three parts."),
...
LESSON["lecture"] = [
    ...
    part("\U0001FA9E", "Looking back at Stage 3",
...
LESSON["words"] = [
    ...
    word("reflect", "\U0001FA9E", "To think back over what you did and what you learned.",

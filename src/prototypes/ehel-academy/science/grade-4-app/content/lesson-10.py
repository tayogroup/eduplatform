        ...
        step("questions", "Choose the equipment", "\U0001F9F0", "Right kit", ["4TWSc.03", "4Pe.03", "4Pe.04"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Which would you add to make a circuit switchable?", "\U0001F501", "a switch", ["another lamp"],
                   "A switch opens and closes the loop."),
                 q("Is a metal spoon likely to conduct?", "\U0001F944", "Yes", ["No"],
                   "Metals conduct. That is what the test keeps finding."),
              ],
              "extension": [
                 ...
                 q("Your test says a rubber band does not conduct. What have you learned about rubber, and what have you NOT?", "\U0001F9E4", "that it does not conduct - and nothing about whether it is strong, or safe, or waterproof", ["everything worth knowing about rubber", "nothing at all"],
                   "One test answers one question. It is silent about every other property."),
                 q("You want to compare how bright a lamp is with one cell and with two. What is hard about that?", "\U0001F50B", "brightness is hard to measure - you can only say brighter or dimmer by eye", ["nothing is hard about it", "you cannot use two cells at all"],
                   "Some things have no easy instrument. Saying so is better than inventing a number."),
              ]},
        ...
        step("questions", "Safe with electricity", "\u26A0\uFE0F", "Safety first", ["4TWSp.05"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Is a cell safe to hold in your hand?", "\U0001F50B", "Yes", ["No"],
                   "A class cell is safe. A wall socket is not."),
                 q("Should you tell an adult if a wire gets hot?", "\u26A0\uFE0F", "Yes", ["No"],
                   "Disconnect it and tell an adult straight away."),
              ],
              "extension": [
                 ...
                 q("A screwdriver with a plastic handle is safer than an all-metal one. Which property is doing the work?", "\U0001F527", "the plastic will not let electricity through to your hand", ["the plastic makes it easier to grip", "the metal shaft is the safe part"],
                   "Two materials in one tool, each chosen for the opposite job: metal to reach the screw, plastic to stop at your hand."),
                 q("A bird sits on a bare power line and is fine, and you must never touch one. What is different?", "\U0001F426", "the bird gives the electricity no loop to travel through", ["birds are immune to electricity", "the line is switched off for birds"],
                   "Electricity needs a complete path. The bird offers none; a person standing on the ground does."),
              ]},
        ...
        step("questions", "Circuit check", "✅", "Circuit check", ["4Pe.01", "4Pe.02", "4Pe.03", "4Pe.04"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Will a lamp light if one wire is disconnected?", "\U0001F4A1", "No", ["Yes"],
                   "The loop has to be complete all the way round."),
                 q("Is a wooden ruler a conductor?", "\U0001FAB5", "No", ["Yes"],
                   "Wood does not let electricity through, so the lamp stays dark."),
              ],
              "extension": [
                 ...
                 q("A torch stops working. The cell is new and the lamp is fine. What is left to check?", "\U0001F526", "the loop itself - a loose contact or a broken wire", ["nothing, the torch is finished", "the colour of the wires"],
                   "When the parts are good the fault is in the path between them."),
                 q("You replace your short wires with much longer ones. Does the lamp go dimmer?", "\U0001F50C", "no, not noticeably over that distance", ["yes, the electricity leaks out on the way", "yes, long wires use it up"],
                   "Electricity does not leak out of a wire or get used up travelling along it."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4Pe.01", "4Pe.02", "4Pe.03", "4Pe.04", "4TWSc.03"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Is a plastic-covered wire safe to hold?", "\U0001F50C", "Yes", ["No"],
                   "The plastic is an insulator, so the electricity stays in the metal inside."),
                 q("Is glass a conductor?", "\U0001FA9F", "No", ["Yes"],
                   "Glass is an insulator, like plastic and rubber."),
              ],
              "extension": [
                 ...
                 q("A mechanic looking for a break in a headlight circuit does not start by replacing the bulb. Why not?", "\U0001F527", "the break could be anywhere in the loop, so they test along it", ["bulbs never fail", "replacing the bulb always works"],
                   "Finding a fault means narrowing down where it can be, not swapping parts and hoping."),
                 q("Tap water is safe to drink and not pure. Which of those two facts matters near a circuit?", "\U0001F6B0", "that it is not pure, because what is dissolved in it conducts", ["that it is safe to drink", "neither one matters"],
                   "Safe to swallow and safe near electricity are two completely different questions."),
              ]},

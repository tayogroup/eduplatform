...
LESSON = {
    ...
    "steps": [
        step("explore", "Inside, outside, or no skeleton", "\U0001F9B4", "Skeleton kinds", ["4Bs.05", "4Bs.04"],
             "Not all animals have a skeleton like yours. Tap each kind.",
             explain(
                 ["Animals with a backbone are vertebrates. Animals without one are invertebrates.", "Some invertebrates have a hard skeleton on the outside. It covers the whole body. It has joints so it can bend. This is an exoskeleton."],
                 ...
                 ["Children think a snail's shell is a backbone, or an exoskeleton.", "A snail has no bones at all. Its shell is a house on its back. Its soft body comes out of it, so the shell does not cover the whole body. A snail is a soft invertebrate that carries a shell."],
                 ["Tap all three."]),
             {"items": [
                 {"pic": "\U0001F415", "label": "vertebrate", "sub": "a backbone inside", "say": "A vertebrate has a backbone. That is a spine of small bones inside its body. Mammals, birds, fish, reptiles and amphibians are all vertebrates. So are you."},
                 {"pic": "\U0001FAB1", "label": "soft body", "sub": "no backbone, no hard skeleton", "say": "Some invertebrates have a soft body. They have no backbone and no hard skeleton. Think of a worm, a slug, a jellyfish or an octopus. Most animals in the world are invertebrates."},
                 {"pic": "\U0001F980", "label": "exoskeleton", "sub": "a skeleton on the outside", "say": "Some invertebrates have an exoskeleton. It is a hard case over the whole outside of the body. It has joints so it can bend. Insects, crabs, spiders and woodlice have one. It protects them, and their muscles pull on it from inside. A snail's shell is not one. The snail's soft body comes out of it."},
             ], "need": 3,
              "then": {"ask": "A crab has a hard shell over its whole body and no bones inside. What is it?",
                       ...
                       "why": "It has no backbone, so it is an invertebrate. The hard case on the outside is an exoskeleton."}},
        ...
        step("sort", "Vertebrate, or invertebrate?", "\U0001F5C2️", "Backbone sort", ["4Bs.05", "4TWSc.01"],
             ...
             {"ask": "Vertebrate, or invertebrate?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F40C", "label": "snail", "bin": "invert", "why": "A snail has no bones. It is soft, and it carries a shell on its back."},
                  {"pic": "\U0001F988", "label": "shark", "bin": "vert", "why": "A shark has a backbone. It is bendy, not made of hard bone."},
                  ...
                  {"pic": "\U0001F41D", "label": "bee", "bin": "invert", "why": "A bee is an insect. It has an exoskeleton and no backbone."},
                  {"pic": "\U0001F99C", "label": "parrot", "bin": "vert", "why": "A bird has a backbone."},
                  {"pic": "\U0001FAB1", "label": "earthworm", "bin": "invert", "why": "A worm has no bones. It has no hard case either."},
              ]},
        ...
        step("key", "Use a key", "\U0001F511", "Key user", ["4TWSc.02", "4TWSc.01"],
             ...
             explain(
                 ...
                 ["Does it have legs? Yes: how many? No: does it have a shell?", "Answer from what you see. The key does the rest."],
             ...
             {"ask": "Follow the key. Answer each question about this creature.",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F577️", "label": "a creature with eight legs", "answer": "spider", "facts": {"legs": True, "six": False, "eight": True}, "why": "Eight legs: a spider. It is not an insect."},
        ...
        step("lookup", "Look it up: exoskeletons", "\U0001F4DA", "Shell facts", ["4TWSc.07", "4Bs.04"],
             ...
             {"source": {"title": "Living in a suit of armour",
                         "lines": ["An <b>exoskeleton</b> is a hard skeleton on the <b>outside</b> of the whole body. It has joints so it can bend. Insects, spiders, crabs and woodlice have one.",
                                   "It <b>protects</b> the soft body inside. The animal's muscles pull on it from the inside to move.",
                                   "An exoskeleton <b>cannot grow</b>. To get bigger, the animal must <b>shed</b> it. Then it grows a new, bigger one. This is called moulting.",
                                   "At first the new exoskeleton is soft. So the animal <b>hides</b>, because it is easy to eat.",
                                   "A crab can moult twenty times in its life. You may find a lobster's old shell on the beach. It is empty, but it looks just like the lobster."]},
              "items": [
        ...
        step("questions", "Skeleton check", "✅", "Skeleton check", ["4Bs.04", "4Bs.05", "4TWSc.02"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Does a snail have a backbone?", "\U0001F40C", "No", ["Yes"],
                   "A hard shell on the outside and no backbone inside. An invertebrate."),
                 q("Must a crab shed its case in order to grow?", "\U0001F980", "Yes", ["No"],
                   "The case cannot stretch, so a bigger one has to be grown underneath."),
              ],
              "extension": [
                 ...
                 q("Most of the animals on Earth are invertebrates. What does that tell you about backbones?", "\U0001F41D", "a backbone is one good answer to the problem, not the only one", ["backbones are a mistake of nature", "most animals are unfinished"],
                   "Insects, worms, snails and jellyfish all manage without one, in far greater numbers than we do."),
                 q("A key gets you to 'woodlouse' in four questions out of thousands of minibeasts. How?", "\U0001F50D", "each yes-or-no throws away a whole set at once", ["it checks every minibeast in turn, very fast", "it guesses and usually gets lucky"],
                   "Halving the possibilities four times leaves very few. That is why a key beats looking."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4Bs.04", "4Bs.05", "4TWSc.02", "4TWSc.07"],
             ...
             {"items": [
                 ...
                 q("Where are a crab's muscles?", "\U0001F980", "inside, pulling on the exoskeleton", ["outside, on top of the shell", "a crab has no muscles at all"], "Muscles pull on the hard case from inside."),
              ...
              "support": [
                 ...
                 q("Does a snail's shell count as a backbone?", "\U0001F40C", "No", ["Yes"],
                   "The shell is on the outside. A backbone is inside, and a snail has none."),
                 q("Can a crab's hard case stretch as the crab grows?", "\U0001F980", "No", ["Yes"],
                   "It cannot, which is why the crab has to shed it and grow a new one."),
              ],
              "extension": [
                 ...
                 q("A crab is soft and hides for days after moulting. What is the cost of an exoskeleton?", "\U0001F980", "it has to be shed to grow, and the animal is defenceless while the new one hardens", ["there is no cost at all", "it stops the crab eating for ever"],
                   "Every design has a price. A backbone grows with you; a case has to be replaced."),
                 q("You find a minibeast with a hard shell and no backbone. Which group, and how do you know?", "\U0001F41A", "an invertebrate - the shell is on the outside and there is nothing inside", ["a vertebrate, because it has hard parts", "you cannot tell at all"],
                   "Hard parts alone prove nothing. Where they are is what decides it."),
              ]},
...
LESSON["lecture"] = [
    ...
    part("\U0001FAB1", "Invertebrates",
         "A worm has no backbone. Neither does a slug, a jellyfish or an octopus. Animals without a backbone are invertebrates. Most animals in the world are invertebrates."),
    part("\U0001F980", "Exoskeletons",
         "Some invertebrates wear their skeleton on the outside. It is a hard case over the whole body, with joints. It is called an exoskeleton. Insects, spiders, crabs and woodlice have one. It protects them, and their muscles pull on it from inside. To grow, they have to shed it. A snail's shell is different. The snail's soft body comes out of it."),
    part("\U0001F511", "A key",
         "Scientists use a key to identify creatures. A key is a chain of yes-or-no questions. Does it have legs? Six of them? Wings? Each answer leads to the next question. At the end, the key names the creature."),
...
LESSON["home"] = [
    ...
    home("Backbone hunt", "Any animals you can see: pets, birds, a fish tank, a zoo, or pictures in a book",
         ["For each animal, decide: backbone or not?",
          "For the ones without, decide: a hard case over the whole body, or a soft body? A snail goes with the soft ones. It is soft, and it carries a shell.",
          "Make three lists."],

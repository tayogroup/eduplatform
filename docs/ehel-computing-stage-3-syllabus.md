# Stage 3 Computing — course syllabus

Narrative copy for the syllabus authoring form at
`local/hubredirect/syllabus.php`, for the Ehel Academy **Stage 3 Computing**
course (Grade 3; this subject labels its years *Stage*). Every figure is read
from `src/prototypes/ehel-academy/computing/grade-3/data/`.
...
3. **The narration is not in the repository.** 1421 clips are needed for
   this stage and 1421 are present on this machine — but
...
Stage 3 Computing is the year programs have to be readable by someone else — the first unit is *Making Programs Clear*. It follows **Cambridge Primary Computing 0672, Stage 3**.

Twelve units cover clarity in programs, how hardware and software work together, data, design, networks, storytelling, robots, music, secret messages and more.

Across the year: **12 units**, **79 learning outcomes**,
**60 concepts**, **26 code examples**, **96 hands-on activities**,
**76 practice questions**, **76 fluency questions**, **62 debugging
cases**, **37 e-safety notes**, **144 games** and **12 unit projects** — one
...
**debugging section** — a symptom, its cause and its fix, 62 of them across the
year — which teaches that finding the fault is part of the work rather than a
sign of failure. And every unit carries **e-safety notes**, 37 across the year,
...
> {{Teacher name}} supports Stage 3 Computing at {{school name}}. {{One or two
...
Before Unit 1 a learner sits the **Stage 3 Computing Placement Exam**: 28 questions, 28 marks, about 25 minutes. Attempts are unlimited and it is never a fail.
...
- **The tools each unit names.** 11 toolkit entries across the year point at
...
- **Self-assessment** — 79 *I can…* statements across the year, no marks.
...
- **Read the e-safety notes properly.** 37 across the year, inside the
...
**If a learner is struggling**, the placement check can be retaken at any time. Stage 2 Computing remains available for a learner who needs the ground under this one.
...
|---|---|---|---|---|---|---|
| 1 | Making Programs Clear | 6 | 5 | 3 | 8 | 3 |
| 2 | Hardware and Software Work Together | 6 | 5 | 0 | 8 | 3 |
| 3 | Be a Data Expert | 7 | 5 | 0 | 8 | 3 |
| 4 | Be a Designer | 6 | 5 | 4 | 8 | 3 |
| 5 | Networks Are Everywhere | 5 | 5 | 0 | 8 | 4 |
| 6 | Be a Storyteller | 8 | 5 | 4 | 8 | 3 |
| 7 | Computers and Robots | 7 | 5 | 1 | 8 | 3 |
| 8 | Be a Musician | 7 | 5 | 3 | 8 | 3 |
| 9 | Sending Secret Messages | 6 | 5 | 0 | 8 | 4 |
| 10 | Be a Game Developer | 7 | 5 | 8 | 8 | 3 |
| 11 | Be a Data Designer | 7 | 5 | 0 | 8 | 2 |
| 12 | Be a Problem Solver | 7 | 5 | 3 | 8 | 3 |
| | **Total** | **79** | **60** | **26** | **96** | **37** |

Varying between units: concepts (5), outcomes (5–8),
code examples (0–8), activities (8), e-safety notes
(2–4), debugging cases (3–6), practice (6–9)
...
Framework: Cambridge Primary Computing 0672, Stage 3.
Source audience: teacher-guide.
Narration: 1421/1421 clips present locally, 0 tracked in git.

Source: `course-manifest.json` and `units/unit-*.json` under
`src/prototypes/ehel-academy/computing/grade-3/data/`.

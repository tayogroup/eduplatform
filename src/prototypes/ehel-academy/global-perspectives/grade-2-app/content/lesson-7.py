    ...
    "steps": [
        ...
        step("listen", "Listen, then ask something relevant", "\U0001F442", "Relevant asker", ["2Ml.01"],
             ...
             {"rounds": [
                 ...
                 {"speaker": LEO, "talk": ["I moved here from a town by the sea.", "Every Saturday we went to the beach, even when it was cold.", "I miss the sound of the waves at night."],
                  "topics": ["sea", "beach", "waves"],
                  "opts": [tagged("What did you do at the beach when it was cold?", "beach"), tagged("What is your teddy called?", "toys"), tagged("Do you like maths?", "maths")],
                  "why": "Leo talked about going to the beach even in the cold, so a question about that is about what he said.",
                  "reply": "We threw stones in the waves and drank hot chocolate from a flask."},
             ]},
        ...
        step("askq", "Ask Leo a focused question", "❓", "Focused asker", ["2Rq.01", "2Ml.01"],
             ...
             {"topic": "Leo's old town", "words": ["What", "Where", "Who", "When", "Why", "How"],
              "ends": [
                  ...
                  {"id": "beach", "t": "was the beach from your house?", "words": ["Where", "How"], "asks": "the beach and his house"},
                  ...
                  {"id": "miss", "t": "do you miss most?", "words": ["What", "Who"], "asks": "what he misses"},
              ],
              "rounds": [
                  {"want": "the name of Leo's old school", "pic": "\U0001F3EB", "word": "What", "end": "school", "why": "What asks for a name or a thing."},
                  {"want": "the place the beach was, near his house", "pic": "\U0001F3D6️", "word": "Where", "end": "beach", "why": "Where asks for a place."},
...
LESSON["lecture"] = [
    ...
    part("❓", "Focused questions for Leo",
         "To find out about Leo's old town, ask focused questions. What was your old school called? Where was the beach from your house? Why did you move here?"),

    ...
    "steps": [
        ...
        step("sort", "Networked, or not?", "\U0001F5C2️", "Networked sorter", ["3DC.01"],
             ...
             {"ask": "Networked, or not?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F4BB", "label": "a laptop with a cable to the wall socket", "bin": "net", "why": "The cable goes to the switch."},
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star computer scientist", ["3DC.01", "3DC.02", "3DC.03"],
             ...
             {"items": [
                 ...
                 q("Which is a DISADVANTAGE?", "\U0001F44E", "it costs money to set up and look after", ["files can be shared", "the web is available", "classes can work together"], "Cost is a cost."),
                 q("A laptop with a cable to the wall socket is connected to...", "\U0001F5A7", "the switch", ["the sun", "a torch", "nothing"], "Cables go to the switch."),
             ]},

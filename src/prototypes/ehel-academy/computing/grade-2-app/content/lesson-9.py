    ...
    "steps": [
        ...
        step("sort", "Wired network, or wireless network?", "\U0001F5C2️", "Network typer", ["2DC.03"],
             ...
             {"ask": "Wired network, or wireless network?",
              ...
              "items": [
                  ...
                  {"pic": "⌚", "label": "a smart watch talking to a phone", "bin": "wireless", "why": "Through the air: wireless."},
                  {"pic": "\U0001F5A8️", "label": "a printer with a cable to the router", "bin": "wired", "why": "A cable: wired."},
                  {"pic": "\U0001F6CB️", "label": "a laptop on the sofa with no cables", "bin": "wireless", "why": "No cables: wireless."},
              ]},
        ...
        step("sort", "Is the network there?", "\U0001F4F6", "Signal reader", ["2DC.04"],
             ...
             {"ask": "Network available, or not?",
              ...
              "items": [
                  ...
                  {"pic": "⏳", "label": "the page keeps spinning and never loads", "bin": "no", "why": "A spinner that never stops means the network is not reaching the device."},
        ...
        step("offline", "When the network is not there", "\U0001F4F4", "Offline tester", ["2DC.04"],
             ...
             explain(
                 ...
                 ["A video online, a photo to Grandma, a video call: they need the network.", "A saved game, drawing, your own photos: they work without it."],
                 [],
                 ["Switch it off, predict, try it, then switch it back on."]),
             {"apps": [
                 {"id": "video", "label": "Watch a video online", "pic": "\U0001F3AC", "needs": True, "why": "The video is on another computer. No network, no video."},
                 {"id": "photo", "label": "Send a photo to Grandma", "pic": "\U0001F4E4", "needs": True, "why": "The photo has to travel across the network to reach her."},
                 {"id": "game", "label": "Play a game saved on the tablet", "pic": "\U0001F3AE", "needs": False, "why": "The game is already here. It runs without the network."},
                 {"id": "draw", "label": "Draw a picture", "pic": "\U0001F3A8", "needs": False, "why": "Drawing happens on this device alone."},
                 {"id": "call", "label": "Video call a friend", "pic": "\U0001F4DE", "needs": True, "why": "A call needs the other device, across the network."},
                 {"id": "photos", "label": "Look at your own photos", "pic": "\U0001F5BC️", "needs": False, "why": "Your photos are saved here."},
             ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star computer scientist", ["2DC.01", "2DC.02", "2DC.03", "2DC.04", "2DC.05"],
             ...
             {"items": [
                 ...
                 q("The page keeps spinning and never loads. What is most likely?", "⏳", "the network is not available", ["the tablet is full", "the page is shy", "you need a bigger screen"], "A spinner that never stops means no network is reaching the device."),
...
LESSON["lecture"] = [
    ...
    part("\U0001F4F6", "Is it there?",
         "Devices tell you. Bars on the phone and a green light on the router mean the network is available. No bars, aeroplane mode, a spinner that never stops, or a dark router mean it is not. Then the things that need other devices stop, and the rest carry on."),

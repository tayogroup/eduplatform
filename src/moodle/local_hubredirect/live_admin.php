...
$groups = [
    '1. Inquiry & Intake' => [
        ...
        ['EduForTomorrow marketplace requests', '/local/hubredirect/teacher_marketplace_admin.php?consumer=edu-for-tomorrow', 'Review EduForTomorrow parent requests and teacher selections by marketplace consumer.'],
        ['EduForTomorrow public landing', '/local/hubredirect/consumer_landing.php?consumer=edu-for-tomorrow', 'Preview the EduForTomorrow public landing experience with consumer-aware calls to action.'],
        ['EduForTomorrow teacher marketplace', '/local/hubredirect/teacher_marketplace.php?consumer=edu-for-tomorrow', 'Preview the parent-facing EduForTomorrow teacher marketplace and published profiles.'],
        ['Parent teacher request tracker', '/local/hubredirect/teacher_marketplace_requests.php?consumer=edu-for-tomorrow', 'Parent-facing request status page for marketplace messages, selections, and assignments.'],
    ...
    '7. Operations, Compliance & Diagnostics' => [
        ...
        ['Consumer diagnostics', '/local/hubredirect/consumer_diagnostics.php?host=edufortomorrow.com&consumer=edu-for-tomorrow', 'Verify multi-consumer schema, current host resolution, seeded domains, and EduForTomorrow routing.'],
...
$workflows = [
    ...
    ['6', 'Publish marketplace profiles', '/local/hubredirect/teacher_marketplace_admin.php?consumer=edu-for-tomorrow', 'Review teacher profile content, vetting state, parent visibility, and EduForTomorrow tutor requests.'],

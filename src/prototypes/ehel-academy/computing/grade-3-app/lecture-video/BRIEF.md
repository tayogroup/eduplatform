# Brief: the Grade 3 Computing unit lecture films
...
| file | what it is |
| --- | --- |
| `src/prototypes/ehel-academy/computing/grade-3-app/lecture-video/<slug>.json` | the storyboard: the script and its cues |
| `tools/lib/film-scenes/computing-g3/<slug>.js` | your pictures (more parts if needed: `<slug>-2.js`, `<slug>-3.js`) |
...
```json
{
  "_comment": "Storyboard for the Grade 3 Computing unit lecture film, Lesson N <Title>. Rendered by tools/create-ehel-unit-lecture.js. See lecture-video/BRIEF.md.",
  "slug": "<slug>",
  "lesson": N,
  "grade": 3,
  "stage": 3,
  "title": "<the lesson's title, exactly as app.config.json has it>",
  "subtitle": "Grade 3 Computing",
  "framework": "Cambridge Primary Computing 0059",
  "renderer": {
    "art": ["computing"],
    "skin": "brown",
    "scenes": ["tools/lib/ehel-film-marks.js", "tools/lib/film-scenes/computing-g3/<slug>.js"]
  },
...
### Language: a Grade 3 child (about 8), and the lesson's own words
...
```bash
T="node tools/create-ehel-unit-lecture.js --app src/prototypes/ehel-academy/computing/grade-3-app --slug <slug>"
...
```bash
node tools/check-ehel-film-cues.js computing 3
```

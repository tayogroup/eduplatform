...
function main() {
  ...
  const runtime = {
    ...
    unit,
    visual: {
      image: "../../assets/unit-2-neighbours-jobs.png",
      alt: unitVocabulary.visual.alt,
      lectureVideo: "../../lecture-media/unit-2-vocabulary-lecture.mp4",
      lecturePoster: "../../lecture-media/unit-2-lecture-poster.jpg",
      lectureCaptions: "../../lecture-media/unit-2-vocabulary-lecture.vtt",
    },

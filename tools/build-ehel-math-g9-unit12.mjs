...
const workedExamples = [
  ...
  { id: "we02", outcomeId: "lo01", difficulty: "Basic", twm: "critiquing", title: "When adding would be wrong",
  ...
  { id: "we05", outcomeId: "lo03", difficulty: "Core", twm: "characterising", title: "Testing for independence",
  ...
  { id: "we06", outcomeId: "lo03", difficulty: "Core", twm: "classifying", title: "Events that are not independent",
  ...
  { id: "we09", outcomeId: "lo06", difficulty: "Extension", twm: "convincing", title: "At least one",
  ...
  { id: "we11", outcomeId: "lo07", difficulty: "Core", twm: "specialising", title: "Relative frequency",
  ...
  { id: "we12", outcomeId: "lo08", difficulty: "Core", twm: "generalising", title: "Expected frequency",

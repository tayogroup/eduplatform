"""Assemble the Grade 4 Numbers and How They Behave lesson.
...
extra = io.open("num-extra.css", encoding="utf-8").read()
body = io.open("num-body.html", encoding="utf-8").read()
shell = io.open("shell.js", encoding="utf-8").read()
slides = io.open("num-slides.js", encoding="utf-8").read()

doc = (
    '<meta charset="utf-8">\n'
    '<meta name="viewport" content="width=device-width, initial-scale=1">\n'
    "<title>Numbers and How They Behave</title>\n"
...
io.open("numbers-and-behaviour.html", "w", encoding="utf-8").write(doc)
print("wrote numbers-and-behaviour.html", len(doc), "bytes")

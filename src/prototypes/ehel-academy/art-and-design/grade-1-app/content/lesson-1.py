    ...
    "steps": [
        ...
        step("quiz", "Show what you know", "⭐", "Star mark maker", ["1E.01", "1E.02", "1E.03", "1M.01"],
             ...
             {"items": [
                 ...
                 q("Sorting things by their lines is a way of…", "🗂️", "gathering what you notice", ["making paint", "washing brushes"], "Artists gather what they notice by sorting and ordering."),
                 q("Which line is made of sharp turns?", "🏔️", "zigzag", ["wavy", "straight"], "Sharp turns, like mountain tops, make a zigzag."),
                 q("Can your finger be a tool?", "👆", "yes, it leaves a mark", ["no, only pencils", "no, only brushes"], "Anything that leaves a mark is a tool, and a finger in paint leaves a mark."),
             ]},

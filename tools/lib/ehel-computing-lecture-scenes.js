  ...
  /* ==== Grade 1 Computing, Lesson 8: Computers Everywhere ==================
     The pictures of the Computing film, between the shared engine's head and
     tail (tools/lib/ehel-film-engine-head.js explains the assembly). The
     lesson draws its machines as HTML and emoji inside interactive renderers
     (computing.js), so there is nothing pure to lift out; every machine here is
     drawn fresh, in the colours of the kit's own hardware drawings, and it
     moves as it is named - a call rings, a rainbow is painted, letters travel
     down a cable, a drum fills and spins, a rover drives. */

    ...
    "steps": [
        ...
        step("experiment", "Mostly water?", "\U0001F9EA", "Globe catch", ["1ESp.01", "1TWSp.02", "1TWSc.04", "1TWSa.01"],
             ...
             {"sim": "globeCatch",
              ...
              "conclude": {"ask": "So what did we find out about <b>land and water</b>?",
        ...
        step("experiment", "Sun or shade?", "\U0001F9EA", "Sun test", ["1ESs.02", "1TWSp.02", "1TWSc.04", "1TWSa.01"],
             ...
             {"sim": "sunShade",
              ...
              "conclude": {"ask": "So what did we find out about <b>the Sun</b>?",
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["1ESp.01", "1ESp.02", "1ESs.01", "1ESs.02"],
             ...
             {"items": [
                 ...
                 q("Why does the ground look flat when Earth is really a huge ball?", "\U0001F30D", "Earth is so big that the little bit you can see looks flat", ["the ground really is flat where you live", "the ball shape only starts further away"], "Stand on a beach ball and you can feel the curve. Stand on something the size of Earth and your piece of it looks flat."),
                 ...
                 q("Is every bright light you can see in the night sky a star?", "✈️", "No. Some are planes, some are planets, and one is the Moon.", ["Yes, every bright light is a star", "Yes, unless it is very dim"], "The Moon, planes, satellites and the planets are all bright, and not one of them is a star."),
              ...
              "support": [
                 ...
                 q("Does the Sun give heat?", "\u2600\uFE0F", "Yes", ["No"],
                   "The Sun gives us light and heat."),
                 q("Is soil the same thing as rock?", "\U0001FAA8", "No", ["Yes"],
                   "Soil is the dark crumbly layer on top. Rock is the hard stuff underneath it."),
              ],
              "extension": [
                 q("If it is the Earth that turns, what ELSE in the sky should look as though it moves across?", "⭐", "the stars and the Moon as well", ["only the Sun, because it is closest", "nothing else at all"],
                   "The whole sky appears to move, because it is you being carried round. Watch one star for an hour and it will have shifted."),
                 q("A beach is sand and the cliff behind it is solid rock. Where did the sand come from?", "\U0001F3D6️", "from the cliff, worn away by the sea over a very long time", ["it was always sand", "it blew in from the sky"],
                   "The sea wears rock away grain by grain for thousands of years. That is why a beach's sand matches the rock beside it."),
                 q("It is night where you are. Is the Sun still shining somewhere?", "\U0001F311", "yes - it is shining on the other side of the Earth", ["no, it goes out at night", "it moves away and comes back in the morning"],
                   "The Earth turns, so your side faces away for a while. The Sun never stops shining."),
                 q("A puddle in the sun has gone by the afternoon and one in the shade has not. What did the Sun do?", "\U0001F4A7", "warmed the water until it dried away into the air", ["drank the water up", "pushed the puddle somewhere else"],
                   "The Sun's heat dries things, which is why washing goes out on a sunny day."),
              ]
             },
...
LESSON["warmup"] = [
    ...
    q("A stone is put in water and goes to the bottom. What did it do?", "\U0001FAA8", "it sank", ["it floated", "it stayed still on top"],
      "Things that go down to the bottom sink. Being heavy is not what decides it - a big ship floats."),

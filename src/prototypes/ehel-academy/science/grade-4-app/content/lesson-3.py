...
prevent some; 4Bp.04 movement keeps humans healthy; with 4TWSc.01,
...
LESSON = {
    ...
    "steps": [
        step("sort", "Medicines: safe, or not safe?", "\U0001F48A", "Medicine rules", ["4Bp.01", "4TWSc.01"],
             ...
             explain(
                 ...
                 ["Children think more medicine means better faster.", "The amount on the label is the safe amount. More is poison."],
        ...
        step("demo", "Vaccines: training the body", "\U0001F489", "Vaccines", ["4Bp.02"],
             ...
             explain(
                 ...
                 ["Germs get in.", "The body makes fighters, but slowly, and you get ill.", "A vaccine trains the fighters in advance.", "Next time the real germ arrives, the body wins at once."],
             ...
             {"frames": [
                 ...
                 {"pic": "\U0001F6E1️", "cap": "Now when the real germ arrives, the body wins straight away.", "say": "Now if the real germ ever arrives, your body already knows what to do and beats it at once. You do not get the disease."},
                 {"pic": "\U0001F415", "cap": "Animals are vaccinated too: puppies, kittens, farm animals. Plants cannot be, so farmers protect them in other ways.", "say": "Animals are vaccinated as well: puppies, kittens, cows and sheep. Plants get infectious diseases too, but they cannot be vaccinated, so farmers protect crops in other ways."},
             ]},
             "A vaccine trains the body to beat a germ before it arrives."),
        ...
        step("sort", "Evidence, or opinion?", "⚖️", "Evidence sort", ["4SIC.03"],
             ...
             {"ask": "Evidence, or opinion?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F4AC", "label": "I think PE is boring", "bin": "opinion", "why": "What someone thinks. An opinion."},
                  ...
                  {"pic": "\U0001F4AC", "label": "My uncle says vaccines are a waste of time", "bin": "opinion", "why": "Somebody's view, not a measurement."},
                  {"pic": "\U0001F634", "label": "Scientists timed sleep: children who moved more fell asleep faster", "bin": "evidence", "why": "Timed. Evidence."},
                  {"pic": "\U0001F4AC", "label": "Football is the best sport", "bin": "opinion", "why": "A favourite, not a test."},
                  ...
                  {"pic": "\U0001F4AC", "label": "Medicine always tastes horrible", "bin": "opinion", "why": "Some do, some do not. A feeling, not a measurement."},
              ]},
             "Evidence is measured or tested. Use it to back up your point."),

        step("context", "Health science near you", "\U0001F3E5", "Health jobs", ["4SIC.04", "4Bp.01", "4Bp.02"],
             "People in your area use health science every day. Tap each one.",
             explain(
                 ["Science is not only in a lab. It is in the pharmacy, the vet's and the clinic down the road."],
        ...
        step("questions", "Health check", "✅", "Health check", ["4Bp.01", "4Bp.02", "4Bp.04"],
             ...
             {"label": "Question", "items": [
                 ...
                 q("What does a vaccine do?", "\U0001F489", "trains the body to fight a germ before the real one arrives", ["cures you when you are ill", "makes you run faster"], "Given when well, to stay well."),
                 q("Can a puppy be vaccinated?", "\U0001F415", "yes, animals get infectious diseases too", ["no, only people", "only cats"], "Vets vaccinate animals."),
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4Bp.01", "4Bp.02", "4Bp.04", "4SIC.03"],
             ...
             {"items": [
                 ...
                 q("You find a pill on the floor that looks like a sweet.", "\U0001F36C", "leave it and tell a grown-up", ["eat it", "give it to a friend"], "Never eat a medicine you find."),
                 q("What is an infectious disease?", "\U0001F9A0", "one that spreads from one living thing to another", ["a broken bone", "a headache from reading"], "Carried by germs."),
                 q("When is a vaccine given?", "\U0001F489", "when you are well, to stop the disease", ["when you are ill, to cure it", "never"], "Before the germ arrives."),
                 q("Can plants get infectious diseases?", "\U0001F331", "yes, but they cannot be vaccinated", ["no, never", "only in winter"], "Farmers protect crops in other ways."),
                 q("Which counts as moving every day?", "\U0001F6B6\U0001F3FE", "walking, climbing stairs, dancing and playing", ["only football", "only running races"], "All movement counts."),
                 q("Which is evidence?", "\U0001F4CA", "doctors measured that runners had stronger hearts", ["my friend says running is silly", "I like running"], "Measured, not just said."),
...
LESSON["lecture"] = [
    ...
    part("\U0001F489", "Vaccines",
         "A vaccine is a harmless piece of a germ. Your body learns to fight it while you are well. Then if the real germ ever arrives, your body beats it at once. Puppies, kittens and farm animals are vaccinated too."),
...
LESSON["home"] = [
    home("Medicine cupboard check", "A grown-up, your medicine cupboard",
         ["With a grown-up, look at where the medicines are kept. Are they high up or locked?",
    ...
    home("Heart rate before and after", "A clock with seconds, a grown-up",
         ["Sit still and count your pulse for thirty seconds.",
          "Run on the spot for two minutes.",
          "Count again. Write both numbers down."],
         "Faster after running: your heart working harder, which is what makes it stronger. That number is evidence."),

    ...
    "steps": [
        ...
        step("quiz", "Show what you know", "⭐", "Star texture finder", ["1E.01", "1E.02", "1E.03", "1M.02", "1TWA.02"],
             ...
             {"items": [
                 ...
                 q("Which material is shiny?", "✨", "foil", ["cotton wool", "felt"], "Foil is shiny and smooth."),
                 ...
                 q("Guess, add, look. That is…", "🧪", "experimenting", ["copying", "sleeping"], "Trying something and looking at what happened is experimenting."),
             ]},

...
LESSON = {
    ...
    "steps": [
        step("demo", "Small cause, shared consequence", "\U0001F517", "Chain spotter", ["4Ac.01"],
             ...
             explain(
                 ...
                 ["Hana wanted the window seat, so she pushed to the front of the lunch queue. The cause: wanting the seat.",
                  "The Year 1 behind her dropped his tray. The consequence, for him, and for the dinner staff who cleaned it up."],
                 ["Children see only the person right next to them.", "Ask who ELSE the chain reached."],
                 ["Press Next and follow the chain."]),
             {"frames": [
                 {"pic": "\U0001FA9F", "cap": "<b>Cause:</b> Hana wanted the seat by the window.", "say": "The cause. Hana wanted the seat by the window before anyone else got it."},
                 ...
                 {"pic": "\U0001F4A5", "cap": "<b>Consequence:</b> a Year 1 behind her dropped his tray, and dinner was late for the whole line.", "say": "The consequence for others. A Year 1 behind her lost his balance and dropped his tray. The dinner staff stopped to clean it, and everyone behind waited longer.", "sound": "thud"},
        ...
        step("consequence", "Why did you do it, and who did it reach?", "\U0001F517", "Chain follower", ["4Ac.01"],
             ...
             {"rounds": [
                 ...
                 {"situation": "You were bored in assembly, so you whispered jokes to Tariq.", "pic": "\U0001F971",
                  ...
                  "predict": {"ask": "Who did it reach?", "opts": [opt("The Year 2s in front could not hear the story, and Tariq got told off", True), opt("Everyone laughed", False), opt("Nobody", False)]},
                  "result": {"pic": "\U0001F61F", "say": "The Year 2s in front missed the end of the story, and Tariq was the one sent to sit at the side.", "sound": "thud"},
                  "why": "Your boredom reached a row of Year 2s and landed on Tariq."},
        ...
        step("sort", "Which cause could you change?", "\U0001F527", "Cause changer", ["4Ac.01"],
             ...
             {"ask": "Could you change this cause?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F6A8", "label": "the fire drill went off mid-lesson", "bin": "not", "why": "That is not yours to change."},
                  {"pic": "\U0001FA9F", "label": "I wanted the window seat", "bin": "mine", "why": "Wanting is fine. Pushing for it is the choice."},
        ...
        step("solve", "An action for somebody else's problem", "\U0001F4AA", "Action suggester", ["4As.01"],
             ...
             explain(
                 ["The problem is somebody else's. The action is still yours.", "It has to be something you do, not something you hope a grown-up does."],
             ...
             {"rounds": [
                 {"issue": {"title": "Hana cannot see the board from the back row", "pic": "\U0001F453", "say": "Her new glasses are not ready yet. What could YOU do?", "fixed": "Hana can see every word!"},
                  ...
                  "actions": [
                      ...
                      action("teacher", "I could tell the teacher to move her", "\U0001F469\U0001F3FE‍\U0001F3EB", "nothing", "That is the teacher's action. Hana squinted through another lesson."),
                  ...
                  "why": "Swapping seats is your action, and it changes Hana's lesson today."},
                 {"issue": {"title": "The caretaker cannot get his trolley past the bikes dumped on the path", "pic": "\U0001F6B2", "say": "Bikes lie across the path every morning. What could YOU do?", "fixed": "The path is clear for the trolley."},
                  ...
                  "actions": [
                      ...
                      action("sign", "I could hope somebody puts a sign up", "\U0001FAA7", "nothing", "No sign came. The bikes stayed."),
                      action("blame", "I could say it is the Year 6s' bikes, not ours", "\U0001F937", "nothing", "Every class said that. The path stayed blocked."),
                 ...
                 {"issue": {"title": "The Year 2s lose their ball over the fence every playtime", "pic": "⚽", "say": "They are too small to get it back. What could YOU do?", "fixed": "The Year 2s have their ball back."},
                  "needs": "return",
                  "actions": [
                      action("fetch", "I could ask a teacher to come with me and fetch it back", "\U0001F91D", "return", "You and Teacher Yasmin fetched it in two minutes. The Year 2s finished their game."),
                      action("laugh", "I could laugh at how bad their kicking is", "\U0001F602", "worse", "They felt small AND had no ball."),
                      action("ignore", "I could decide it is not my problem", "\U0001F648", "nothing", "It is not your problem. Their ball is still over the fence."),
                      action("keep", "I could get it and keep it for our game", "\U0001F3C3", "worse", "Now they had no ball and knew who had it."),
                  ],
                  "why": "Fetching it, with a grown-up, is your action, and it gives the Year 2s their game back."},
        ...
        step("explore", "Small actions in shared spaces", "\U0001F31F", "Difference maker", ["4As.01"],
             ...
             {"items": [
              ...
              "then": {"ask": "Which of these is an action YOU could take for somebody else?",
                       "opts": [opt("Tidy one library shelf every lunchtime", True), opt("Hope the school hires another librarian", False), opt("Say the shelves are the Year 6s' fault", False)],
        ...
        step("questions", "Causes and actions", "\U0001F4AC", "Cause judge", ["4Ac.01", "4As.01"],
             ...
             {"label": "Question", "items": [
                 q("Hana pushed to the front of the queue. What was the CAUSE?", "\U0001FA9F", "she wanted the window seat", ["the Year 1 pushed her", "the queue was short"], "Wanting the seat was why she pushed."),
                 q("You whispered in assembly because you were bored. Who did it reach?", "\U0001F971", "the Year 2s who could not hear, and Tariq who got told off", ["nobody", "only you"], "In a shared space the chain reaches more people."),
                 q("Hana cannot see the board. Which action is YOURS?", "\U0001FA91", "swap seats with her", ["tell the teacher to move her", "wait for her glasses"], "Swapping is something you do."),
        ...
        step("quiz", "Show what you know", "⭐", "Star thinker", ["4Ac.01", "4As.01"],
             ...
             {"items": [
                 ...
                 q("Which problem is somebody ELSE'S?", "⚽", "the Year 2s lose their ball over the fence", ["I keep losing my pencil", "I am hungry", "my laces are undone"], "Their problem, and your action."),
                 q("The bikes block the caretaker's path. Which action is YOURS?", "\U0001F6B2", "rack my bike and ask my friends to", ["hope for a sign", "say it is the Year 6s' bikes", "kick them out of the way"], "Something you do, that helps him."),
...
LESSON["lecture"] = [
    part("\U0001FA9F", "One push in the queue",
         "Hana wanted the window seat, so she pushed to the front of the lunch queue. A Year 1 dropped his tray, the dinner staff stopped to clean it, and twenty people waited longer. One small cause, and the chain reached the whole line."),
    ...
    part("\U0001F4AA", "An action for somebody else",
         "Hana cannot see the board: swap seats. The bikes block the caretaker: rack yours and ask friends. The Year 2s lose their ball: fetch it with a grown-up. The librarian cannot keep up: tidy a shelf a day. Their problem, your action."),
    part("\U0001F31F", "Small, and yours",
         "None of these needs a grown-up to do the work. Each is something you can do today, and each one changes somebody else's day."),
]

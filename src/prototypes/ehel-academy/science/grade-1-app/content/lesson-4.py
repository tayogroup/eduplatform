        ...
        step("questions", "Describe it", "\U0001F5E3️", "Describe it", ["1Cp.02", "1Cp.01"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Is cotton wool soft or hard?", "\U0001F9F5", "soft", ["hard"],
                   "Cotton wool squashes easily, so it is soft."),
                 q("Is glass bendy or stiff?", "\U0001FA9F", "stiff", ["bendy"],
                   "Glass keeps its shape. It will not bend - it breaks instead."),
              ],
              "extension": [
                 ...
                 q("Why is a metal spoon a bad idea for stirring a very hot pan?", "\U0001F944", "metal carries the heat up the handle to your hand", ["metal would melt", "it would be perfectly fine"],
                   "Letting heat through is a property of metal, and you can test it - carefully, with a grown-up."),
                 q("Two chairs look the same, one wood and one cardboard. How could you tell which is which without breaking them?", "\U0001FA91", "feel and tap them - wood is harder, heavier and sounds different", ["look at the colour", "you could not tell at all"],
                   "Properties you can test are how you tell two materials apart when they look alike."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["1Cm.01", "1Cm.02", "1Cp.02", "1Cc.01"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Is wood a material?", "\U0001FAB5", "Yes", ["No"],
                   "Wood is a material, and so are metal, glass and plastic."),
                 q("Can you bend a metal spoon with your fingers?", "\U0001F944", "No", ["Yes"],
                   "Metal is stiff. Bending it takes far more force than your fingers can give."),
              ],
              "extension": [
                 ...
                 q("A paper cup holds water for a few minutes and then leaks. So is paper waterproof?", "\U0001F964", "no - it holds water for a little while and then soaks through", ["yes, while it lasts", "paper never lets water through at all"],
                   "A property is not always all or nothing. Paper resists water badly, and plastic resists it well."),
                 q("You want to find the strongest of three paper bridges. What has to stay the same?", "\U0001F309", "the same weight, put in the same place, on each bridge", ["nothing - just pile things on", "use a different weight for each one"],
                   "A fair test changes one thing only. Here that is the bridge, so everything else must match."),
              ]
             },

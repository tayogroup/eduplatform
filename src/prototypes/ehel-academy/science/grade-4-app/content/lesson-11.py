        ...
        step("questions", "Earth check", "✅", "Earth check", ["4ESp.01", "4ESp.02", "4ESp.03"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Is the crust the thin layer or the thick one?", "\U0001F30D", "the thin one", ["the thick one"],
                   "Thin on the outside; the mantle beneath it is far thicker."),
                 q("Does lava come out of a volcano?", "\U0001F30B", "Yes", ["No"],
                   "Melted rock that has reached the surface is called lava."),
              ],
              "extension": [
                 ...
                 q("Nobody has ever been to the Earth's core. So how is it known to be metal?", "\U0001F9F2", "from how heavy the Earth is, and from how earthquake waves travel through it", ["somebody drilled down and looked", "it is only a guess"],
                   "Evidence can reach places people cannot. The waves and the weight both point the same way."),
                 q("A volcano and an earthquake happen in the same region. What do they share?", "\u26F0\uFE0F", "a break in the crust, where the plates meet", ["nothing at all - it is a coincidence", "the same melted rock"],
                   "Both are what happens at the edges of the huge plates the crust is broken into."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4ESp.01", "4ESp.02", "4ESp.03", "4TWSm.02", "4SIC.01"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Which layer is thickest, the crust, the mantle or the core?", "\U0001F30D", "the mantle", ["the crust"],
                   "The mantle makes up most of the Earth."),
                 q("Is the Earth’s crust solid rock?", "\U0001FAA8", "Yes", ["No"],
                   "Solid rock, and we live on top of it."),
              ],
              "extension": [
                 ...
                 q("A volcano destroys farms and the soil round it is richer for years afterwards. Good effect or bad?", "\U0001F30B", "both - and weighing the two is the point", ["only bad", "only good"],
                   "Ash carries minerals into the soil. That is why people farm near volcanoes knowing the risk."),
                 q("Two mountains rise a few millimetres a year. How tall after a million years, if nothing wore them down?", "\u26F0\uFE0F", "kilometres - a tiny rate over an enormous time", ["a few centimetres", "nothing would change"],
                   "Geology is mostly arithmetic about time. Slow plus long equals enormous."),
              ]},

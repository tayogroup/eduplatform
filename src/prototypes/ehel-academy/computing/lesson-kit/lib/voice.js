  ...
  /* Every call site in this lesson already says say(...). It now goes to Sonia.
     ...
     load and every round asks its question aloud: lines for steps the child
     has not reached, each a request to the paid voice endpoint and each
     cutting off the last, with the late ones read over step 1. The count
     drops to 0 after show(0, false), the script's last line; later() raises
     it while a round runs for a step the child has already left. */

    ...
    "steps": [
        step("sort", "Which habitat suits it?", "\U0001F5C2️", "Habitat sort", ["4Be.01", "4TWSc.01"],
             ...
             explain(
                 ...
                 ["Children put the penguin in the Arctic.", "No penguins live in the Arctic. They live in the southern half of the world, around Antarctica and on southern coasts. Polar bears live in the Arctic, in the far north."],
             ...
             {"ask": "Desert, Arctic, rainforest or ocean?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F98C", "label": "reindeer", "bin": "arctic", "why": "A thick coat for the cold, and wide hooves that do not sink into the snow."},
                  ...
                  {"pic": icon("arcticfox"), "label": "Arctic fox", "bin": "arctic", "why": "Small ears to keep heat in, and a thick white winter coat that hides it in the snow."},
        ...
        step("explore", "Suited to the place", "\U0001F42A", "Suited features", ["4Be.01"],
             ...
             {"items": [
                 ...
                 {"pic": "\U0001F41F", "label": "fish", "sub": "gills, fins, scales", "say": "A fish breathes with gills, which take oxygen out of the water. Fins steer it. Take it out of the water and it cannot breathe."},
        ...
        step("lookup", "Look it up: living outside the habitat", "\U0001F4DA", "Survivor facts", ["4Be.02", "4TWSc.07"],
             ...
             {"source": {"title": "Surviving away from home",
                         "lines": ["A living thing is <b>suited</b> to its habitat, but it can often survive somewhere else if it can still get <b>food, water, the right temperature and shelter</b>.",
                                   "A <b>goldfish</b> lives in a bowl for years because a person feeds it and keeps the water clean. Goldfish let go in wild ponds and rivers often survive too, and some grow big and spread, eating the food the wild animals there need. That is why a pet fish must never be let go.",
        ...
        step("context", "Science and technology near you", "\U0001F3D8️", "Local effects", ["4SIC.05", "4SIC.02", "4Be.01"],
             ...
             {"items": [
                 ...
                 {"pic": "♻️", "label": "a recycling centre", "say": "A recycling centre means less rubbish buried and less rock dug up for new metal and glass. That is good for habitats. But the lorries that bring the rubbish make noise and dirty air on the roads nearby."},
                 {"pic": "\U0001F438", "label": "a park pond", "say": "A pond dug in a park is a new habitat. Within a year there are frogs, dragonflies and pondweed. But digging it destroys the patch of grass and the minibeasts that lived there."},
             ], "need": 4,
        ...
        step("questions", "Back it up with science", "\U0001F5E3\uFE0F", "Backed by science", ["4SIC.03", "4Be.01"],
             ...
             {"label": "Question", "items": [
                 ...
                 q("\"A cactus is suited to the desert.\" Which evidence supports that?", "🌵", "it stores water in its thick stem and has spines", ["it is green, like most plants", "it grows slowly in a pot indoors"], "Features that help it survive in its habitat are the evidence."),
             ]},
        ...
        step("questions", "Habitat check", "✅", "Habitat check", ["4Be.01", "4Be.02"],
             ...
             {"label": "Question", "items": [
                 ...
                 q("Can a pet goldfish survive in a bowl?", "\U0001F41F", "yes, if a person feeds it and keeps the water clean", ["no, a fish can never live in a bowl", "only if the bowl is filled with sea water"], "Food and clean water provided."),
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4Be.01", "4Be.02", "4SIC.05", "4TWSp.01"],
             ...
             {"items": [
                 ...
                 q("Which animal is suited to the rainforest?", "\U0001F333", "a monkey", ["a polar bear", "a camel"], "Grasping hands and a tail, built for trees."),
                 ...
                 q("A rainforest plant on a windowsill survives if...", "\U0001F331", "it is watered and kept warm", ["it is put somewhere freezing", "it is never watered"], "The needs are provided."),
                 ...
                 q("A zoo keeps a penguin far from its home. What must the zoo give it?", "\U0001F3E0", "food, water, the right temperature and shelter", ["only a bigger space to run about in", "just sunlight and a quiet place"], "The card said so."),
                 q("Why should you never let a pet goldfish go in a pond or river?", "\U0001F914", "it can survive there and eat food the wild animals need", ["it would turn into a different kind of fish", "goldfish cannot swim in moving water"], "Goldfish often survive in the wild and spread, taking food from the animals that live there."),
             ]},

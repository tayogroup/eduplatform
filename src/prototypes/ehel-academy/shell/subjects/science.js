...
function renderAI() {
  ...
  $("#app").innerHTML = `${pageHeader("Your AI subject expert", "Wehel — Science", "Ask questions, go deeper, get quizzed, role-play a scientist or get homework help — by text or voice.", "Wehel · Ehel Academy AI")}
  ...
  mountWehelChat({
    ...
    meta: { subject: "science", subjectLabel: "Science", grade: stageNumber, cambridgeCode: `${fw.level} ${fw.code}`, unitNo: course.unit.unitNo, unitTitle: course.unit.unitTitle, unit: course },
    store: progress,

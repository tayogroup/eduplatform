        ...
        step("questions", "The right material for the job", "\U0001F3E0", "Right material", ["2Cp.02", "2Cp.01"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Is wool warm or cold to wear?", "\U0001F9E5", "warm", ["cold"],
                   "Wool traps air close to you, and that is what keeps you warm."),
                 q("Does a towel soak up water?", "\U0001F9FA", "Yes", ["No"],
                   "Cotton soaks water up, which is what a towel is for."),
              ],
              "extension": [
                 ...
                 q("A paper bag and a plastic bag both carry shopping. Which would you choose for a rainy walk, and why?", "\U0001F6CD\uFE0F", "the plastic one, because it is waterproof and paper is not", ["the paper one, because it is stronger", "either - the rain makes no difference"],
                   "Choosing a material means asking what the job will do to it."),
                 q("An oven shelf is metal and an oven glove is thick cloth. Why not make the glove of metal too?", "\U0001F9E4", "metal carries heat straight through to your hand", ["cloth is cheaper", "a metal glove would be too heavy"],
                   "The shelf has to take the heat and the glove has to keep it out. Opposite jobs, opposite materials."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["2Cm.01", "2Cp.01", "2Cp.02", "2Cp.03"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Is plastic natural or manufactured?", "\U0001F9F4", "manufactured", ["natural"],
                   "People make plastic in a factory."),
                 q("Is wool natural?", "\U0001F411", "Yes", ["No"],
                   "Wool grows on a sheep, so it is natural."),
              ],
              "extension": [
                 ...
                 q("A wooden spoon and a metal spoon both stir. Name a job where only one of them will do.", "\U0001F944", "stirring a hot pan - the wooden one stays cool to hold", ["there is no such job", "only metal ever works"],
                   "Two materials can do the same job until the conditions change. Then their properties decide."),
                 q("Two coats are both labelled waterproof and one lets rain through after an hour. Is the label wrong?", "\U0001F9E5", "not quite - waterproof is a matter of degree, not all or nothing", ["yes, it is simply a lie", "yes, because waterproof means for ever"],
                   "A property can be strong or weak. Testing tells you how strong, and the label does not."),
              ]},

        ...
        step("questions", "Energy check", "✅", "Energy check", ["4Bp.03", "4Be.03"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Does a sheep eat plants or animals?", "\U0001F411", "plants", ["animals"],
                   "Only plants, which makes a sheep a herbivore."),
                 q("Do you need to eat in order to have energy?", "\U0001F35E", "Yes", ["No"],
                   "Your food is where all of it comes from."),
              ],
              "extension": [
                 ...
                 q("A lion eats a zebra and the zebra ate grass. What did the lion really get from the grass?", "\U0001F981", "the energy the grass caught from the Sun, passed along two steps", ["nothing - it only ate zebra", "grass seeds it swallowed by accident"],
                   "Follow the arrows. Every mouthful in a chain traces back to sunlight."),
                 q("Why would a field support many rabbits but only one or two foxes?", "\U0001F98A", "most of the energy is lost at each step, so the top of a chain feeds few", ["foxes prefer to live alone", "rabbits eat less than foxes"],
                   "A chain narrows sharply as it rises. That is why big predators are always rare."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4Bp.03", "4Be.03", "4TWSm.02"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Is a lion a predator?", "\U0001F981", "Yes", ["No"],
                   "It hunts other animals, so it is a predator and they are its prey."),
                 q("Does a mouse make its own food?", "\U0001F42D", "No", ["Yes"],
                   "It has to eat. Only a plant makes its own."),
              ],
              "extension": [
                 ...
                 q("A frog eats flies and a heron eats frogs. What is the frog?", "\U0001F438", "both a predator and prey, depending which way you look", ["only a predator", "only prey"],
                   "Most animals in the middle of a chain are both, and that is normal rather than odd."),
                 q("A disease kills most of the rabbits in a wood. Name TWO things that changes.", "\U0001F430", "more grass grows, and the foxes go hungry", ["nothing changes at all", "only the foxes are affected"],
                   "A change in the middle of a chain travels in both directions at once."),
              ]},

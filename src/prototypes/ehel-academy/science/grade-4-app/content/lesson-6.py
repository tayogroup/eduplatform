        ...
        step("questions", "Particle check", "✅", "Particle check", ["4Cm.01", "4Cm.02", "4Cm.03", "4Cp.01", "4Cp.02"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Are the particles in a liquid touching each other?", "\U0001F4A7", "Yes", ["No"],
                   "Touching, but sliding past one another. That is why a liquid flows."),
                 q("Do the particles in a solid ever stop moving?", "\U0001F9F1", "No", ["Yes"],
                   "They vibrate on the spot, always."),
              ],
              "extension": [
                 ...
                 q("A smell reaches you from across the room with nobody fanning it. What are the particles doing?", "\U0001F35E", "moving about on their own and spreading through the air", ["sitting still until the air is moved", "travelling along a straight line only"],
                   "Gas particles move fast and in all directions. That is why a smell arrives without help."),
                 q("Sand pours and water pours. Use the particles to say why only one of them is a liquid.", "\U0001F3D6\uFE0F", "each grain of sand is itself a solid, with its particles locked in rows", ["sand is a liquid made of big particles", "there is no real difference"],
                   "A heap of tiny solids behaves a little like a liquid and is not one. Look at what a single grain is doing."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4Cm.01", "4Cm.02", "4Cm.03", "4Cp.01", "4Cp.02", "4TWSm.01"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Which has bigger gaps between its particles, a gas or a solid?", "\U0001F4A8", "a gas", ["a solid"],
                   "Big gaps in a gas; almost none in a solid."),
                 q("Is salt a material or a substance?", "\U0001F9C2", "a substance", ["a material"],
                   "One pure kind of stuff, the same all through. That is a substance."),
              ],
              "extension": [
                 ...
                 q("Water is a substance and sea water is not. What is the difference?", "\U0001F30A", "sea water has other things dissolved in it, so it is a mixture", ["there is no difference", "sea water is a purer substance"],
                   "A substance is one pure kind of stuff all through. Dissolve anything in it and it becomes a mixture."),
                 q("A sealed balloon is put in a fridge and gets smaller. Nothing escaped. What happened?", "\U0001F388", "the particles slowed down and pushed less hard on the skin", ["some of the air leaked out", "the rubber shrank on its own"],
                   "Cooling takes energy out of the particles. Less movement means less push."),
              ]},

    ...
    "steps": [
        step("explore", "What covers an animal?", "\U0001F43E", "Coverings", ["2Bs.01"],
             ...
             explain(
                 ...
                 ["Children think humans are not animals.", "We are. We are covered in skin and hair, and we are like other animals in some ways and different in others."],
        ...
        step("sort", "Sort by covering", "\U0001F5C2️", "Sorted by skin", ["2Bs.01", "2TWSc.01"],
             ...
             {"ask": "Fur, feathers, scales, or skin?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F9D1", "label": "person", "bin": "skin", "why": "People have bare skin, with most of their hair on their head."},
        ...
        step("questions", "Alike and different", "\U0001F50D", "Compared", ["2Bs.01", "2Bp.04"],
             ...
             explain(
                 ...
                 ["A bird and a bat both have wings, but one has feathers and one has fur.", "A person and a monkey usually both have two arms and two legs.",
                  "A fish has fins where a person has arms.",
                  "Young animals are alike and different too: each one gets some features from its mother and some from its father."],
                 [],
             ...
             {"label": "Question", "items": [
                 ...
                 q("A bird and a fish. What is different?", "\U0001F426\U0001F41F", "a bird has feathers and wings; a fish has scales and fins", ["both have two eyes", "both breathe", "both eat"], "A bird has feathers and wings; a fish has scales and fins."),
                 q("A person and a monkey. What do they both usually have?", "\U0001F9D2\U0001F412", "two arms and two legs", ["a tail", "fur all over", "wings"], "People and monkeys usually both have two arms and two legs."),
                 q("How many legs does a spider have?", "\U0001F577️", "eight", ["four", "six", "two"], "A spider has eight legs. An insect has six."),
                 q("Which animal has no legs at all?", "\U0001F40D", "a snake", ["a cat", "a hen", "a frog"], "A snake has no legs and moves by sliding on its scales."),
              ...
              "extension": [
                 ...
                 q("An ant and an elephant are both animals. Name one thing they both do.", "\U0001F41C", "both need food, and both have young", ["both have four legs", "nothing at all - they are too different"],
                   "Two animals can look nothing alike and still share everything that makes them animals."),
                 q("You and a friend both have two eyes, one nose and two ears. Is that a surprise?", "\U0001F46B", "no - every person has the same body parts", ["yes, it is a coincidence", "only twins are alike in that way"],
                   "People are alike in the big things and different in the details."),
              ]},
        ...
        step("order", "From egg to hen", "\U0001F95A", "In order", ["2Bp.03"],
             ...
             {"items": [
                 ...
                 {"pic": "\U0001F425", "label": "young hen", "say": "The chick grows bigger and grows feathers. Now it is a young hen."},
        ...
        step("explore", "Like mother, like father", "\U0001F46A", "Family features", ["2Bp.04"],
             ...
             explain(
                 ...
                 ["A black cat and a white cat can have black kittens, white kittens, and black and white kittens.",
                  "A child might have curly hair like one parent and brown eyes like the other."],
             ...
             {"items": [
                 {"pic": "\U0001F408\U0001F408\U0001F431", "label": "cat family", "say": "A black mother cat and a ginger father cat. Some kittens are black, and some are black with ginger patches. Each kitten gets its own mix."},
                 ...
                 {"pic": "\U0001F469\U0001F468\U0001F9D2", "label": "a human family", "say": "In a family, a child might have curly hair like one parent and eyes like the other. Features from both."},
              ...
              "then": {"ask": "A black cat and a white cat have kittens. What could the kittens be like?",
                       "opts": [opt("They can each look different", True), opt("They must all be black", False), opt("They must all be grey", False)],
        ...
        step("sort", "Diagram, or picture?", "\U0001F4D0", "Diagram spotter", ["2TWSm.03", "2TWSc.01"],
             ...
             {"ask": "Diagram, or picture?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F426", "label": "a bird, coloured in, no labels", "bin": "picture", "why": "It shows how the bird looks, with no labels. A picture."},
                  {"pic": FISH_DIAGRAM, "label": "a fish drawing with labels", "bin": "diagram", "why": "It names the fin, tail and scales. A diagram."},
                  {"pic": "\U0001F41F", "label": "a fish, coloured in, no labels", "bin": "picture", "why": "No labels, no lines. A picture."},
                  {"pic": "\U0001F5BC️", "label": "a painting in a frame", "bin": "picture", "why": "A painting shows how something looks, with no labels. A picture."},
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["2Bs.01", "2Bp.03", "2Bp.04", "2TWSm.03"],
             ...
             {"items": [
                 ...
                 q("Which animal is covered in skin, not fur, feathers or scales?", "❓", "a person", ["a cat", "a hen", "a snake"], "People are covered in skin, with most of their hair on their head."),
                 ...
                 q("A brown dog and a spotty dog have puppies. What could the puppies be like?", "\U0001F436", "They can each look different", ["They must all be brown", "They must all be grey"], "Each puppy gets its own mix of features from both parents, so some may be brown, some spotty, and some both."),
              ...
              "support": [
                 ...
                 q("Is a cat covered in fur or scales?", "\U0001F408", "fur", ["scales"],
                   "Fur covers a cat. Scales cover a fish."),
                 q("Does a hen lay eggs?", "\U0001F423", "Yes", ["No"],
                   "A hen lays eggs, and chicks hatch out of them."),
              ],
              "extension": [
                 ...
                 q("A bat has fur and flies. Is it a bird?", "\U0001F987", "no - feathers make a bird, and a bat has fur", ["yes, because it flies", "yes, because it has wings"],
                   "Flying is not on the list. What an animal is covered in tells you far more."),
                 q("A kitten is born with its eyes shut and a chick hatches ready to walk. Are both newly born?", "\U0001F425", "yes - different animals are born at different stages of readiness", ["no, only the chick is really newborn", "no, only the kitten is"],
                   "Being newborn does not mean being helpless. It depends on the animal."),
              ]},
...
LESSON["warmup"] = [
    q("Which animal has feathers?", "\U0001FAB6", "a duck", ["a cat", "a fish"], "A duck is a bird, and every bird has feathers."),
    q("Are people animals?", "\U0001F9D2", "yes", ["no"], "People are animals too. We grow, we eat, and we have young, like other animals."),
]
...
LESSON["home"] = [
    home("Covering hunt", "A grown-up, a garden, a park or a window, paper and a pencil",
         ["Go outside with a grown-up, or look out of a window.",
          "Spot five animals: birds, insects, a cat, a dog, a snail. Look, do not touch.",
    ...
    home("Family look-alikes", "A family you know, or a book with pictures of animals and their young",
         ["Look at a family you know, or an animal and its young in a book.",
          "Find two things the young one shares with one parent, and two it shares with the other.",
          "Say one thing that is different from both."],

    ...
    "steps": [
        ...
        step("tester", "Test the materials", "\U0001F52C", "Material tester", ["2Cp.01", "2Cp.03", "2TWSc.02"],
             ...
             explain(
                 ...
                 ["Choose glass.", "Press it: hard.", "Bend it: stiff.", "Hold it up: see-through.", "Pour water: waterproof.", "Four properties, one material.",
                  "Now choose wool and see how different its answers are."],
             ...
             {"need": 4,
              ...
              "materials": [
                  ...
                  {"id": "wood", "pic": "\U0001FAB5", "label": "wood", "props": {"press": "hard", "bend": "stiff", "light": "not see-through", "water": "waterproof"}, "animates": {"bend": False}},
        ...
        step("record", "Record: is it waterproof?", "\U0001F4DD", "Recorded it", ["2TWSc.06", "2Cp.03"],
             ...
             explain(
                 ...
                 ["Glass: waterproof.", "Wool: soaked up the water.", "Wood: waterproof.", "Sponge: soaked it up."],
                 [],
             ...
             {"ask": "Was %s waterproof?",
              ...
              "rows": [
                  ...
                  {"pic": "\U0001FAB5", "label": "wood", "answer": "yes", "why": "the water ran off the wood."},
        ...
        step("questions", "The right material for the job", "\U0001F3E0", "Right material", ["2Cp.02"],
             "Why was this material chosen? Tap the property that made it the right one.",
             explain(
                 ["People choose a material for a job because of its properties."],
        ...
        step("context", "The science in everyday things", "\U0001F527", "How it works", ["2SIC.02", "2Cp.02"],
             ...
             explain(
                 ...
                 ["A kettle is metal on the outside because metal is strong, and the handle is plastic because plastic does not get hot.",
             ...
             {"items": [
                 {"pic": "\U0001FAD6", "label": "kettle", "say": "The body is metal, which is strong and does not melt. The handle is plastic, because plastic does not carry the heat to your hand."},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["2Cm.01", "2Cp.01", "2Cp.02", "2Cp.03"],
             ...
             {"items": [
                 ...
                 q("Which is the best material for a towel?", "\U0001F9FB", "cotton, because it soaks up water", ["glass, because it is see-through", "metal, because it is hard"], "A towel has to soak water up."),
             ]},

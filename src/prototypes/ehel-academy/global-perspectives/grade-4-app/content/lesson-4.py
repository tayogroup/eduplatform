...
LESSON = {
    ...
    "steps": [
        ...
        step("text", "The company's leaflet", "\U0001F4CB", "Leaflet reader", ["4Es.01"],
             "The supermarket company handed out a leaflet at the market. Find the sentences that show what the AUTHOR thinks. Then say what the viewpoint is.",
             explain(
             ...
             {"reasonsNeeded": 2,
              "rounds": [
                 {"topic": "keeping the field and the small shops", "tag": "shops", "pic": "\U0001F9D4\U0001F3FE", "ask": "What do you think of Mr Omar's view?",
                  ...
                  "stances": [{"id": "agree", "t": "I agree with Mr Omar"}, {"id": "part", "t": "I partly agree with Mr Omar", "mixed": True}, {"id": "disagree", "t": "I disagree with Mr Omar"}],
                 ...
                 {"topic": "cheaper food closer to home", "tag": "cheaper", "pic": "\U0001F469\U0001F3FD", "ask": "What do you think of Mrs Farah's view?",
                  ...
                  "stances": [{"id": "agree", "t": "I agree with Mrs Farah"}, {"id": "part", "t": "I partly agree with Mrs Farah", "mixed": True}, {"id": "disagree", "t": "I disagree with Mrs Farah"}],
...
LESSON["home"] = [
    ...
    home("Find the viewpoint", "A leaflet, an advert or a letter you were given, and a grown-up",
         ["Find who wrote it.",

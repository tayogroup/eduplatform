...
function pqhcd_context_rows(stdClass $context): array {
    return [
        ...
        'externalwebsiteurl' => (string)($context->externalwebsiteurl ?? ''),
        'domainmanagement' => (string)($context->domainmanagement ?? ''),
        'portallabel' => (string)($context->portallabel ?? ''),
        'brandingsource' => (string)($context->brandingsource ?? ''),
        'intakelocation' => (string)($context->intakelocation ?? ''),
        'integrationmethod' => (string)($context->integrationmethod ?? ''),
        'returnurl' => (string)($context->returnurl ?? ''),

        ...
        step("context", "File sizes", "\U0001F4E6", "Size thinker", ["4CS.05"],
             ...
             explain(
                 ...
                 ["A page of text is a few kilobytes: letters are small.", "A photo is a few megabytes: millions of coloured dots.",
                  "A song is a few megabytes: thousands of sounds a second.", "A film is gigabytes: many pictures every second, plus the sound."],
             ...
             {"items": [
              ...
              "then": {"ask": "Which is usually the BIGGEST file?",

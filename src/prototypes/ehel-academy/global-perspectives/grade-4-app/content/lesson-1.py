...
LESSON = {
    ...
    "steps": [
        step("demo", "A question that opens a journey", "\U0001F35E", "Journey asker", ["4Rq.01"],
             "Omar sells bread and bananas. Amal wants to understand how they got there. Press <b>Next</b> and hear the questions she constructs.",
             explain(
             ...
             {"frames": [
                 {"pic": "\U0001F3EA", "cap": "Amal is in Omar's shop. A loaf and a bunch of bananas. <b>Where did they come from?</b>", "say": "Amal is in Omar's shop. A loaf and a bunch of bananas. Where did they come from? She wants to understand the journey."},
                 ...
                 {"pic": "\U0001F6A2", "cap": "Then: <b>how did the bananas get here from so far away?</b>", "say": "Then: how did the bananas get here from so far away? Bananas do not grow in our town. That opens the middle of the journey.", "sound": "ding"},
        ...
        step("explore", "The stages of a food journey", "\U0001F69A", "Journey mapper", ["4Rq.01"],
             ...
             {"items": [
                 {"pic": "\U0001F33E", "label": "grown", "say": "Grown. Wheat in a field, bananas on a plant in a hot country. Question: where, and by whom?"},
                 {"pic": "\U0001F6A2", "label": "moved", "say": "Moved. By lorry, by ship, by train. Question: how far, and how long did it take?"},
                 {"pic": "\U0001F3EA", "label": "sold", "say": "Sold. In Omar's shop, at the market, in the supermarket. Question: who chose the price?"},
        ...
        step("askq", "Construct your questions about food", "❓", "Question builder", ["4Rq.01"],
             ...
             {"topic": "the journey of our food", "words": ["What", "Where", "Why", "How", "How far", "How many"],
              "ends": [
                  {"id": "wheat", "t": "was the wheat in our bread grown?", "words": ["Where"], "asks": "where the wheat was grown"},
                  {"id": "ship", "t": "do bananas get here from a hot country?", "words": ["How"], "asks": "how bananas travel"},
                  {"id": "days", "t": "days does a banana take to reach the shop?", "words": ["How many"], "asks": "the days a banana travels"},
                  {"id": "far", "t": "does a banana travel to reach us?", "words": ["How far"], "asks": "the distance a banana travels"},
                  {"id": "cold", "t": "are bananas kept cold on the ship?", "words": ["Why"], "asks": "the reason for keeping bananas cold"},
              ...
              "rounds": [
                  ...
                  {"want": "the way bananas travel from a hot country", "pic": "\U0001F6A2", "word": "How", "end": "ship", "why": "How asks for the way it is done. By ship, in a cold hold."},
                  ...
                  {"want": "the distance a banana travels", "pic": "\U0001F30D", "word": "How far", "end": "far", "why": "How far asks for a distance."},
        ...
        step("sort", "Does it open the journey?", "\U0001F9E0", "Question judge", ["4Rq.01"],
             ...
             {"ask": "Would it help me understand the journey of our food?",
              ...
              "items": [
                  {"pic": "\U0001F30D", "label": "How far does a banana travel to reach us?", "bin": "yes", "why": "A distance you cannot guess. It opens the moving stage."},
        ...
        step("text", "Locate the answers in the text", "\U0001F4C4", "Answer locator", ["4Ri.01"],
             ...
             {"title": "The journey of a banana",
              "lines": [
                  "Bananas grow on tall plants in hot countries near the equator, such as Ecuador and Ghana.",
        ...
        step("source", "Locate it in the market", "\U0001F3EA", "Market finder", ["4Ri.01"],
             ...
             {"scene": "market", "need": 5, "caption": "Tap the stalls and signs to see what each one tells us about where food comes from.",
              "spots": [
                  spot("bread", "the bread stall", "The baker made this bread at four o'clock this morning, from flour milled twenty miles away.", 70, 150, "\U0001F35E"),
                  spot("bananas", "the banana box", "The box says: Produce of Ecuador. These bananas crossed an ocean.", 160, 155, "\U0001F34C"),
                  spot("apples", "the apple crate", "A chalk sign says: picked yesterday at Mill Farm, two miles up the road.", 250, 150, "\U0001F34E"),
              ...
              "rounds": [
                  {"ask": "Which part shows food that crossed an OCEAN?", "about": "food that crossed an ocean", "spot": "bananas", "why": "The box says Produce of Ecuador."},
                  {"ask": "Which part shows food grown CLOSEST to the market?", "about": "food grown closest", "spot": "apples", "why": "Mill Farm, two miles up the road."},
                  ...
                  {"ask": "Which part shows food kept fresh with ICE?", "about": "food kept fresh with ice", "spot": "fish", "why": "The fish counter: packed in ice overnight."},
              ]},
        ...
        step("questions", "Questions and journeys", "\U0001F4AC", "Question judge", ["4Rq.01", "4Ri.01"],
             ...
             {"label": "Question", "items": [
                 q("Which question OPENS a stage of the food journey?", "\U0001F9E0", "How far does a banana travel to reach us?", ["Are bananas yellow?", "What is my favourite fruit?"], "A distance you cannot guess, about the moving stage."),
                 ...
                 q("Which part of the market showed food grown two miles away?", "\U0001F34E", "the apple crate", ["the banana box", "the fish counter"], "Mill Farm, two miles up the road."),
        ...
        step("quiz", "Show what you know", "⭐", "Star researcher", ["4Rq.01", "4Ri.01"],
             ...
             {"items": [
                 ...
                 q("Where do bananas grow?", "\U0001F34C", "in hot countries near the equator", ["in our town", "on the ship", "in the shop"], "The first sentence of the text."),
...
LESSON["lecture"] = [
    part("\U0001F3EA", "Amal in the shop",
         "A loaf and a bunch of bananas on Omar's shelf. Amal wants to understand how they got there, so she constructs her own questions about the journey."),
    part("❓", "Questions that open a stage",
         "Where was the wheat grown? How did the bananas get here from so far away? How many days did they travel? Each one Amal cannot answer yet, and each one opens a stage of the journey. Are bananas yellow? She can see. That opens nothing."),
    ...
    part("\U0001F3EA", "A market answers too",
         "The banana box says Produce of Ecuador. The apple sign says Mill Farm, two miles up the road. The fish is packed in ice from the coast. Locate the part that answers your question."),
]

LESSON["words"] = [
    word("journey", "\U0001F69A", "The way something travels from where it starts to where it ends.",
         ["A banana's journey crosses an ocean.", "Food has a journey in four stages."]),
    ...
    word("equator", "\U0001F30D", "The imaginary line round the middle of the Earth, where it is hottest.",
...
LESSON["lookback"] = {
    ...
    "changed": [
        ...
        {"before": "To find an answer I read the whole text.", "after": "I locate the one sentence that answers my question."},
    ],
}

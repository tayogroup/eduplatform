...
PLAYGROUND = (
    [glyph("\U0001F964", "bottle", "a plastic bottle")] * 5 +
    ...
    "steps": [
        step("demo", "Choose the way that fits", "\U0001F52C", "Waste investigator", ["4Rc.01"],
             ...
             explain(
                 ...
                 ["How many bottles are on the playground? You can see them: observe and count.",
             ...
             {"frames": [
                 ...
                 {"pic": "\U0001F4DD", "cap": "<b>What do you do with an empty carton?</b> You cannot see that. ASK a questionnaire.", "say": "What do you do with an empty juice carton at home? Nobody can see that. Ask everyone the same question on a questionnaire.", "sound": "pop"},
        ...
        step("observe", "Observe the playground after lunch", "\U0001F440", "Litter counter", ["4Rc.01", "4Rf.01"],
             ...
             explain(
                 ...
                 ["Count the bottles: tap every bottle. Five.", "Then the apple cores. Then the paper. Then the cartons."],
                 ["Children count everything they see, leaves included.", "Count only what you are looking for."],
                 ["Tap every bottle, then every apple core, then every piece of paper, then every carton."]),
             {"title": "Litter on the playground after lunch", "columns": ["Litter", "How many"],
              "scene": PLAYGROUND,
              "rounds": [
                  {"kind": "bottle", "label": "Bottles", "pic": "\U0001F964", "ask": "Count the plastic bottles. Tap each one."},
                  {"kind": "core", "label": "Apple cores", "pic": "\U0001F34E", "ask": "Now the apple cores. Tap each one."},
                  {"kind": "paper", "label": "Paper", "pic": "\U0001F4C4", "ask": "Now the pieces of paper. Tap each one."},
                  {"kind": "carton", "label": "Cartons", "pic": "\U0001F9C3", "ask": "Now the juice cartons. Tap each one."},
              ]},
        ...
        step("pictogram", "What the litter count shows", "\U0001F4CA", "Litter chart reader", ["4Rf.01"],
             ...
             explain(
                 ["What you counted is now a chart.", "The longest bar is the litter we drop most."],
                 [],
                 [],
             ...
             {"fromObserve": True, "display": "bars", "title": "Litter on the playground after lunch",
              "items": [
                  {"ask": "Which litter was there MOST of?", "check": {"kind": "most"},
                   "opts": [opt("Bottles", True), opt("Paper", False), opt("Apple cores", False)], "why": "Bottles: five, the longest bar."},
                  ...
                  {"ask": "How many more bottles than cartons?", "check": {"kind": "difference", "a": "Bottles", "b": "Cartons"},
        ...
        step("organiser", "Which bin does it belong in?", "\U0001F5C2️", "Waste sorter", ["4Rf.01"],
             ...
             explain(
                 ...
                 ["A plastic bottle: recycling.", "An apple core: compost. It rots into soil.", "A crisp packet: rubbish. It cannot be recycled or composted."],
                 [],
             ...
             {"title": "Where our waste should go", "ask": "Recycling, compost, or rubbish?",
              ...
              "items": [
                  {"pic": "\U0001F964", "label": "a plastic bottle", "bin": "rec", "why": "Plastic bottles are recycled into new plastic."},
                  {"pic": "\U0001F34E", "label": "an apple core", "bin": "comp", "why": "It rots into soil for the garden."},
                  {"pic": "\U0001F96B", "label": "a crisp packet", "bin": "rub", "why": "Shiny crisp packets cannot be recycled here."},
        ...
        step("questions", "Observing, asking, measuring", "\U0001F4AC", "Investigation judge", ["4Rc.01", "4Rf.01"],
             ...
             {"label": "Question", "items": [
                 q("How many bottles are on the playground? Best way to find out?", "\U0001F964", "observe and count", ["ask the class", "measure with a gauge"], "You can see bottles. Count them."),
        ...
        step("quiz", "Show what you know", "⭐", "Star investigator", ["4Rc.01", "4Rf.01"],
             ...
             {"items": [
                 ...
                 q("Which litter was there most of?", "\U0001F964", "bottles", ["paper", "apple cores", "cartons"], "Five, the longest bar."),
...
LESSON["lecture"] = [
    ...
    part("\U0001F440", "Observing",
         "Count one kind of thing at a time, and decide first what counts. Leaves fell from the tree, so they are not litter. Five bottles, three apple cores, four pieces of paper, two cartons."),

    ...
    "steps": [
        ...
        step("quiz", "Show what you know", "⭐", "Star reflector", ["2Fv.01", "2Fl.01", "2Ap.01", "2Mi.01"],
             ...
             {"items": [
                 ...
                 q("Three children play football. The football bar, the tally and the number 3 all…", "\U0001F4CA", "show the same finding", ["show different surveys", "only show opinions", "disagree"], "One finding, drawn three ways."),
                 ...
                 q("I think we should recycle more, because it saves paper. What does my opinion still need?", "\U0001F4AD", "another reason about recycling", ["a reason about my bike", "nothing", "a picture"], "At least two reasons, all about the topic."),
                 ...
                 q("Leo said he went to the beach every Saturday. Which question is relevant?", "\U0001F3D6️", "What did you do at the beach?", ["Do you like maths?", "What is your cat called?", "Can you play the guitar?"], "It is about what he said."),
             ]},

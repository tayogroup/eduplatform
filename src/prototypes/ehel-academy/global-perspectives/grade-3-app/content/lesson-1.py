...
LESSON = {
    ...
    "steps": [
        step("demo", "Questions that help me understand", "\U0001F4A7", "Understanding asker", ["3Rq.01"],
             ...
             explain(
                 ["At Stage 3 you make your own questions, and the good ones help you understand the topic.",
        ...
        step("askq", "Make your own questions about water", "❓", "Question maker", ["3Rq.01"],
             ...
             {"topic": "water where we live", "words": ["What", "Where", "Why", "How", "How much", "How many"],
              "ends": [
                  ...
                  {"id": "clean", "t": "do they clean dirty water?", "words": ["How", "Why"], "asks": "the cleaning of water"},
                  {"id": "litres", "t": "litres does our school use in a day?", "words": ["How many"], "asks": "the school's daily litres"},
                  {"id": "winter", "t": "is the river higher in winter?", "words": ["Why"], "asks": "the river in winter"},
              ],
              "rounds": [
                  ...
                  {"want": "the reason the river is higher in winter", "pic": "\U0001F327️", "word": "Why", "end": "winter", "why": "Why asks for a reason: more rain."},
              ]},
        ...
        step("source", "Find it in the kitchen", "\U0001F373", "Kitchen finder", ["3Ri.01"],
             ...
             {"scene": "kitchen", "need": 5, "caption": "Tap the things in the kitchen to see what each one tells us about water.",
              "spots": [
                  ...
                  spot("kettle", "the kettle", "The kettle heats water for tea. It holds about one and a half litres.", 250, 130, "\U0001FAD6"),
                  spot("bottle", "the water bottle", "Tap water is safe to drink, so we can fill a bottle from the tap.", 60, 120, "\U0001F9F4"),
                  spot("plant", "the plant on the windowsill", "Plants need water too. This one gets a cup every day.", 160, 60, "\U0001FAB4"),
              ],
              "rounds": [
                  ...
                  {"ask": "Which thing shows that tap water is safe to drink?", "about": "that tap water is safe to drink", "spot": "bottle", "why": "We fill a bottle from the tap and drink it."},
        ...
        step("questions", "Questions and answers", "\U0001F4AC", "Question judge", ["3Rq.01", "3Ri.01"],
             ...
             {"label": "Question", "items": [
                 q("Which question helps you UNDERSTAND water?", "\U0001F9E0", "Where does our tap water come from?", ["Is water wet?", "What colour is my bottle?"], "You cannot answer it yet, and it is about how water works."),
...
LESSON["words"] = [
    ...
    word("litre", "\U0001F9F4", "A measure of how much water: a big bottle holds about one litre.",

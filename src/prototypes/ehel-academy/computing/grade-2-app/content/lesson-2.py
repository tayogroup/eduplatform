        ...
        step("bugs", "Find the bug and fix it: bedtime", "\U0001F6CF️", "Bedtime debugger", ["2CT.02"],
             ...
             {"scene": "bed", "rounds": [
                 {"goal": "Get ready for bed",
                  ...
                  "fix": {"opts": [choice("teeth", "Brush your teeth", True, "\U0001FAA5"), choice("tv", "Watch television for an hour", False, "\U0001F4FA"), choice("coat", "Put on your coat", False, "\U0001F9E5")],
                          "why": "Brushing your teeth is the step that belongs there."},
                  "done": "Pyjamas, teeth, story, bed, lights off."},
                 {"goal": "Get ready for bed",
                  "steps": [s("pyjamas", "Put on pyjamas", "\U0001F454"), s("teeth", "Brush your teeth", "\U0001FAA5"), s("story", "Read a story", "\U0001F4D6"), s("lights", "Lights off", "\U0001F4A1"), s("bed", "Get into bed", "\U0001F6CF️")],

...
LESSON = {
    ...
    "steps": [
        step("order", "From frogspawn to frog", "\U0001F438", "Frog life", ["3Bp.04"],
             ...
             {"items": [
                 {"pic": "\U0001F95A", "label": "frogspawn", "say": "It starts as frogspawn: eggs in jelly, floating in the pond."},
                 {"pic": "\U0001F41F", "label": "tadpole", "say": "A tadpole hatches. It has a tail and no legs, and it breathes in the water."},
                 {"pic": "\U0001F9B5", "label": "tadpole with legs", "say": "Back legs grow first, then front legs. The tail starts to shrink."},
                 {"pic": "\U0001F438", "label": "froglet", "say": "A froglet: four legs and a stub of tail. It can climb out of the water."},
        ...
        step("sort", "Changes shape, or just grows?", "\U0001F5C2️", "How it grows", ["3Bp.04", "3TWSc.01"],
             ...
             {"ask": "Small adult, or a new shape?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F41F", "label": "tadpole", "bin": "change", "why": "A tadpole grows legs, loses its tail and becomes a frog."},
                  ...
                  {"pic": "\U0001F41E", "label": "ladybird larva", "bin": "change", "why": "A ladybird larva looks like a tiny crocodile, then changes into a ladybird."},
                  {"pic": "\U0001F431", "label": "kitten", "bin": "same", "why": "A kitten is a small cat."},
              ]},
             "Mammals and birds keep their shape. Frogs and insects change it."),
        ...
        step("record", "How long until it is grown?", "\U0001F4CB", "Growing table", ["3TWSc.06", "3Bp.04"],
             ...
             explain(
                 ...
                 ["A butterfly: a few weeks.", "A frog: a few months.", "A human: many years."],
                 [],
             ...
             {"ask": "How long does a %s take to grow up?",
              ...
              "rows": [
                  ...
                  {"pic": "\U0001F438", "label": "frog", "answer": "months", "why": "frogspawn to frog takes a few months."},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Bp.04", "3TWSm.01", "3TWSc.06"],
             ...
             {"items": [
                 ...
                 q("Which legs grow first on a tadpole?", "\U0001F9B5", "the back legs", ["the front legs", "all four at once"], "Back legs first, then front."),
...
LESSON["home"] = [
    home("Watch tadpoles", "A pond with frogspawn in spring, a grown-up, a notebook. Look, do not take.",
         ["Visit the same pond every week.",
    ...
    home("Caterpillar hunt", "A cabbage patch or nettles, a magnifying glass",
         ["Look under leaves for eggs, caterpillars or a chrysalis.",
          "Draw what you find and leave it where it is.",
          "Come back in a week and look again."],

...
(function (window, document) {
  ...
  function injectCssOnce() {
    ...
    style.textContent = [
      ...
      '.pq-match-popup{position:fixed;left:50%;top:16%;transform:translateX(-50%) scale(.96);z-index:10050;max-width:min(92vw,520px);padding:18px 22px;border-radius:24px;background:linear-gradient(180deg,#ffffff 0%,#fff7dc 100%);border:2px solid rgba(242,184,63,.55);box-shadow:0 22px 60px rgba(15,23,42,.22);font-weight:900;font-size:1.05rem;text-align:center;color:#243548;opacity:0;pointer-events:none;transition:opacity .18s ease,transform .18s ease;}',
      ...
      '.tile .pq-match-mark{position:absolute !important;top:10px !important;right:12px !important;width:44px !important;height:44px !important;border-radius:999px !important;display:flex !important;align-items:center !important;justify-content:center !important;font-size:1.55rem !important;font-weight:1000 !important;z-index:999 !important;border:4px solid #fff !important;box-shadow:0 10px 22px rgba(0,0,0,.22) !important;pointer-events:none !important;direction:ltr !important;}',

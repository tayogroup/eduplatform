    ...
    "steps": [
        step("demo", "Six skills, one year on", "\U0001F9E9", "Six skills", ["2Fv.01"],
             ...
             {"frames": [
                 ...
                 {"pic": "\U0001FA9E", "cap": "<b>Looking back.</b> What I learned, and which activity helped me learn it. That is this lesson.", "say": "Looking back. What I learned, and which activity helped me learn it. That is this lesson.", "sound": "tada"},
             ]},
        ...
        step("explore", "Which skill grew?", "\U0001F9E9", "Skill spotter", ["2Fv.01"],
             ...
             {"items": [
                 ...
                 {"pic": "\U0001FA9E", "label": "Looking back", "say": "Looking back. Last year, what I liked. This year, which activity helped me learn."},
             ], "need": 6,
        ...
        step("lookback", "What I learned, and what helped", "\U0001FA9E", "I looked back", ["2Fv.01", "2Fl.01"],
        ...
        step("know", "My talk about finding things out", "\U0001F50D", "Finding-out expert", ["2Mi.01"],
             ...
             explain(
                 ["You did it for seven lessons. Now say it."],
             ...
             {"asker": YASMIN,
              "rounds": [
                  {"ask": "How did we find out what the class plays at playtime?", "about": "the interview", "pic": "\U0001F399️",
                   "opts": [tagged("We interviewed everyone and recorded it as bars.", "the interview"), tagged("We painted the sky first.", "the backdrop"), tagged("I had toast.", "breakfast")],
                   "why": "She asked how we found out. The interview is how."},
                  {"ask": "Who would know when the strawberries are ready?", "about": "the farmer", "pic": "\U0001F353",
                   "opts": [tagged("The farmer, because the farmer grows them.", "the farmer"), tagged("The bus driver, because buses are fast.", "the bus driver"), tagged("The sea is salty.", "the sea")],
                   "why": "Different people know different things. The farmer grows the strawberries."},
        ...
        step("sort", "Which skill was it?", "\U0001F9E9", "Skill sorter", ["2Fv.01"],
             ...
             {"ask": "Which skill was this?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F3AD", "label": "suggesting a scarecrow when the team was stuck", "bin": "team", "why": "An idea for the team is working together."},
        ...
        step("quiz", "Show what you know", "⭐", "Star reflector", ["2Fv.01", "2Fl.01", "2Ap.01", "2Mi.01"],
             ...
             {"items": [
                 q("What is a focused question?", "\U0001F3AF", "one about the exact problem, that you can find out", ["any question", "a long question", "a question about the moon"], "About the topic, about the problem, findable."),
                 q("Pictures, bars and numbers can all…", "\U0001F4CA", "show the same findings", ["show different surveys", "only show opinions", "confuse people"], "Same findings, drawn three ways."),
                 q("Does the baker know where the buses go?", "\U0001F469\U0001F3FE‍\U0001F373", "No, different people know different things", ["Yes, bakers know everything", "Nobody knows"], "Ask the person whose job it is."),
                 q("Omar talked during the story. Who else did that reach?", "\U0001F467\U0001F3FD", "Nora, who could not hear it", ["nobody", "only Omar", "the teacher's dog"], "What you do reaches others."),
                 q("How many reasons does a Stage 2 opinion have?", "\U0001F4AD", "two, both about the topic", ["none", "one about anything", "ten"], "Two reasons, on the topic."),
                 q("What got the team unstuck when the paint ran out?", "\U0001F7E9", "an idea: mix it with white", ["giving up", "arguing", "painting the hills red"], "An idea gets the team unstuck."),
                 q("What is looking back at Stage 2?", "\U0001FA9E", "saying what you learned and which activity helped", ["turning around", "a survey", "a kind of source"], "What I learned, and what helped me learn it."),
                 q("Which is a relevant question after Leo said he misses the waves?", "\U0001F30A", "Why do you miss the waves at night?", ["Do you like maths?", "What is your cat called?", "Can you play the guitar?"], "It is about what he said."),
             ]},
...
LESSON["words"] = [
    ...
    word("look back", "\U0001FA9E", "To think about what you did and say what you learned and what helped.",
    ...
    word("sharper", "\U0001F52A", "Better and more exact than before.",

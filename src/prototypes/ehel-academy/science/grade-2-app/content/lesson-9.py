        ...
        step("questions", "Rock check", "✅", "Rock check", ["2ESp.01", "2ESp.02", "2ESp.03"],
             ...
             {"label": "Question", "items": [
              ...
              "extension": [
                 ...
                 q("Two children test the same rock for hardness and disagree. What would settle it?", "\U0001F50D", "both scratching it the same way, with the same thing", ["asking who is older", "nothing - hardness cannot be tested"],
                   "A test settles an argument only when both people do it the same way."),
              ]},

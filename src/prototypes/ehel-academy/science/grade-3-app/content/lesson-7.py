        ...
        step("questions", "Choose the equipment", "\U0001F9F0", "Right tool", ["3TWSc.02", "3TWSc.03"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Which would you use to see something very small?", "\U0001F50D", "a hand lens", ["a ruler"],
                   "A hand lens makes small things look bigger."),
                 q("Which measures how heavy something is?", "\u2696\uFE0F", "scales", ["a thermometer"],
              ...
              "extension": [
                 ...
                 q("You measure the same leaf twice and get 8 cm and then 9 cm. What should you do?", "\U0001F4CF", "measure again, carefully, and find out why they disagree", ["write down 8.5 cm and move on", "pick whichever you prefer"],
                   "Two different answers means something went wrong. Finding out what is part of the work."),
                 q("A measuring jug has marks every 10 millilitres. Can you use it to measure 5 millilitres?", "\U0001F964", "not accurately - the marks are not fine enough for that", ["yes, just guess halfway", "yes, jugs measure anything"],
                   "Equipment has to be fine enough for the amount you want. Choosing it is part of planning."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Cm.01", "3Cp.01", "3TWSc.03", "3TWSc.02"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Can you squash a solid into a smaller space?", "\U0001F9F1", "No", ["Yes"],
                   "There is nowhere for it to go. A gas has gaps in it and a solid has almost none."),
                 q("Can you hold a gas in your hand?", "\U0001F4A8", "No", ["Yes"],
                   "It spreads out and escapes between your fingers. A gas needs a container."),
              ],
              "extension": [
                 ...
                 q("Air has no colour and no smell. So how do you know it is really there?", "\U0001F388", "you can feel it move, and it fills a balloon out", ["you cannot - air might not be there at all", "you can see it if you look hard"],
                   "A thing you cannot see can still be measured by what it does. That is most of science."),
                 q("A balloon is squashed into a smaller shape and no air escapes. What happened to the gas inside?", "\U0001F388", "it was squeezed into less space, because a gas has gaps in it", ["some of it turned into a liquid", "nothing at all happened to it"],
                   "A gas can be squashed because there is space between its parts. A liquid has almost none."),
              ]},

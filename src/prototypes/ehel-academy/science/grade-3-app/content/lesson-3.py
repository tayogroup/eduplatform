        ...
        step("questions", "Which group?", "✅", "Group check", ["3Bs.02"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Does a cat feed its kittens milk?", "\U0001F408", "Yes", ["No"],
                   "Milk for the young is what puts an animal in the mammals."),
                 q("Where does a fish live?", "\U0001F41F", "in water", ["on land"],
                   "In water, breathing through gills all its life."),
              ],
              "extension": [
                 ...
                 q("An animal has smooth damp skin and lays its eggs in water. Which group, and what will its young be like?", "\U0001F438", "an amphibian, and its young start as tadpoles in the water", ["a reptile, and its young hatch on land", "a fish, and its young have gills for ever"],
                   "Two features name the group, and the group then tells you what to expect."),
                 q("Why can two animals in the SAME group look completely different, like a bat and a whale?", "\U0001F433", "a group is decided by a few key features, not by size or shape", ["they cannot - same group means same shape", "one of them is in the wrong group"],
                   "Fur and milk put both in the mammals. Everything else about them is free to differ."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Bs.02", "3TWSc.01", "3TWSm.01"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Is a frog an amphibian?", "\U0001F438", "Yes", ["No"],
                   "Smooth damp skin and a tadpole start. That is an amphibian."),
                 q("Does a fish have gills?", "\U0001F41F", "Yes", ["No"],
                   "Gills all its life, which is how a fish breathes under water."),
              ],
              "extension": [
                 ...
                 q("An insect has six legs and three body parts. Why count BOTH, rather than just the legs?", "\U0001F41C", "two features together are far more certain than one", ["the legs alone are enough", "the body parts alone are enough"],
                   "One feature can mislead you. Two agreeing is much harder to get wrong."),
                 q("Nobody has ever seen a living dinosaur. So how do scientists decide which group one belongs to?", "\U0001F995", "from its bones - the features that decide a group are in the skeleton", ["they guess from the pictures", "dinosaurs are in no group at all"],
                   "A skeleton carries the evidence: a backbone, the shape of the jaw, how the legs join on."),
              ]},

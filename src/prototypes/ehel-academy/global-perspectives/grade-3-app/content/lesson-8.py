...
LESSON = {
    ...
    "steps": [
             ...
             {"asker": YASMIN,
              "rounds": [
                  ...
                  {"ask": "What is a strength and what is a limitation of your teamwork?", "about": "strengths", "pic": "\U0001F4AA",
                   "opts": [tagged("A strength is what I did well; a limitation is what took more than one go.", "strengths"), tagged("A strength is being first in the line.", "the line"), tagged("My shoes are blue.", "shoes")],
        ...
        step("quiz", "Show what you know", "⭐", "Star reflector", ["3Fv.01", "3Fl.01", "3Ap.01", "3Mi.01"],
             ...
             {"items": [
                 q("Lesson one: which kind of question helps you understand a topic?", "\U0001F9E0", "you cannot answer it yet and it is about how the topic works", ["everybody knows the answer", "it is about you", "it is short"], "Lesson one."),

        ...
        step("questions", "Which part?", "✅", "Which part?", ["1Bs.01"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Which part of a plant would you smell?", "\U0001F337", "the flower", ["the roots"],
                   "Flowers are the part with the scent, and the scent is what brings insects."),
                 q("Is a tree a plant?", "\U0001F333", "Yes", ["No"],
                   "A tree is a plant, and so is grass, and so is a daisy."),
              ],
              "extension": [
                 ...
                 q("A plant's stem is cut right through. The leaves still have plenty of light. Why do they go limp?", "\U0001F33F", "water cannot get up to them any more", ["they have run out of light", "nothing happens, they still have light"],
                   "The stem is the pipe. Cut it and the leaves are cut off from the water the roots take in."),
                 q("Grass has no big bright flower. So how does it make seeds?", "\U0001F33E", "it has small flowers you hardly notice", ["grass does not make seeds", "its leaves make the seeds"],
                   "Every flowering plant has flowers, even when they are tiny and green instead of big and bright."),
              ]},

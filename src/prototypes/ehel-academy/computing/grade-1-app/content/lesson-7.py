    ...
    "steps": [
        ...
        step("quiz", "Show what you know", "⭐", "Star computer scientist", ["1DC.01", "1DC.02", "1DC.03", "1DC.04"],
             ...
             {"items": [
                 ...
                 q("What is the internet?", "\U0001F30D", "many computers connected together around the world", ["one big computer that holds everything", "a television that shows web pages", "a kind of wire that goes into the wall"], "The internet is millions of computers joined together around the world."),
...
tier(LESSON,
     ...
     extension=[
         q("The school network is working but the internet is off. What still works?", "\U0001F5A8\ufe0f",
           "printing to the school printer",
           ["a video call to another school", "searching the web", "sending an email"],
           "The printer is on your own network. Your tablet can still reach it. The other three have to leave the school, and that needs the internet."),

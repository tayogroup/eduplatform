    ...
    "steps": [
        step("sort", "Is a program controlling it?", "\U0001F5C2️", "Control sorter", ["3CS.05"],
             ...
             {"ask": "Controlled by a program, or not?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F6D7", "label": "a lift", "bin": "prog", "why": "A program takes it to the floor you press."},
        ...
        step("sort", "Internet of Things, or not?", "\U0001F5C2️", "IoT sorter", ["3CS.06"],
             ...
             {"ask": "Internet of Things, or not?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F50C", "label": "a plug on a phone timer", "bin": "iot", "why": "A smart plug is connected."},
        ...
        step("order", "A robot builds a car", "\U0001F3ED", "Line orderer", ["3CS.07"],
             ...
             {"items": [
                 ...
                 s("wheels", "A robot fits the wheels", "\U0001F6DE"),
        ...
        step("explore", "Why robots?", "\U0001F916", "Robot reasoner", ["3CS.07"],
             ...
             explain(
                 ...
                 ["Children think robots took all the jobs.", "They took the heavy, dangerous and repeated ones. The people programme and check."],
                 ["Tap all five."]),
             {"items": [
        ...
        step("quiz", "Show what you know", "⭐", "Star computer scientist", ["3CS.05", "3CS.06", "3CS.07"],
             ...
             {"items": [
                 q("A lift going to floor 3 when you press 3 is...", "\U0001F6D7", "a machine controlled by a program", ["magic", "a person pulling", "a network"], "A program moves it."),
...
LESSON["home"] = [
    ...
    home("A factory line at home", "Cards, a partner",

...
LESSON = {
    ...
    "steps": [
        step("demo", "Where do we look?", "\U0001F50E", "Where to look", ["1Es.01"],
             "Nora wants to find out where bread comes from. Press <b>Next</b> and see where she looks.",
             explain(
                 ["A source is somewhere you can find information.", "Some sources help with your topic. Some do not."],
                 ["Nora wants to know where bread comes from.", "A map of the sea will not tell her.", "The baker next door will."],
             ...
             {"frames": [
                 {"pic": "\U0001F467\U0001F3FD", "cap": "Nora wonders: <b>where does bread come from?</b>", "say": "Nora wonders: where does bread come from?"},
        ...
        step("explore", "Kinds of sources", "\U0001F4DA", "Source spotter", ["1Es.01"],
             ...
             {"items": [
                 ...
                 {"pic": "\U0001F9FA", "label": "a real thing", "say": "A real thing. A basket of fruit from the market shows you what grows near here."},
             ], "need": 6,
        ...
        step("sources", "Choose a source", "\U0001F3AF", "Source chooser", ["1Es.01"],
             ...
             {"rounds": [
                 ...
                 {"topic": "what fruit grows near our town", "tag": "fruit", "pic": "\U0001F96D",
                  "sources": [
                      source("basket", "a basket of fruit from the market", "\U0001F9FA", ["fruit", "food"], "A basket of fruit from the market is the real fruit that grows near here."),
                  ...
                  "reasons": [opt("because it is real fruit from near here", True), opt("because baskets are nice", False), opt("because it is heavy", False)],
                 ...
                 {"topic": "how bread is made", "tag": "bread", "pic": "\U0001F35E",
                  "sources": [
                      ...
                      source("music", "a music CD", "\U0001F4BF", ["music"], "A music CD plays music."),
                  ],
        ...
        step("opinion", "What do you think?", "\U0001F4AD", "Opinion giver", ["1Ea.01"],
             ...
             explain(
                 ["An opinion is what YOU think.", "Nobody can tell you your opinion is wrong."],
             ...
             {"rounds": [
                 {"topic": "fruit", "tag": "fruit", "pic": "\U0001F34E", "ask": "What do you think about fruit?",
                  ...
                  "reasons": [tagged("because it is sweet and juicy", "fruit"), tagged("because it is good for me", "fruit"), tagged("because some fruit is sour", "fruit"),
                 ...
                 {"topic": "vegetables", "tag": "vegetables", "pic": "\U0001F966", "ask": "What do you think about vegetables?",
                  ...
                  "reasons": [tagged("because they are crunchy", "vegetables"), tagged("because they help me grow", "vegetables"), tagged("because some taste bitter", "vegetables"),
                 ...
                 {"topic": "eating together at the table", "tag": "meals", "pic": "\U0001F37D️", "ask": "What do you think about eating together at the table?",
                  ...
                  "reasons": [tagged("because we talk about our day", "meals"), tagged("because everyone is there", "meals"), tagged("because it takes a long time", "meals"),
        ...
        step("questions", "Sources and opinions", "\U0001F4AC", "Source judge", ["1Es.01", "1Ea.01"],
             ...
             {"label": "Question", "items": [
                 q("Nora wanted to know where bread comes from. Which source helped?", "\U0001F35E", "the baker", ["a map of the sea", "a photo of football"], "The baker makes bread, so the baker knew."),
                 q("You want to know what fruit grows near your town. Which source?", "\U0001F96D", "a basket of fruit from the market", ["a book about trains", "a map of the sea"], "The basket holds the real fruit from near here."),
        ...
        step("quiz", "Show what you know", "⭐", "Star chooser", ["1Es.01", "1Ea.01"],
             ...
             {"items": [
                 q("What is a source?", "\U0001F4DA", "somewhere you can find information", ["a kind of sauce", "a game", "an opinion"], "A book, a photo, a map, a person, a film or a real thing."),
                 q("Which source shows you WHERE places are?", "\U0001F5FA️", "a map", ["a cookbook", "a music CD", "a football"], "A map shows where places are."),
                 q("You want to know how milk is made. Which source helps most?", "\U0001F95B", "a film about a dairy farm", ["a book about dinosaurs", "a bus ticket", "a photo of the beach"], "The dairy farm is where milk comes from."),
                 ...
                 q("Can somebody tell you your opinion is wrong?", "\U0001F4AD", "No, an opinion is what you think", ["Yes, always", "Only on Mondays"], "Your opinion is yours. The reason just has to be about the topic."),
...
LESSON["lecture"] = [
    part("\U0001F50E", "Where do we look?",
         "Nora wanted to know where bread comes from. A map of the sea did not help. A photo of football did not help. The baker did. The baker was the source that was about bread."),
    ...
    part("\U0001F4AD", "An opinion",
         "An opinion is what you think. I like fruit. I do not like vegetables much. Nobody can say your opinion is wrong. But your reason has to be about the thing: because it is sweet, not because my shoes are new."),

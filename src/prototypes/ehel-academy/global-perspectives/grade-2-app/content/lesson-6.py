    ...
    "steps": [
        step("demo", "A job and an idea", "\U0001F4A1", "Idea spotter", ["2Ct.01"],
             ...
             explain(
                 ...
                 ["Omar digs. Nora waters. You plant. That is everyone doing their job.",
                  "The birds eat the seeds. Sami has an idea: a scarecrow. That is an idea for the team."],
             ...
             {"frames": [
                 ...
                 {"pic": "\U0001F4A1", "cap": "Sami has an <b>idea</b>: make a scarecrow! Everybody says yes.", "say": "Sami has an idea: make a scarecrow! Everybody says yes.", "sound": "ding"},
        ...
        step("team", "Plant the vegetable patch", "\U0001F955", "Patch team", ["2Cc.01", "2Ct.01"],
             ...
             explain(
                 ...
                 ["Your job: water the seeds. Fill the can, carry it, pour gently.",
              ...
              "rounds": [
                  ...
                  {"kind": "idea", "who": "tariq", "situation": "The green paint is nearly gone, and the hills are only half done. The team is stuck.", "pic": "\U0001F7E9",
                   "opts": [{"t": "Let's mix the last green with white so it goes further.", "good": True, "log": "Your idea: mix the green with white to make it go further."},
                            ...
                            {"t": "Let's paint the hills red instead.", "good": False, "why": "Red hills look wrong, and there is no red either."}],
        ...
        step("quiz", "Show what you know", "⭐", "Star team player", ["2Cc.01", "2Ct.01", "2Fc.01", "2Ft.01"],
             ...
             {"items": [
                 ...
                 q("Whose idea was the step stool?", "\U0001FA9C", "Tariq's", ["Hana's", "yours", "Amal's"], "Tariq suggested it to reach the top."),
...
LESSON["lecture"] = [
    ...
    part("\U0001F426", "Stuck",
         "Then something goes wrong. The birds eat the seeds. The green paint runs out. Nobody can reach the top. The team is stuck, and doing your job harder does not fix it."),
...
LESSON["words"] = [
    word("idea", "\U0001F4A1", "Something you suggest that changes what the team does.",
         ["Sami's idea was a scarecrow.", "Whose idea was that?"]),
    ...
    word("suggest", "\U0001F5E3️", "To say an idea out loud for the team.",
         ["Suggest an idea.", "Nora suggested labels."]),

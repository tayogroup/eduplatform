...
WHY IT IS NOT ONLY ON THE HUB. build-grownup-section.py already puts each
lesson's materials in the teachers-and-parents section, which is the right place
...
WHY IT IS FOLDED. This is the reframe rather than a feature: Cambridge Stage 1 is
physical throughout - cubes, counters, spinners, water, sand, and a Learner's Book
that tells children not to write in it - and a screen cannot be any of that. The

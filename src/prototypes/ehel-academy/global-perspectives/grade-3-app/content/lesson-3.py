    ...
    "steps": [
        ...
        step("sort", "Conclusion, or just a guess?", "⚖️", "Conclusion judge", ["3Ad.01"],
             ...
             explain(
                 ...
                 ["Most children chose fruit: proved. Three is the biggest.", "Fruit is the tastiest: not proved. The chart does not measure taste."],
                 [],
             ...
             {"ask": "Does the chart prove it?",
              ...
              "items": [
                  {"pic": "\U0001F34E", "label": "Most children chose fruit", "bin": "yes", "why": "Fruit has 3, the most. Proved."},
        ...
        step("organiser", "Liked, healthy, or both?", "\U0001F5C2️", "Venn sorter", ["3Rf.01"],
             ...
             {"title": "Snacks we like and snacks that are healthy", "ask": "Liked only, both, or healthy only?", "venn": True,
              ...
              "items": [
                  ...
                  {"pic": "\U0001F36C", "label": "sweets", "bin": "like", "why": "Children like sweets, but they are not healthy. Liked only."},
        ...
        step("quiz", "Show what you know", "⭐", "Star analyst", ["3Ad.01", "3Rf.01"],
             ...
             {"items": [
                 ...
                 q("Did more children choose yoghurt than crisps?", "\U0001F963", "Yes, 2 is more than 1", ["No", "The same"], "Yoghurt 2, crisps 1."),
...
LESSON["lecture"] = [
    ...
    part("\U0001F4CB", "Numbers in a table",
         "A table works the same way. The tuck shop sold 30 crisps and 24 apples. Crisps sold most. Twelve more apples than flapjacks. Eighty-four snacks altogether."),

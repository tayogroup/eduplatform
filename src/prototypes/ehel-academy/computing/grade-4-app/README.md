...
- **The real block names.** Naming ScratchJr, Scratch and MakeCode closed
  ...
  maps the blocks it actually uses onto Scratch's move 10 steps, turn 90 degrees, go to x: 0 y: 0 and forever, and MakeCode's on button A pressed, show leds and play tone. Blocks with no equivalent here

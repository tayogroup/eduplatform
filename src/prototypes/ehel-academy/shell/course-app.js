...
import { mountLearnerControls } from "./learner-controls.js?v=20260907a";
...
export function createCourseApp(config) {
  ...
  // Raise a hand, the class chat and the Join class pill now live in
  // shell/learner-controls.js so the standalone Grade 1 Maths lessons can mount

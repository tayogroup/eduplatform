    ...
    "steps": [
        ...
        step("sort", "Sort by material", "\U0001F9F1", "Material sorter", ["1Cm.01", "1TWSc.01"],
             ...
             {"ask": "What material is it made from?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001FAD9", "label": "jar", "bin": "glass", "why": "A jar is made of glass. You can see through it."},
        ...
        step("tester", "Test the materials", "\U0001F52C", "Material tester", ["1Cp.01", "1Cp.02", "1TWSc.02"],
             ...
             {"need": 3,
              ...
              "materials": [
                  ...
                  {"id": "jar", "pic": "\U0001FAD9", "label": "glass jar", "props": {"press": "hard", "bend": "stiff", "look": "shiny", "water": "waterproof"}, "animates": {"bend": False}},
                  {"id": "bottle", "pic": "\U0001F9F4", "label": "plastic bottle", "props": {"press": "hard", "bend": "bendy", "look": "shiny", "water": "waterproof"}},
                  {"id": "paper", "pic": "\U0001F4C4", "label": "paper", "props": {"press": "soft", "bend": "bendy", "look": "dull", "water": "soaks up water"}},
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["1Cm.01", "1Cm.02", "1Cp.02", "1Cc.01"],
             ...
             {"items": [
                 ...
                 q("A pillow feels...", "\U0001F6CF️", "soft", ["hard", "rough", "stiff"], "A pillow presses in easily. That is soft."),
                 q("Which material is bendy?", "➰", "a rubber band", ["a stone", "a glass jar", "a brick"], "A rubber band bends and stretches."),

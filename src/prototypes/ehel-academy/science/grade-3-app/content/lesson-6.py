...
LESSON = {
    ...
    "steps": [
        step("demo", "Who eats whom?", "\U0001F33F", "Producers first", ["3Be.01", "3Bp.02"],
             "Press <b>Next</b> to follow the food from the grass to the fox.",
             explain(
                 ["A food chain shows who eats whom.", "It always starts with a plant, because plants make their own food from sunlight."],
                 ["Grass makes its food from sunlight: a producer.", "A rabbit eats the grass: a consumer.", "A fox eats the rabbit: a consumer too.", "The arrow means is eaten by."],
                 ["Children draw the arrow the wrong way.", "The arrow points from the food to the eater: grass, arrow, rabbit."],
                 ["Press Next and follow the arrows."]),
             {"frames": [
        ...
        step("build", "Build a food chain", "\U0001F527", "Chain builder", ["3Be.01", "3TWSm.02", "3TWSm.03"],
             "Make a model of a food chain: tap the producer first, then the consumers. Then break it.",
             explain(
                 ["A food chain diagram is a model of who eats whom.", "Build it, then take the plant away and see what happens."],
                 ["Grass first: the producer.", "Then the rabbit, which eats the grass.", "Then the fox, which eats the rabbit.", "Then take the grass away."],
        ...
        step("sort", "Producer, or consumer?", "\U0001F5C2️", "Producer sort", ["3Be.01", "3TWSc.01"],
             ...
             explain(
                 ...
                 ["Grass, an oak tree, seaweed, a dandelion: producers.", "A rabbit, an owl, a fish, a cow: consumers."],
             ...
             {"ask": "Producer, or consumer?",
              "bins": [{"id": "producer", "label": "Producer", "pic": "\U0001F33F"}, {"id": "consumer", "label": "Consumer", "pic": "\U0001F407"}],
              "items": [
                  ...
                  {"pic": "\U0001F33F", "label": "seaweed", "bin": "producer", "why": "Seaweed is a plant of the sea. It makes its food from sunlight."},
        ...
        step("context", "Breaking the chain", "\U0001F6A7", "Chains and us", ["3SIC.04", "3Be.01"],
             ...
             {"items": [
                 {"pic": "\U0001F9EA", "label": "spraying weedkiller", "say": "Weedkiller kills the plants. No plants, no caterpillars. No caterpillars, no food for the birds. One spray, three links gone."},
              ...
              "then": {"ask": "Why does killing the plants hurt the birds, which do not eat plants?",
                       "opts": [opt("The insects the birds eat need the plants", True), opt("Birds drink from plants", False), opt("It does not hurt them", False)],
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Be.01", "3TWSm.02", "3SIC.04"],
             ...
             {"items": [
                 q("Which is a producer?", "\U0001F33F", "seaweed", ["a fish", "a heron", "a snail"], "Seaweed is a plant."),
                 ...
                 q("The food chain you built was...", "\U0001F527", "a model of who eats whom", ["a real rabbit", "a picture of a garden"], "A model shows the idea."),
...
LESSON["words"] = [
    ...
    word("producer", "\U0001F33F", "A plant that makes its own food from sunlight.",
         ["Grass is a producer.", "Seaweed is a producer in the sea."]),
...
LESSON["home"] = [
    home("A garden food chain", "A garden or park, a magnifying glass, paper",
         ["Find a plant with a hole nibbled in a leaf.",
    ...
    home("What we do", "A walk in your street, paper",

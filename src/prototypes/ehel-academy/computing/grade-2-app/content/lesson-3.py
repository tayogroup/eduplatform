    ...
    "steps": [
        ...
        step("sort", "Same output, or different?", "\U0001F5C2️", "Output matcher", ["2P.03"],
             ...
             {"ask": "Same output, or different?",
              "bins": [{"id": "same", "label": "Same output", "pic": "\U0001F7F0"}, {"id": "diff", "label": "Different output", "pic": "≠"}],
              "items": [
                  {"pic": "\U0001F501⬆️", "label": "repeat 3 times, jump  /  jump, jump, jump", "bin": "same", "why": "Three jumps, both ways."},
                  {"pic": "\U0001F501➡️", "label": "repeat 2 times, move right  /  move right, move right, move right", "bin": "diff", "why": "Two moves against three. Different."},
                  {"pic": "\U0001F501\U0001F504", "label": "repeat 4 times, spin  /  spin, spin, spin, spin", "bin": "same", "why": "Four spins, both ways."},
                  {"pic": "\U0001F501\U0001F4AC", "label": "repeat 2 times, say hello  /  say hello", "bin": "diff", "why": "Two hellos against one. Different."},
                  {"pic": "\U0001F501⬅️", "label": "repeat 2 times, move left  /  move left, move left", "bin": "same", "why": "Two moves left, both ways."},
                  {"pic": "\U0001F501\U0001F53C", "label": "repeat 3 times, grow  /  grow, grow", "bin": "diff", "why": "Three grows against two. Different."},
              ]},
...
LESSON["lecture"] = [
    ...
    part("\U0001F7F0", "Same output, fewer blocks",

    ...
    "steps": [
        step("demo", "Nobody knows everything", "\U0001F4A1", "Who knows", ["2Ap.01"],
             ...
             {"frames": [
                 ...
                 {"pic": "\U0001F469\U0001F3FE‍\U0001F373", "cap": "The <b>baker</b> knows most about how bread is made.", "say": "The baker knows most about how bread is made. Ask her about bread.", "sound": "pop"},
                 {"pic": "\U0001F68C", "cap": "The <b>bus driver</b> knows most about where the buses go.", "say": "The bus driver knows most about where the buses go. Ask him about buses.", "sound": "pop"},
        ...
        step("explore", "People in our town", "\U0001F3D8️", "Town people", ["2Ap.01"],
             ...
             {"items": [
                 ...
                 {"pic": "\U0001F68C", "label": "the bus driver", "say": "The bus driver knows every bus stop, and which bus goes where."},
        ...
        step("sort", "Who would know that?", "\U0001F9E9", "Knower sorter", ["2Ap.01"],
             ...
             {"ask": "Who would know this?",
              "bins": [{"id": "baker", "label": "The baker", "pic": "\U0001F469\U0001F3FE‍\U0001F373"}, {"id": "driver", "label": "The bus driver", "pic": "\U0001F68C"}, {"id": "keeper", "label": "The park keeper", "pic": "\U0001F9D1\U0001F3FE‍\U0001F33E"}],
              "items": [
        ...
        step("questions", "Knowing and talking", "\U0001F4AC", "Town judge", ["2Ap.01", "2Mi.01"],
             ...
             {"label": "Question", "items": [
                 q("Whose job is it to know where the buses go?", "\U0001F68C", "the bus driver's", ["the baker's", "nobody's"], "Different people know different things. Ask the person whose job it is."),
...
LESSON["check"] = [
    q("You want to know how to make bread. Who would know?", "\U0001F35E", "a baker", ["a bus driver", "a football player"], "A baker makes bread every day, so a baker knows."),
    q("Your tooth hurts. Who knows most about teeth?", "\U0001F9B7", "a dentist", ["a farmer", "a painter"], "Looking after teeth is a dentist's job."),
]

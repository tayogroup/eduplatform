             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Is carpet rougher than ice?", "\U0001F9F6", "Yes", ["No"],
                   "Rougher means more friction, so things stop sooner on it."),
              ],
              "extension": [
                 ...
                 q("Why do shoes have patterned soles rather than smooth ones?", "\U0001F45F", "the pattern grips, giving more friction so you do not slip", ["it makes them look better", "smooth soles would grip more"],
                   "Friction is usually a nuisance. Here it is exactly what you want."),
                 q("A block slides 9 marks on ice and 2 on carpet. Roughly how far would it go on smooth wood?", "\U0001FAB5", "somewhere in between, because wood is rougher than ice and smoother than carpet", ["further than on ice", "less than on carpet"],
                   "Once you have a pattern you can predict a case you have not tested yet."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Pf.01", "3Pf.02", "3Pf.03", "3Pf.04", "3TWSa.02", "3TWSa.04"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Does a forcemeter have a spring inside it?", "\U0001FAA2", "Yes", ["No"],
                   "The spring stretches, and how far it stretches is the reading."),
                 q("Does oil on a surface make more friction or less?", "\U0001F6E2\uFE0F", "less", ["more"],
                   "Oil lets surfaces slide past each other more easily."),
              ],
              "extension": [
                 ...
                 q("Bicycle brakes work by friction. So why are the brake blocks not made as smooth as possible?", "\U0001F6B2", "smooth blocks would grip too little to slow the wheel", ["they are made as smooth as possible", "smoothness makes no difference to brakes"],
                   "A brake is a machine for making friction on purpose."),
                 q("You drop a feather and a marble together and the marble lands first. Does that beat what you learned?", "\U0001FAB6", "no - the air pushes back on the feather much more than on the marble", ["yes, heavy things really do fall faster", "yes, the lesson was wrong"],
                   "Without air they land together. The feather is not falling slowly; it is being held up."),
              ]},

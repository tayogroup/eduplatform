    ...
    "steps": [
        ...
        step("quiz", "Show what you know", "⭐", "Star computer scientist", ["4P.08", "4P.09", "4CS.01"],
             ...
             {"items": [
                 ...
                 q("'Forever: lights on, wait, lights off, wait' makes...", "\U0001F4A1", "a light that keeps flashing until Stop", ["one flash, then the program ends", "four flashes, one for each block", "no light at all, because it never stops"], "Forever repeats until stopped."),
                 ...
                 q("Which is a control system?", "\U0001F6AA", "a door that opens when a sensor sees you", ["a candle that gives out light and heat", "a pencil that writes when you push it", "a bicycle that moves when you pedal"], "Sensor, program, motor."),

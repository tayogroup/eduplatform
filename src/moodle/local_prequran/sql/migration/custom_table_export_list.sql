...
UNION ALL SELECT 50, 'profiles', 'mdlgx_local_prequran_teacher_request'
UNION ALL SELECT 60, 'grouping', 'mdlgx_local_prequran_group_pool'
UNION ALL SELECT 70, 'grouping', 'mdlgx_local_prequran_class_group'
UNION ALL SELECT 80, 'grouping', 'mdlgx_local_prequran_group_member'
UNION ALL SELECT 90, 'intake', 'mdlgx_local_prequran_intake_request'
UNION ALL SELECT 100, 'core_progress', 'mdlgx_local_prequran_lessonprog'
UNION ALL SELECT 110, 'core_progress', 'mdlgx_local_prequran_stepprog'
UNION ALL SELECT 120, 'focus', 'mdlgx_local_prequran_focuslog'
UNION ALL SELECT 130, 'focus', 'mdlgx_local_prequran_focusagg'
UNION ALL SELECT 140, 'recordings', 'mdlgx_local_prequran_speakrec'
UNION ALL SELECT 150, 'recordings', 'mdlgx_local_prequran_submitrec'
UNION ALL SELECT 160, 'communications', 'mdlgx_local_prequran_comm_thread'
UNION ALL SELECT 170, 'communications', 'mdlgx_local_prequran_comm_participant'
UNION ALL SELECT 180, 'communications', 'mdlgx_local_prequran_comm_message'
UNION ALL SELECT 190, 'communications', 'mdlgx_local_prequran_comm_consent'
UNION ALL SELECT 200, 'live', 'mdlgx_local_prequran_live_availability'
UNION ALL SELECT 210, 'live', 'mdlgx_local_prequran_live_consent'
UNION ALL SELECT 220, 'live', 'mdlgx_local_prequran_live_series'
UNION ALL SELECT 230, 'live', 'mdlgx_local_prequran_live_session'
UNION ALL SELECT 240, 'live', 'mdlgx_local_prequran_live_participant'
UNION ALL SELECT 250, 'live', 'mdlgx_local_prequran_live_attendance'
UNION ALL SELECT 260, 'live', 'mdlgx_local_prequran_live_note'
UNION ALL SELECT 270, 'live', 'mdlgx_local_prequran_live_recording'
UNION ALL SELECT 280, 'live', 'mdlgx_local_prequran_live_ack'
UNION ALL SELECT 290, 'live', 'mdlgx_local_prequran_live_audit'
UNION ALL SELECT 300, 'quiz', 'mdlgx_local_prequran_quiz_attempt'
UNION ALL SELECT 310, 'quiz', 'mdlgx_local_prequran_quiz_pass'
UNION ALL SELECT 320, 'quiz', 'mdlgx_local_prequran_quiz_question'
...
FROM (
    ...
    UNION ALL SELECT 'mdlgx_local_prequran_teacher_request'

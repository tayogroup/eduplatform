    ...
    "steps": [
        ...
        step("sort", "Wi-fi, or ethernet?", "\U0001F5C2️", "Wi-fi weigher", ["4DC.03"],
             ...
             {"ask": "Wi-fi, or ethernet?",
              ...
              "items": [
                  {"pic": "\U0001F50C", "label": "a network cable from the computer to the router", "bin": "eth", "why": "That is what ethernet is."},
                  ...
                  {"pic": "\U0001F4F2", "label": "the only choice for a phone", "bin": "wifi", "why": "A phone has no socket for a network cable."},
              ]},
...
LESSON["home"] = [
    home("Find the server", "A grown-up",
         ...
         "Clients ask; servers serve."),
    home("Cable or wi-fi?", "A grown-up, the router at home",

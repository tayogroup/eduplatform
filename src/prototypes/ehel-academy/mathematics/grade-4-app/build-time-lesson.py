"""Assemble the Grade 4 Telling the Time lesson.
...
extra = io.open("time-extra.css", encoding="utf-8").read()
body = io.open("time-body.html", encoding="utf-8").read()
shell = io.open("shell.js", encoding="utf-8").read()
slides = io.open("time-slides.js", encoding="utf-8").read()
...
io.open("telling-the-time.html", "w", encoding="utf-8").write(doc)
print("wrote telling-the-time.html", len(doc), "bytes")

...
import { initMathWebGL } from "./math-webgl.js?v=math-20260801a";
import { unitTopic, mathDiagram } from "./math-visuals.js?v=math-20260801a";
...
// Pre-generated narration lookup. cyrb53 gives a stable, well-distributed hash
// shared byte-for-byte with tools/generate-ehel-math-audio.js, so a Listen
...
function staticVoicePath(key) {
  ...
  return new URL(`../../media/mathematics/g${g}/audio/tts/${key}.mp3`, document.baseURI).href;
}

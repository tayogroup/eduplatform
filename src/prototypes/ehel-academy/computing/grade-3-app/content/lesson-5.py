...
# from lecture-video/tidy-programs.json. The names are content hashes, so a
# re-render gets new ones and must be re-listed here and in app.config.json
# extraPages.
LESSON["video"] = {
    "src": "lecture-video/tidy-programs.46aea517.mp4",
    "captions": "lecture-video/tidy-programs.2afd195d.vtt",
    "poster": "lecture-video/tidy-programs.b0019605.jpg",

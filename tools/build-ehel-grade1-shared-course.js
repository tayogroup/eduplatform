...
// The unit overview, in the learner's voice.
//
// The Year 1 source is a Teacher & Parent Guide, so its "What This Unit Is
// About" section is a letter to the adult: "In this unit, your child learns the
// words for family members… They talk about who is in their family." Extracting
// it verbatim (as this builder did) put that on the child's own overview page,
// where it is both read and — once the page grew a Listen button — read ALOUD to
// a five-year-old. Unit 0's extraction was worse: it captured two headings and
// the text between them ("Who This Is For ESL students aged 5–7 years… What
// Children Will Be Able to Do"), which is not prose at all.
//
...
// (page header and banner), and generate-ehel-english-audio.js overview narrates
// exactly what is shown.
const LEARNER_OVERVIEWS = {
  0: "Welcome to your very first English unit. You will meet all the letters of the alphabet — big letters and small letters — and learn the sound each one makes. You will trace letters, say their sounds, and blend them into your first little words like cat and sun. You will also learn your first sight words and read tiny sentences. Take your time: knowing your letters well matters more than going fast.",
  1: "Welcome to your first unit of Year 1 English. You will learn the words for things in your classroom, some colour words, and how to say your own name and how old you are. School is a happy, welcoming place, and this unit helps you feel at home in it. Say the words out loud and enjoy them — this is about brave first steps in English, not perfect spelling.",
  2: "In this unit you will learn the words for the people in your family — mum, dad, sister, brother, grandma and grandpa. You will also learn some breakfast and fruit words, and how to count from 1 to 10. You will talk about who is in your family, and about how families help each other and have fun together. Say the words out loud — this is about talking with confidence, not perfect spelling.",
  3: "In this unit you will learn the words for games and play, like bounce, roll, throw and catch. You will name the parts of your body, and learn the words that say where something is — on, under, next to, left and right. You will play simple games, try a game from another country, and listen to a funny story. You will also hear the short 'u' sound in sun, fun and duck. Learn by playing — that is the best way.",
  4: "In this unit you will learn the words for shapes, colours and clothes. You will make things from paper shapes — a paper quilt, a picture, a shape animal. You will talk about what people are wearing, and dress up in pretend party costumes. You will meet the short 'e' sound in hen, pen and tent, and enjoy the old story of the elves and the shoemaker. Making things takes patience, and it is fun to try, try again.",
  5: "In this unit you will learn about the farm. You will name the farm animals and the sounds they make, learn farm words like tractor, barn and field, and talk about the work people do on a farm — feeding, planting and picking. You will see how animals and plants grow: a chick from an egg, a bean from a seed. You will hear a gentle story about helping and working hard. Say the words out loud — this is about speaking with confidence, not perfect spelling.",
  6: "In this unit you will learn about your five senses — seeing, hearing, smelling, tasting and touching — and the parts of your body you use for each one. You will learn describing words like soft, loud, sweet and cold, and begin to compare things: a tree is tall, a building is taller. Most of all you will explore the world around you, stay curious, and be thankful for all the wonderful things you can sense.",
  7: "In this unit you will learn how we travel and get around. You will meet the words for ways to travel — walk, bus, car, bicycle and boat — and learn to say how you go to school. You will talk about journeys: going somewhere with the people you love, staying safe, and enjoying the trip. Say the words out loud — this is about confident everyday English, not perfect spelling.",
  8: "In this unit you will learn about water — where it comes from, where we find it, and all the ways we use it every day. You will meet rainy and sunny weather, animals that live in water, and the big idea that water is a gift we should never waste. Say the words out loud — this is about confident English and being thankful for water, not perfect spelling.",
  9: "In this unit you will learn the words for places in a town — the shop, the market, the school, the hospital and the library. You will learn about the people who work in these places, and the words that tell us where something is: near, far and next to. You will meet the traffic lights too, and learn that red means stop and green means go. A town is full of helpful places and kind people, and we all help to keep it clean and safe.",
  10: "This is your capstone: a celebration of your first year of English. You will choose your favourite work for a picture-and-word portfolio, make a six-page mini-book, give a one-minute presentation, and think about what you would like to learn next. Everything you have learned this year comes together here.",
};
...
// Running this rebuilds the WHOLE grade-1 tree, and audioDescriptor() above still
// emits the retired ./media/audio/unit-N/ paths that the audio generator long ago
// repaired to ./media/audio/grade-1/<category>/ — a rebuild would point every one
// of grade 1's ~2,700 live clips at files that do not exist. So the build is left
// alone here, and tools/apply-ehel-grade1-overview-voice.js lays LEARNER_OVERVIEWS
// over the units on disk instead. Exported so that tool cannot hold a second copy.
if (require.main === module) main();

module.exports = { LEARNER_OVERVIEWS };

...
LESSON = {
    ...
    "steps": [
        ...
        step("explore", "Kinds of sources", "\U0001F50E", "Source kinds", ["2Es.01"],
             ...
             explain(
                 ["A book, a photo, a map, a person, a film, a real thing, a website with a grown-up.", "Each kind helps with different questions."],
                 [],
                 [],
             ...
             {"rounds": [
                 ...
                 {"topic": "why the beach has litter on it", "tag": "beach", "pic": "\U0001F3D6️", "multi": True,
                  "sources": [
                      ...
                      source("moon", "a photo of the moon", "\U0001F319", ["the moon"], "The moon has no litter on it."),
                  ],
        ...
        step("opinion", "What do you think, and why?", "\U0001F4AD", "Opinion giver", ["2Ea.01"],
             ...
             explain(
                 ["An opinion is what you think.", "At Stage 2 you give reasons: two of them, both about the topic."],
             ...
             {"reasonsNeeded": 2,
              "rounds": [
                 {"topic": "recycling at school", "tag": "recycling", "pic": "♻️", "ask": "What do you think about recycling at school?",
                  ...
                  "reasons": [tagged("because it saves paper and trees", "recycling"), tagged("because it keeps rubbish out of the sea", "recycling"), tagged("because the bins are sometimes confusing", "recycling"), tagged("because it takes time at the end of the day", "recycling"),
                 ...
                 {"topic": "keeping animals in a zoo", "tag": "zoo", "pic": "\U0001F981", "ask": "What do you think about keeping animals in a zoo?",
                  ...
                  "reasons": [tagged("because a zoo keeps rare animals safe", "zoo"), tagged("because animals need space to run", "zoo"), tagged("because we can learn about animals there", "zoo"), tagged("because a cage is not a home", "zoo"),
                 ...
                 {"topic": "litter on the beach", "tag": "beach", "pic": "\U0001F3D6️", "ask": "What do you think about litter on the beach?",
                  ...
                  "reasons": [tagged("because litter hurts the sea animals", "beach"), tagged("because a clean beach is nicer to play on", "beach"), tagged("because bins fill up on a hot day", "beach"), tagged("because people forget their bags", "beach"),
        ...
        step("questions", "Sources and opinions", "\U0001F4AC", "Reason judge", ["2Es.01", "2Ea.01"],
             ...
             {"label": "Question", "items": [
                 ...
                 q("How many reasons should an opinion have at Stage 2?", "\U0001F522", "two, both about the topic", ["none", "one about anything"], "Two reasons, and both have to be about the topic."),
             ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star evaluator", ["2Es.01", "2Ea.01"],
             ...
             {"items": [
                 ...
                 q("A website can be a source if…", "\U0001F4BB", "a grown-up helps you use it", ["it is blue", "it has a game", "nobody helps"], "With a grown-up, the zoo's website tells you about its animals."),
...
LESSON["lecture"] = [
    ...
    part("\U0001F4AD", "Opinions with reasons",
         "An opinion is what you think. At Stage 2 you give two reasons, and both have to be about the topic. I think we should recycle more, because it saves paper, and because it keeps rubbish out of the sea."),
...
LESSON["home"] = [
    ...
    home("Look in the real thing", "The recycling bin at home, and a grown-up",
         ["Look in the recycling bin together.",

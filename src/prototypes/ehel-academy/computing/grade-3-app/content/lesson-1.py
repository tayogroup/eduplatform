...
label_ct(LESSON, "A linear algorithm", "Algorithmic thinking")
label_ct(LESSON, "Follow it exactly", "Algorithmic thinking")
label_ct(LESSON, "Correct the algorithm", "Algorithmic thinking")

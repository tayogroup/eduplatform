    ...
    "steps": [
        step("demo", "Wanda wonders", "\U0001F914", "Wanda wonders", ["1Rq.01"],
             ...
             {"frames": [
                 ...
                 {"pic": "\U0001F5E3️", "cap": "So she <b>asks the vet</b>: What does a rabbit eat?", "say": "So she asks the vet. What does a rabbit eat?", "sound": "chatter"},
                 {"pic": "\U0001F33F", "cap": "The vet says: <b>mostly hay and grass, and some green leaves.</b> Now Wanda knows.", "say": "The vet says: mostly hay and grass, and some green leaves. Now Wanda knows.", "sound": "ding"},
        ...
        step("explore", "The six question words", "❓", "Question words", ["1Rq.01"],
             ...
             {"items": [
                 {"pic": "\U0001F4E6", "label": "What", "say": "What asks for a thing. What does a rabbit eat? Hay and grass."},
                 ...
                 {"pic": "\U0001F552", "label": "When", "say": "When asks for a time. When do we feed the cat? In the morning and after school."},
                 {"pic": "\U0001F4AD", "label": "Why", "say": "Why asks for a reason. Why does the cat miaow? Because it is hungry."},
                 {"pic": "\U0001F527", "label": "How", "say": "How asks for the way something is done. How do you brush a cat? Gently, with a soft brush."},
             ], "need": 6,
        ...
        step("askq", "Build a question about pets", "\U0001F43E", "Question builder", ["1Rq.01"],
             ...
             {"topic": "pets", "words": ["What", "Where", "Who", "When", "Why", "How"],
              "ends": [
                  {"id": "eat", "t": "do rabbits eat?", "words": ["What", "Where", "When", "Why", "How"], "asks": "rabbits eating"},
                  {"id": "sleep", "t": "does the cat sleep?", "words": ["Where", "When", "Why", "How"], "asks": "the cat's sleeping"},
                  {"id": "look", "t": "looks after the cat?", "words": ["Who"], "asks": "who looks after the cat"},
                  {"id": "miaow", "t": "does the cat miaow?", "words": ["Why", "When", "Where", "How"], "asks": "the cat miaowing"},
                  {"id": "brush", "t": "do you brush a cat?", "words": ["How", "When", "Where", "Why"], "asks": "brushing a cat"},
                  {"id": "feed", "t": "do we feed the fish?", "words": ["When", "How", "What", "Where", "Why"], "asks": "feeding the fish"},
              ],
              "rounds": [
                  ...
                  {"want": "which person looks after the cat", "pic": "\U0001F431", "word": "Who", "end": "look", "why": "Who asks for a person."},
                  {"want": "the reason the cat miaows", "pic": "\U0001F408", "word": "Why", "end": "miaow", "why": "Why asks for a reason."},
                  {"want": "the way to brush a cat", "pic": "\U0001F431", "word": "How", "end": "brush", "why": "How asks for the way it is done."},
        ...
        step("quiz", "Show what you know", "⭐", "Star asker", ["1Rq.01", "1Ri.01"],
             ...
             {"items": [
                 ...
                 q("Which word asks about a TIME?", "\U0001F552", "When", ["Why", "How", "Who"], "When asks for a time. When do we feed the cat?"),
                 ...
                 q("What is a source?", "\U0001F4D6", "something you can find information in", ["a kind of soup", "a pet", "a question word"], "A picture, a book or a person can be a source of information."),
                 ...
                 q("The park sign said: do not feed the ducks bread. Why?", "\U0001F6AB", "bread is bad for ducks", ["ducks do not like the park", "bread is for dogs"], "The sign told us bread is bad for them."),
                 q("Wanda wants to know how to brush a cat. Which question?", "\U0001F431", "How do you brush a cat?", ["Who is a cat?", "Where is a brush?"], "The way something is done needs How."),
             ]},
...
LESSON["words"] = [
    ...
    word("answer", "\U0001F4A1", "What you find out when a question is asked.",
         ["The answer was hay and grass.", "The vet gave Wanda an answer."]),

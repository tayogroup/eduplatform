    ...
    "steps": [
        ...
        step("demo", "What is a magnet?", "\U0001F9F2", "Magnet!", ["1Pe.02"],
             ...
             explain(
                 ...
                 ["Children think a magnet sticks to everything made of metal.", "It sticks to iron and steel. It does not stick to a copper coin or aluminium foil."],
        ...
        step("predictEach", "Will it stick?", "\U0001F9EA", "Magnet test", ["1Pe.02", "1TWSp.02", "1TWSc.04", "1TWSa.01"],
             ...
             explain(
                 ...
                 ["Children predict that all metal sticks.", "The metal spoon and the key stick, but a copper coin does not. Test, do not guess."],
             ...
             {"sim": "magnet", "tryLabel": "Bring the magnet near", "ask": "Will the magnet stick to the %s?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001FA99", "label": "copper coin", "answer": "no", "why": "A copper coin is metal, but the magnet did not stick. Not all metals are magnetic!"},
        ...
        step("record", "Record the magnet test", "\U0001F4DD", "Magnet table", ["1TWSc.05", "1Pe.02"],
             ...
             {"ask": "Did the magnet stick to %s?",
              ...
              "rows": [
                  ...
                  {"pic": "\U0001FA99", "label": "the copper coin", "answer": "no", "why": "the copper coin did not stick, even though it is metal."},
              ],

    ...
    "steps": [
        step("explore", "Does it need electricity?", "\U0001F4A1", "Electric things", ["1Pe.01"],
             ...
             {"items": [
                 ...
                 {"pic": icon("fridge"), "label": "fridge", "sub": "needs electricity", "say": "A fridge needs electricity to keep food cold."},
        ...
        step("predictEach", "Will the magnet attract it?", "\U0001F9EA", "Magnet test", ["1Pe.02", "1TWSp.02", "1TWSc.04", "1TWSa.01"],
             ...
             {"sim": "magnet", "tryLabel": "Bring the magnet near", "ask": "Will the magnet attract the %s?",
              ...
              "items": [
                  ...
                  {"pic": icon("foil"), "label": "kitchen foil", "answer": "no", "why": "Kitchen foil is metal, but the magnet did not attract it. Not every metal is magnetic!",
                   "said": "The magnet did not attract the kitchen foil, even though foil is metal. Not every metal is magnetic."},
                  {"pic": icon("nail"), "label": "iron nail", "answer": "yes", "why": "The magnet attracted the iron nail.",
        ...
        step("record", "Record the magnet test", "\U0001F4DD", "Magnet table", ["1TWSc.05", "1Pe.02"],
             ...
             {"ask": "Did the magnet attract %s?",
              ...
              "rows": [
                  ...
                  {"pic": icon("foil"), "label": "the kitchen foil", "answer": "no", "why": "the magnet did not attract the kitchen foil, even though it is metal."},
              ],
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["1Pe.01", "1Pe.02"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Does a magnet pull a plastic spoon?", "\U0001F944", "No", ["Yes"],
                   "A magnet does nothing at all to plastic."),
                 q("Does a torch need a battery?", "\U0001F526", "Yes", ["No"],
                   "The battery is where a torch gets its electricity."),
              ],
              "extension": [
                 ...
                 q("A paperclip on the table jumps to a magnet before the magnet touches it. What does that tell you?", "\U0001F4CE", "a magnet can pull across a small gap, without touching", ["the clip moved all by itself", "the magnet touched it too fast to see"],
                   "A magnet's pull reaches out a little way past the magnet itself."),
                 q("Why is a plug the only thing that should ever go into a wall socket?", "\u26A0\uFE0F", "because the electricity in a socket is strong enough to hurt you badly", ["because plugs are the right shape for the holes", "anything thin would do"],
                   "A socket is not a toy, and there is no safe way to test that yourself."),
              ]
             },

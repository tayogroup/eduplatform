    ...
    "steps": [
        ...
        step("quiz", "Show what you know", "⭐", "Star colour mixer", ["1E.01", "1E.02", "1E.03", "1M.01", "1R.02"],
             ...
             {"items": [
                 ...
                 q("Which is the lightest tone?", "⚪", "white", ["blue", "black"], "White is the lightest of all."),
                 q("Which colours feel warm?", "🔥", "red, orange and yellow", ["blue and green", "black and white"], "Red, orange and yellow remind us of fire and sun."),

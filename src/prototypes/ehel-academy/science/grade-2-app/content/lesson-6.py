        ...
        step("questions", "What made it change?", "✅", "Cause finder", ["2Pf.03", "2Pf.01"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Does it take a bigger push to move a heavy box than a light one?", "\U0001F4E6", "Yes", ["No"],
                   "The heavier it is, the more push it needs to start moving."),
                 q("Does squashing clay change its shape?", "\U0001F9F1", "Yes", ["No"],
              ...
              "extension": [
                 ...
                 q("A sledge slides a long way on snow and hardly at all on gravel. What is the gravel doing?", "\U0001F6F7", "rubbing against it much more, so it stops sooner", ["pushing it forwards", "nothing - the snow is just colder"],
                   "A rough surface rubs more. That rubbing is a force pushing back on the sledge."),
                 q("You stretch an elastic band and let go, and it flies across the room. Where did that movement come from?", "\u27B0", "from the stretch you put into it, stored and then let go", ["from the air in the room", "from nowhere - it moves on its own"],
                   "The force you used to stretch it was kept in the band until you released it."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["2Pf.01", "2Pf.02", "2Pf.03", "2TWSa.02"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Does a ball roll further on grass or on a smooth floor?", "\U0001F3D0", "a smooth floor", ["grass"],
                   "Grass rubs against it and slows it sooner."),
              ],
              "extension": [
                 ...
                 q("Two children push a box from opposite sides with exactly the same push. What happens?", "\U0001F4E6", "nothing moves - the two pushes cancel each other out", ["it moves towards the stronger child", "it moves in a circle"],
                   "Nothing moving does not mean nothing pushing. It can mean the pushes are balanced."),
                 q("A bicycle is easier to push along than a heavy crate of the same weight. Why?", "\U0001F6B2", "wheels roll instead of dragging, so there is much less rubbing", ["the bicycle is lighter", "crates are always harder to move"],
                   "Wheels are a way of getting rid of most of the rubbing between a load and the ground."),
              ]},

        ...
        step("questions", "Back it up with science", "\U0001F5E3\uFE0F", "Backed by science", ["4SIC.03", "4Be.01"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Is 'I think it looks nice' a science reason?", "\U0001F3A8", "No", ["Yes"],
                   "It is an opinion. A science reason says something you could check."),
                 q("Could you count how many birds visit a feeder?", "\U0001F426", "Yes", ["No"],
                   "You could, and a count is evidence."),
              ],
              "extension": [
                 ...
                 q("Two people disagree about whether a pond has more frogs than last year. How could that be settled?", "\U0001F438", "by counting, if somebody counted last year too", ["by asking who has lived there longer", "it cannot be settled at all"],
                   "Evidence only settles an argument if it was collected before you needed it. That is why scientists record."),
                 q("A poster says 'this park is good for wildlife'. What would turn that into a claim you could test?", "\U0001F3DE\uFE0F", "naming what lives there and how many, so somebody could go and check", ["printing it in bigger letters", "nothing - posters cannot be tested"],
                   "A testable claim says something specific enough to be wrong."),
              ]},
        ...
        step("questions", "Habitat check", "✅", "Habitat check", ["4Be.01", "4Be.02"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Does a monkey live in a rainforest or a desert?", "\U0001F412", "a rainforest", ["a desert"],
                   "Trees to climb and plenty of rain. That is a monkey's habitat."),
                 q("Can a fish breathe out of water?", "\U0001F41F", "No", ["Yes"],
                   "Its gills only work in water."),
              ],
              "extension": [
                 ...
                 q("A camel and a polar bear are both very well suited. Swap them over. What happens and why?", "\u2744\uFE0F", "both struggle - each one's features fit the place it came from", ["both manage perfectly well", "only the camel struggles"],
                   "Suited means fitted to one place. The better the fit, the worse the swap."),
                 q("Woodlice are found 20 to 2 in damp against dry. Is one count of each enough to be sure?", "\U0001FAB1", "not really - counting again in other places would make it much safer", ["yes, 20 against 2 settles it", "no, counts prove nothing ever"],
                   "A big difference is good evidence and repeating it is better. One count could be luck."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4Be.01", "4Be.02", "4SIC.05", "4TWSp.01"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Is the Arctic hot or cold?", "\u2744\uFE0F", "cold", ["hot"],
                   "Cold, which is why the animals there have fur and fat."),
                 q("Would a rainforest plant survive outdoors in a frosty garden?", "\U0001FAB4", "No", ["Yes"],
                   "It needs warmth all year, which a frosty garden cannot give."),
              ],
              "extension": [
                 ...
                 q("A new car park covers a meadow. List a good effect and a bad effect.", "\U0001F697", "people can park; the meadow's plants and animals lose their home", ["there are only good effects", "there are only bad effects"],
                   "Stage 4 asks you to weigh both sides. Almost nothing people build has effects in one direction only."),
                 q("A goldfish let loose in a river survives and the wild fish do worse. Why?", "\U0001F41F", "it eats the food the wild fish need, and nothing there is used to it", ["it cannot survive at all", "it makes no difference to the river"],
                   "An animal that survives outside its habitat can become a problem for everything that lives there already."),
              ]},

    ...
    "steps": [
        ...
        step("predictEach", "Will it stick?", "\U0001F4CE", "Magnetic test", ["3Pe.03", "3TWSp.03", "3TWSa.01"],
             ...
             {"sim": "magnet", "ask": "Is the %s magnetic? Predict, then test.", "tryLabel": "Bring the magnet",
              ...
              "items": [
                  ...
                  {"pic": icon("nail"), "label": "iron nail", "answer": "yes", "why": "Iron: magnetic. The magnet pulled it across."},
        ...
        step("record", "Record the magnet test", "\U0001F4CB", "Magnet table", ["3TWSc.06", "3Pe.03"],
             ...
             {"ask": "Was the %s magnetic?",
              ...
              "rows": [
                  {"pic": icon("nail"), "label": "iron nail", "answer": "yes", "why": "the iron nail jumped to the magnet."},
        ...
        step("context", "Magnets at work", "\U0001F9ED", "Useful magnets", ["3SIC.02", "3Pe.02", "3Pe.03"],
             ...
             explain(
                 ...
                 ["Tap each one."]),
             {"items": [
                 {"pic": icon("fridge"), "label": "fridge door","say": "The rubber seal round a fridge door has a magnetic strip inside. It pulls against the fridge's steel frame and holds the door shut."},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Pe.01", "3Pe.02", "3Pe.03", "3SIC.02"],
             ...
             {"items": [
                 ...
                 q("Why does a fridge door stay shut?", icon("fridge"),"a magnetic strip pulls against the fridge's steel frame", ["it is glued", "gravity"], "Magnet on steel."),
              ...
              "support": [
                 q("Does a magnet pull an iron nail?", icon("nail"), "Yes", ["No"],
                   "Iron is magnetic."),

        ...
        step("questions", "Bone check", "✅", "Bone check", ["4Bs.01", "4Bs.02", "4Bs.03"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Does your rib cage protect your heart?", "\U0001FAC0", "Yes", ["No"],
                   "The ribs make a cage round the heart and the lungs."),
                 q("Do your bones grow as you grow?", "\U0001F9B4", "Yes", ["No"],
                   "Bones are living. They grow with you and they mend when they break."),
              ],
              "extension": [
                 ...
                 q("You bend your arm and the biceps gets shorter and fatter. Where did the arm's movement come from?", "\U0001F4AA", "the muscle pulling on the bone as it shortens", ["the bone pushing itself round", "the joint moving on its own"],
                   "A muscle only ever pulls. The bone goes where it is pulled."),
                 q("A jellyfish has no skeleton and a person could not manage without one. What does a skeleton give you that water gives a jellyfish?", "\U0001F30A", "something firm to hold your shape and to pull against", ["somewhere to store food", "a way of breathing"],
                   "Out of water a jellyfish collapses. On land you need your own framework."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4Bs.01", "4Bs.02", "4Bs.03"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Where is your spine?", "\U0001F9B4", "down your back", ["across your chest"],
                   "A chain of small bones running down your back."),
                 q("Do muscles come in pairs?", "\U0001F4AA", "Yes", ["No"],
                   "One pulls a bone one way and its partner pulls it back."),
              ],
              "extension": [
                 ...
                 q("Your ribs can move a little when you breathe, and your skull cannot move at all. Why the difference?", "\U0001FAC1", "the ribs have to let the chest rise; the skull only has to protect", ["the skull is simply older bone", "the ribs are not really bones"],
                   "Each part of the skeleton is shaped for its own job, and some jobs need movement while others need none."),
                 q("A footballer's leg muscles are bigger than yours. What did that?", "\U0001F3C3", "using them, over and over", ["being born with bigger ones", "eating more bread"],
                   "Muscles answer to use. That is also why they shrink when somebody cannot move for weeks."),
              ]},

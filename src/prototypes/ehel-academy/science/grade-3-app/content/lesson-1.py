        ...
        step("questions", "Alive, or not?", "✅", "Life check", ["3Bp.01", "3Bp.02", "3TWSp.02"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Does a bird feed its young?", "\U0001F426", "Yes", ["No"],
                   "Feeding the young is part of how living things keep their kind going."),
                 q("Is a plastic bottle alive?", "\U0001F9F4", "No", ["Yes"],
                   "It never fed, never grew and cannot make more bottles."),
              ],
              "extension": [
                 ...
                 q("A river moves along and gets wider over the years. Which life processes does it still NOT do?", "\U0001F30A", "feeding, and making more rivers of its own kind", ["none - a river does all four", "only growth is missing"],
                   "Moving and getting bigger are two of the four. A living thing does all of them."),
                 q("A snail hides in its shell all winter and does not move or eat. How would you check it is still alive?", "\U0001F40C", "wait for spring and see whether it feeds and moves again", ["poke it and see", "you cannot ever tell"],
                   "Some animals rest so deeply that they look dead. What settles it is whether the life processes start again."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Bp.01", "3Bp.02", "3TWSp.02", "3SIC.03"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Is a cloud alive?", "\u2601\uFE0F", "No", ["Yes"],
                   "It moves and it grows, and it cannot feed or make more clouds."),
                 q("Does a fish need food?", "\U0001F41F", "Yes", ["No"],
                   "Every animal must feed to stay alive."),
              ],
              "extension": [
                 ...
                 q("Yeast, a mushroom and an oak tree are all living, and none of them walks. What do all three do?", "\U0001F344", "feed, grow, and make more of their own kind", ["move about from place to place", "nothing in common at all"],
                   "Movement is the one life process that looks different in a plant or a fungus. The rest are the same."),
                 q("Why do scientists insist on ALL four life processes, rather than just one?", "\U0001F52C", "because plenty of non-living things manage one of them", ["to make the test harder", "one would be enough, really"],
                   "A flame moves. A river grows. A car takes in fuel. Only a living thing does the whole set."),
              ]},

    ...
    "steps": [
        step("explore", "Computer scientists at work", "\U0001F469\U0001F4BB", "Scientist spotter", ["4CS.06"],
             ...
             {"items": [
                 ...
                 {"pic": "\U0001F697", "label": "in a car company", "say": "In a car company. Computer scientists write the programs that help a car brake in time, park itself, and one day drive itself."},
             ], "need": 6,
        ...
        step("explore", "Service robots", "\U0001F916", "Robot spotter", ["4CS.07"],
             ...
             {"items": [
                 ...
                 {"pic": "\U0001F68C", "label": "a self-driving shuttle bus", "sub": "public transport", "say": "A self-driving shuttle bus. Cameras and sensors see the road; a program steers along a fixed route at walking pace."},
...
LESSON["lecture"] = [
    ...
    part("\U0001F686", "Robots that move people and help patients",
         "A driverless train runs the airport shuttle. A self-driving shuttle bus steers round a park at walking pace. In a hospital a robot carries medicines to the ward, and a surgical robot holds instruments steadier than any hand. Public transport and health care."),

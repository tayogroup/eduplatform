...
LESSON = {
    ...
    "steps": [
             ...
             {"asker": YASMIN,
              "rounds": [
                  {"ask": "What did Mr Omar think about the supermarket, and what did Mrs Farah think?", "about": "the field views", "pic": "\U0001F3EA",
                   "opts": [tagged("He thought it would close small shops; she thought food would be cheaper and closer.", "the field views"), tagged("The old field is at the edge of town.", "where the field is"), tagged("I had cereal.", "breakfast")],
                  ...
                  {"ask": "What is a strength and what is a limitation of your teamwork?", "about": "strengths", "pic": "\U0001F4AA",
                   "opts": [tagged("A strength is what I did well; a limitation is what took more than one go.", "strengths"), tagged("Our class made a museum.", "the museum"), tagged("My shoes are blue.", "shoes")],
                  ...
                  {"ask": "Do people who know the same facts always think the same?", "about": "thinking differently", "pic": "\U0001F4AD",
                   "opts": [tagged("No. They can know the same facts and still think different things, from where they stand.", "thinking differently"), tagged("Mr Hassan keeps sheep.", "the sheep"), tagged("The sea is salty.", "the sea")],
        ...
        step("sort", "Which skill was it?", "\U0001F9E9", "Skill sorter", ["4Fv.01"],
             ...
             {"ask": "Which skill was this?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F4CA", "label": "concluding that half of the children we asked slept 8 to 10 hours", "bin": "think", "why": "Drawing a conclusion is thinking about the data."},
        ...
        step("quiz", "Show what you know", "⭐", "Star reflector", ["4Fv.01", "4Fl.01", "4Ap.01", "4Mi.01"],
             ...
             {"items": [
                 q("Lesson one: which kind of question helps you understand a topic?", "\U0001F9E0", "one you cannot answer yet, that opens a stage of the topic", ["one everybody can answer", "one about you", "a short one"], "Lesson one."),

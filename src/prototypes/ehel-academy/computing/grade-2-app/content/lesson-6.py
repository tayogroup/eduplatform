    ...
    "steps": [
        step("demo", "Meet the floor robot", "\U0001F41D", "Floor robot", ["2P.08"],
             ...
             {"frames": [
                 ...
                 {"pic": "\u25B6\uFE0F", "cap": "<b>GO</b> runs the whole program.", "say": "Press GO and the robot runs the whole program, one square at a time.", "sound": "robot"},
        ...
        step("questions", "Which button?", "\U0001F518", "Button chooser", ["2P.08"],
             ...
             {"label": "Question", "items": [
                 ...
                 q("Which button makes the robot start driving?", "\u25B6\uFE0F", "GO", ["CLEAR", "forward", "turn right"], "GO runs the remembered program."),
...
LESSON["words"] = [
    ...
    word("GO", "\u25B6\uFE0F", "The button that runs the remembered program.",

    ...
    "steps": [
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Do you see with your eyes?", "\U0001F441\uFE0F", "Yes", ["No"],
                   "Eyes are for seeing."),
                 q("What do you smell with?", "\U0001F443", "my nose", ["my ears"],
                   "Your nose is for smelling."),
                 q("What do you taste with?", "\U0001F44B", "my tongue", ["my nose"],
              ...
              "extension": [
                 ...
                 q("You shut your eyes and somebody holds an orange near you. Which TWO senses could still tell you what it is?", "\U0001F34A", "smell and touch", ["sight and hearing", "only taste"],
                   "More than one sense can answer the same question. That is useful when one of them cannot help."),
                 q("A hot pan looks exactly like a cold one. Which sense warns you, and why is that a problem?", "\u2668\uFE0F", "touch - and only once you are already touching it", ["sight, straight away", "smell, from across the room"],
                   "Your eyes cannot see heat. That is why you never test whether a pan is hot with your hand."),
              ]},
        ...
        step("questions", "The feely bag", "\U0001F45C", "Feely bag", ["1Bs.02"],
             ...
             {"label": "Bag", "items": [
              ...
              "support": [
                 ...
                 q("Is a feather heavy or light?", "\U0001FAB6", "light", ["heavy"],
                   "A feather is so light you can hardly feel it."),
                 q("Do you use your eyes inside the feely bag?", "\U0001F45C", "No", ["Yes"],
                   "The bag hides everything, so only touch can help you."),
              ],
              "extension": [
                 ...
                 q("Two children reach into the bag and disagree about what one object is. How could they settle it without looking?", "\U0001F91D", "each describe what they feel, and check they are feeling the same part", ["take a vote on it", "they cannot - somebody has to look"],
                   "Two people can have hold of different parts of one thing. Describing carefully is how scientists compare."),
                 q("Why is a feely bag a fair way to test touch?", "\u2696\uFE0F", "because it takes every other sense out of the test", ["because it is dark in there", "it is not a fair test at all"],
                   "A fair test leaves only the thing you are testing. The bag leaves only your skin."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["1Bs.02", "1Bs.03", "1Bp.04"],
             ...
             {"items": [
                 ...
                 q("Between any two children, are there <b>more</b> things that are the same, or more things that are different?", "\U0001F46B", "more things that are the same", ["more things that are different", "exactly the same number of each"], "Two eyes, two ears, a nose, a mouth, teeth, hair, skin, a heart beating. Everyone shares nearly everything. Differences are easier to NOTICE, and there are far fewer of them."),
                 ...
                 q("Two children argue about who is taller. What settles it?", "\U0001F590️", "standing them back to back and measuring", ["whoever says it loudest", "whoever looks taller from across the room"], "A loud voice or a big character can make somebody seem taller than they are. Measuring settles it."),
             ],
              "support": [
                 ...
                 q("How many eyes do you have?", "\U0001F441\uFE0F", "two", ["one"],
                   "Two eyes, one nose, two ears."),
                 q("Is your skin part of your body?", "\u270B", "Yes", ["No"],
                   "Skin covers your whole body, and you feel with it."),
              ],
              "extension": [
                 ...
                 q("Why do doctors measure how tall you are in centimetres rather than in hand spans?", "\U0001F4CF", "everyone's hand is a different size, so hand spans cannot be compared", ["centimetres are bigger than hands", "hand spans take too long to count"],
                   "A centimetre is the same for everybody. That is what makes two people's measurements worth comparing."),
                 q("A friend's eyes and ears both work perfectly, and they still walk into a low branch. What does that show?", "\U0001F333", "a sense only helps if you are paying attention to it", ["their eyes must be broken", "senses do not really work"],
                   "Your senses gather the news. You still have to notice it."),
              ]
             },

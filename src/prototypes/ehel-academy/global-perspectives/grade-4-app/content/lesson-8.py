...
LESSON = {
    ...
    "steps": [
        step("demo", "How the six skills grew", "\U0001F9E9", "Six skills", ["4Fv.01"],
             ...
             {"frames": [
                 {"pic": "\U0001F50D", "cap": "<b>Finding out.</b> Questions that open a journey; choosing to observe, ask or measure; a rain gauge; a Venn diagram.", "say": "Finding out. Constructing questions that open a stage of a journey, choosing whether to observe, ask or measure, reading a rain gauge, and recording on a Venn diagram. Lessons one and two."},
        ...
        step("lookback", "What I learned, how my ideas changed, what helped", "\U0001FA9E", "I looked back", ["4Fv.01", "4Fl.01"],
        ...
        step("know", "Present what you learned", "\U0001F3A4", "Learning presenter", ["4Mi.01"],
             ...
             {"mode": "structured", "topic": "what I learned about finding things out", "tag": "findingout", "topicPic": "\U0001F50D",
              ...
              "cards": [
                  ...
                  dict(tagged("I learned that a conclusion goes exactly as far as the data", "findingout", "\U0001F4CA"), say="I learned that a conclusion goes exactly as far as the data", part="middle"),
        ...
        step("quiz", "Show what you know", "⭐", "Star reflector", ["4Fv.01", "4Fl.01", "4Ap.01", "4Mi.01"],
             ...
             {"items": [
                 q("A question helps you understand a topic when…", "\U0001F9E0", "you cannot answer it yet and it opens a stage of the topic", ["everybody knows the answer", "it is about you", "it is short"], "Lesson one."),
                 ...
                 q("Which kind of activity is reading a rain gauge?", "\U0001F440", "observing and measuring", ["presenting a talk", "reading a source", "listening"], "Measuring for yourself."),
                 q("Looking back this year asks…", "\U0001FA9E", "what I learned, how my ideas changed, and what kind of activity helped", ["only what I liked", "nothing", "who won"], "Three parts."),

        ...
        step("questions", "Mixture check", "✅", "Mixture check", ["3Cm.02", "3Cp.02", "3Cp.03", "3Cp.04", "3Cc.01"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Can you see dissolved salt in the water?", "\U0001F9C2", "No", ["Yes"],
                   "It is still there, in pieces far too small to see."),
                 q("Should you wear goggles when you pour liquids in an experiment?", "\U0001F97D", "Yes", ["No"],
                   "Goggles keep a splash out of your eyes."),
              ],
              "extension": [
                 ...
                 q("You stir sand into water and leave it overnight. What do you find in the morning?", "\U0001F3D6\uFE0F", "the sand settled at the bottom, still sand", ["the sand dissolved overnight", "the sand turned into mud for ever"],
                   "Sand does not dissolve. Given time it simply sinks, and each grain is unchanged."),
                 q("Why is a mixture different from a brand-new substance?", "\u2697\uFE0F", "in a mixture each material keeps its own properties and can be separated again", ["there is no difference at all", "a mixture can never be separated"],
                   "That is the whole test: are the things you started with still there, and still themselves?"),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Cm.02", "3Cp.02", "3Cp.03", "3Cp.04", "3Cc.01", "3TWSp.04"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Will a sieve separate two powders of the same size?", "\U0001F35A", "No", ["Yes"],
                   "A sieve works on size. Same size, no separation."),
                 q("Should you taste a chemical to find out what it is?", "\u26A0\uFE0F", "No", ["Yes"],
                   "Never taste anything in an experiment. Wafting a smell is as far as it goes."),
              ],
              "extension": [
                 ...
                 q("Sea water is salty. How does a salt works get dry salt out of it?", "\U0001F9C2", "by letting the water dry away and collecting what is left", ["by filtering the sea water", "by pulling the salt out with a magnet"],
                   "The same method as your experiment, on a very large scale: dry the water off and the solid stays."),
                 q("Muddy water is filtered and comes out clear. Is it now safe to drink?", "\U0001F4A7", "not necessarily - things small enough to dissolve went straight through", ["yes, clear water is always safe", "no, filtered water is never safe"],
                   "A filter takes out what is too big to pass. Clear is not the same as clean."),
              ]},

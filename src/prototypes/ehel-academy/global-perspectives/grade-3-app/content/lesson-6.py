    ...
    "steps": [
             ...
             {"goal": "paint the sign for our fair stall", "scene": "mural", "friends": SIGN_FRIENDS,
              "rounds": [
                  {"kind": "allocate", "who": "sami", "members": SIGN_MEMBERS, "log": "You gave each sign job to the right person.", "why": "Each job needed a skill, and each went to the person who had it.",
                   "tasks": [task("board", "Carry the heavy board to the hall", "\U0001F6DE", "carrying heavy things"), task("top", "Paint the top edge nobody else can reach", "\U0001F58C️", "reaching high"),
                             task("letters", "Paint the letters neatly", "✍️", "neat writing"), task("coins", "Count the coins for the paint", "\U0001FA99", "counting")]},
                  {"kind": "friend", "who": "sami", "did": "carried the board to the hall on his own, so the rest of us could start mixing paint.", "log": "Sami carried the board.", "pic": "\U0001F6DE"},
                  ...
                  {"kind": "work", "who": "omar", "situation": "Omar counted the coins twice and got two different answers. He looks upset.", "pic": "\U0001FA99",
        ...
        step("team", "Plant the recycling garden", "\U0001F331", "Garden team", ["3Cc.01", "3Ct.01"],
             ...
             {"goal": "plant the recycling garden", "scene": "garden", "friends": GARDEN_FRIENDS,
              "rounds": [
                  ...
                  {"kind": "friend", "who": "nora", "did": "drew a new set of labels, one picture for each plant.", "log": "Nora drew the labels.", "pic": "\U0001F3F7️"},
                  {"kind": "idea", "who": "amal", "situation": "The birds are already pecking at the seedlings. The team is stuck.", "pic": "\U0001F426",
                   "opts": [{"t": "Let's hang old CDs on string above the tyres to scare the birds.", "good": True, "log": "Your idea: hang old CDs to scare the birds."},
                   ...
                   "why": "Shiny CDs scare birds, and they are recycled too. Your idea finished the garden."},
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star team player", ["3Cc.01", "3Ct.01", "3Fc.01", "3Ft.01"],
             ...
             {"items": [
                 ...
                 q("Who should carry the heavy board?", "\U0001F6DE", "Sami, because he is strong", ["Omar, because he is good with numbers", "you, because you have neat writing", "anyone"], "The job needs strength."),
                 q("Omar counted the coins wrong and was upset. What is working positively?", "\U0001FA99", "count them together in tens", ["tell him he is useless", "take the job off him", "ignore him"], "Help with the job, without taking it away."),
                 ...
                 q("What is a STRENGTH of your teamwork?", "\U0001F4AA", "something you did well, first time", ["something that took three goes", "a job you skipped", "being the tallest"], "Giving out the jobs right first time was a strength."),
...
LESSON["words"] = [
    ...
    word("skill", "\U0001F9E9", "Something a person is good at.",
         ["Sami's skill is strength.", "Match the job to the skill."]),

...
import { initScienceWebGL } from "../../science/shared/science-webgl.js?v=science-20260721l";
import { unitTopic, scienceDiagram } from "../../science/shared/science-visuals.js?v=science-20260721l";
...
const config = {
  ...
  renderers: {
    overview: renderOverview, lesson: renderLesson, ai: renderAI, words: renderScienceWords,
    ...
    live: renderLiveClass, progress: renderReflect, teacher: renderTeacher,
  },
  bind,
  async load(ctx) {

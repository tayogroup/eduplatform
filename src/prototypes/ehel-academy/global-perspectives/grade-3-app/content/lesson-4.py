    ...
    "steps": [
        step("demo", "Four people, four views", "\U0001F415", "View spotter", ["3Ap.01"],
             ...
             explain(
                 ...
                 ["Everybody knows dogs run in the park.", "The park keeper thinks they should be on leashes. Mrs Adams thinks they should run free.", "Same facts, different views."],
             ...
             {"frames": [
                 {"pic": "\U0001F3DE️", "cap": "Our topic: <b>dogs in our park</b>. Should they run free?", "say": "Our topic: dogs in our park. Should they run free, or stay on leashes?"},
                 {"pic": "\U0001F9D1\U0001F3FE‍\U0001F33E", "cap": "Mr Bello, the park keeper, thinks: <b>dogs should be on leashes</b>. They frighten the ducks.", "say": "Mr Bello, the park keeper, thinks dogs should be on leashes. They frighten the ducks and dig up the flower beds.", "sound": "pop"},
                 ...
                 {"pic": "\U0001F3C3", "cap": "Leila, a runner, thinks: <b>dogs off the leash trip runners up</b>.", "say": "Leila, a runner, thinks dogs off the leash trip runners up, so leashes on the path at least.", "sound": "pop"},
        ...
        step("answer", "Who thinks what?", "\U0001F4AD", "View matcher", ["3Ap.01"],
             ...
             explain(
                 ...
                 ["Dogs should be on leashes because of the ducks: that is the park keeper.", "Dogs need to run free: that is Mrs Adams."],
                 [],
                 ["Read the view, then tap the person who holds it."]),
             {"asker": YASMIN,
              "rounds": [
                  {"ask": "Who thinks dogs should be on leashes because they frighten the ducks?", "about": "dogs on leashes", "pic": "\U0001F986",
                   "opts": [tagged("Mr Bello, the park keeper", "dogs on leashes", "\U0001F9D1\U0001F3FE‍\U0001F33E"), tagged("Mrs Adams, the dog owner", "dogs running free", "\U0001F469\U0001F3FC"), tagged("Mr Khan, the dad", "a fenced dog area", "\U0001F468\U0001F3FD")],
                   "why": "The park keeper looks after the ducks and the flower beds, and thinks leashes protect them."},
                  {"ask": "Who thinks dogs need to run free to be healthy?", "about": "dogs running free", "pic": "\U0001F415",
                   "opts": [tagged("Mrs Adams, the dog owner", "dogs running free", "\U0001F469\U0001F3FC"), tagged("Leila, the runner", "runners on the path", "\U0001F3C3"), tagged("Mr Bello, the park keeper", "dogs on leashes", "\U0001F9D1\U0001F3FE‍\U0001F33E")],
                  ...
                  {"ask": "Who thinks dogs off the leash trip runners up on the path?", "about": "runners on the path", "pic": "\U0001F3C3",
                   "opts": [tagged("Leila, the runner", "runners on the path", "\U0001F3C3"), tagged("Mr Bello, the park keeper", "dogs on leashes", "\U0001F9D1\U0001F3FE‍\U0001F33E"), tagged("Mr Khan, the dad", "a fenced dog area", "\U0001F468\U0001F3FD")],
        ...
        step("sort", "A fact, or what somebody thinks?", "⚖️", "Fact-or-view judge", ["3Ap.01"],
             ...
             explain(
                 ...
                 ["The park has a pond with ducks: a fact.", "Dogs should be on leashes: what Mr Bello thinks."],
                 [],
             ...
             {"ask": "A fact, or a view?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F9D1\U0001F3FE‍\U0001F33E", "label": "Dogs should always be on leashes in the park", "bin": "view", "why": "That is what Mr Bello thinks. Mrs Adams thinks differently."},
        ...
        step("text", "The park keeper's poster", "\U0001F4CB", "Poster reader", ["3Es.01"],
             ...
             explain(
                 ...
                 ["The ducks are frightened by loose dogs: that is the author's reason.", "Please keep your dog on a leash: that is what the author wants."],
                 ["Children treat a poster as if it were plain facts.", "Ask: who wrote this, and what do THEY want?"],
             ...
             {"title": "A poster by the park gate",
              "lines": [
                  ...
                  "So please keep your dog on a leash at all times.",
                  "Thank you. Mr Bello, Park Keeper.",
              ],
              "rounds": [
                  {"ask": "Which sentence shows what the author WANTS people to do?", "about": "what the author wants", "line": 3, "why": "Please keep your dog on a leash. That is the author's wish, stated plainly."},
              ...
              "then": {"ask": "What is the author's viewpoint?",
                       "opts": [opt("Dogs should be kept on leashes in the park", True), opt("Dogs should run free in the park", False), opt("The park should have no ducks", False)],
                       "why": "Every sentence points the same way: the park keeper thinks dogs should be on leashes."}},
        ...
        step("text", "The dog owner's letter", "✉️", "Letter reader", ["3Es.01"],
             ...
             {"title": "A letter to the newspaper",
              "lines": [
                  ...
                  "Dogs need to run to stay healthy, and a leash does not let them.",
              ...
              "then": {"ask": "Do Mr Bello and Mrs Adams have the same viewpoint?",
                       "opts": [opt("No: he wants leashes, she wants dogs to run free", True), opt("Yes, they both want leashes", False), opt("Yes, they both want dogs to run free", False)],
        ...
        step("opinion", "What do YOU think of their views?", "\U0001F4AD", "Viewpoint judge", ["3Ea.01"],
             ...
             explain(
                 ...
                 ["I partly agree with Mr Bello, because the ducks do need protecting, and because a dog on a leash cannot get enough exercise.",
             ...
             {"reasonsNeeded": 2,
              "rounds": [
                 {"topic": "dogs on leashes in the park", "tag": "leashes", "pic": "\U0001F9D1\U0001F3FE‍\U0001F33E", "ask": "What do you think of Mr Bello's view?",
                  "view": {"name": "Mr Bello", "pic": "\U0001F9D1\U0001F3FE‍\U0001F33E", "says": "Dogs should be on leashes at all times, for the ducks and the flower beds."},
                  ...
                  "reasons": [dict(tagged("because the ducks and their nests do need protecting", "leashes"), supports=['agree', 'part']), dict(tagged("because the flower beds get dug up by loose dogs", "leashes"), supports=['agree', 'part']), dict(tagged("because a dog on a leash cannot get enough exercise", "leashes"), supports=['disagree', 'part']), dict(tagged("because leashes everywhere seem unfair on dogs that behave", "leashes"), supports=['disagree', 'part']),
        ...
        step("questions", "Views and viewpoints", "\U0001F4AC", "Viewpoint judge", ["3Ap.01", "3Es.01", "3Ea.01"],
             ...
             {"label": "Question", "items": [
                 ...
                 q("What was the viewpoint in Mrs Adams's letter?", "✉️", "dogs should run free on the big field", ["dogs should be on leashes", "the pond should be filled in"], "She thinks the park should let dogs run free on the field."),
        ...
        step("quiz", "Show what you know", "⭐", "Star evaluator", ["3Ap.01", "3Es.01", "3Ea.01"],
             ...
             {"items": [
                 q("What is a viewpoint?", "\U0001F4AD", "what a person thinks should happen about a topic", ["a fact everybody agrees on", "a kind of poster", "a place in the park"], "The park keeper's viewpoint is that dogs should be on leashes."),
                 q("Which of these is a FACT, not a view?", "✅", "The park has a pond with ducks", ["Dogs should be on leashes", "Dogs need to run free", "A fence would suit everyone"], "Anybody can see the ducks."),
                 ...
                 q("What did Mr Bello's poster ask people to do?", "\U0001F4CB", "keep dogs on a leash at all times", ["let dogs run free", "feed the ducks", "plant flowers"], "Please keep your dog on a leash at all times."),
...
LESSON["lecture"] = [
    part("\U0001F3DE️", "One park, four views",
         "Should dogs run free in Riverside Park? Mr Bello the park keeper says leashes, for the ducks. Mrs Adams the dog owner says free, for the dogs' health. Mr Khan says a fence. Leila the runner says leashes on the path. Same park, four views."),
    part("⚖️", "Facts and views",
         "A fact is true for everybody: the park has a pond with ducks. A view is what one person thinks should happen: dogs should be on leashes. Other people can think differently, and that is not the same as being wrong."),
    part("\U0001F4CB", "An author has a viewpoint",
         "A poster or a letter was written by somebody, and that somebody thinks something. Mr Bello's poster asks for leashes and gives his reasons. Mrs Adams's letter asks for the big field and gives hers. Find the sentences that show it."),
...
LESSON["words"] = [
    word("viewpoint", "\U0001F4AD", "What a person thinks should happen about a topic.",
         ["Mr Bello's viewpoint is that dogs should be on leashes.", "Find the author's viewpoint."]),
...
LESSON["check"] = [
    q("Which one is a fact?", "\U0001F4CC", "The park has a pond.", ["The park is the best place to play.", "Dogs are annoying."], "You can check that the park has a pond. The others are what somebody thinks."),
    q("A farmer and a football team see the same rainy day. Can they think different things about it?", "\u2614", "Yes: people can think different things", ["No: they must think the same", "Only if one of them is wrong"], "The same rain can be good for the farmer's crops and bad for the football match."),
]

        ...
        step("questions", "Circuit check", "✅", "Circuit check", ["2Pe.01", "2Pe.02", "2Pe.03"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Can you build a working circuit with no cell?", "\U0001F50B", "No", ["Yes"],
                   "Nothing would push the electricity round the loop."),
              ...
              "extension": [
                 ...
                 q("Two children build the same circuit and only one lamp lights. Name two things worth checking.", "\U0001F527", "whether every joint is tight, and whether the cell still has push", ["which child is taller", "nothing - one circuit is simply luckier"],
                   "When the parts are right the fault is in the joins between them, or in the cell."),
              ]},

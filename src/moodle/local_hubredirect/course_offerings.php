...
:root{--op-font:"Lato",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Noto Sans",Ubuntu,Cantarell,"Helvetica Neue",sans-serif;--op-primary:#1a67a3;--op-primary-hover:#134a81;--op-primary-subtle:#d1e1ed;--op-primary-border:#a3c2da;--op-primary-emphasis:#0a2941;--op-ink:#1f1f1f;--op-ink-muted:#555;--op-ink-soft:#707070;--op-ink-faint:#919191;--op-line:#dfdfdf;--op-line-strong:#ccc;--op-canvas:#f2f2f2;--op-surface:#fff;--op-surface-tint:#ebf3f7;--op-surface-soft:#f9f9f9;--op-ok-bg:#d1e7dd;--op-ok-line:#a3cfbb;--op-ok-ink:#0a3622;--op-bad-bg:#f8d7da;--op-bad-line:#f1aeb5;--op-bad-ink:#58151c;--op-warn-ink:#664d03;--op-radius:3px;--op-pill:50rem;--op-focus:0 0 0 .25rem rgba(26,103,163,.25)}
...
.pqco-shell .pqh-workspace-top{padding:16px 20px!important;border:1px solid var(--op-line)!important;border-radius:var(--op-radius)!important;background:var(--op-surface)!important;box-shadow:none!important}
.pqco-shell .pqh-workspace-title{display:block!important;margin:0!important;color:var(--op-ink)!important;font-size:24px!important;font-weight:700!important;line-height:1.25!important;letter-spacing:0!important;text-shadow:none!important}
.pqco-shell .pqh-workspace-sub{margin:4px 0 0!important;color:var(--op-ink-soft)!important;font-size:14px!important;font-weight:400!important;opacity:1}
...
/* Logout stays visually distinct from its two neighbours, as it was before, but
   as OpenProject's outline-primary button rather than the only filled button on
   the page -- filled would make signing out the loudest action in the header.
   Carries .pqco-btn so it outranks the filled .pqco-btn:not(--light) rule. */
.pqco-shell .pqh-workspace-actions a.pqco-btn.pqh-workspace-logout{background:var(--op-surface)!important;border-color:var(--op-primary)!important;color:var(--op-primary)!important}
.pqco-shell .pqh-workspace-actions a.pqco-btn.pqh-workspace-logout:hover{background:var(--op-primary)!important;border-color:var(--op-primary)!important;color:#fff!important}

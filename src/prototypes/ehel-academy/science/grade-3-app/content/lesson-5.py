        ...
        step("questions", "Organ check", "✅", "Organ check", ["3Bs.03", "3TWSm.01"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Does your body have organs inside it?", "\U0001FAC0", "Yes", ["No"],
                   "Each one is a part with a job: the heart pumps, the lungs take in air."),
                 q("Is your brain an organ?", "\U0001F9E0", "Yes", ["No"],
                   "It is a part inside the body with a job, so it is an organ."),
              ],
              "extension": [
                 ...
                 q("Your intestine is several metres long and coiled up. Why so long?", "\U0001F35C", "the longer the tube, the more goodness can cross into the blood", ["to hold a whole day's food at once", "so it can reach down to your legs"],
                   "Every part of that long wall takes something across. A short tube would let most of it past."),
                 q("A doctor listens to your chest rather than your arm. Why there?", "\U0001FA7A", "the heart and lungs are both in the chest, and both make sounds", ["the arm is too thin to hear through", "it makes no difference where they listen"],
                   "Two of the busiest organs sit side by side there, and each has a sound of its own."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Bs.03", "3TWSm.02", "3TWSm.03"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Does food go to your stomach after you swallow?", "\U0001F372", "Yes", ["No"],
                   "Down to the stomach first, then on to the intestine."),
                 q("Do you have one heart or two?", "\u2764\uFE0F", "one", ["two"],
                   "One heart, and two lungs either side of it."),
              ],
              "extension": [
                 ...
                 q("You hold your breath and after a while you MUST breathe. What is your body short of?", "\U0001F32C\uFE0F", "the air your lungs pass into your blood", ["food from your stomach", "water"],
                   "Your body has no store of air. That is why the need comes on so fast."),
                 q("The bottle-and-balloon model has no blood in it at all. Does that make it a bad model?", "\U0001F4A7", "no - a model leaves out what you are not studying", ["yes, a model must show everything", "yes, it teaches the wrong thing"],
                   "It was built to show how air gets in and out. Leaving the blood out is what keeps it simple enough to follow."),
              ]},

    ...
    "steps": [
        ...
        step("sort", "Sort them into two bins", "\U0001F5C2️", "Sorted it", ["1Bp.01", "1TWSc.01"],
             ...
             explain(
                 ...
                 ["Look at the thing in the box.", "Ask the four questions: does it grow? Does it need food? Does it need water? Can it have young?", "If yes, tap Alive.", "If no, tap Never alive.",
             ...
             "Alive things grow, need food and water, and can have young."),
...
LESSON["words"] = [
    ...
    word("never alive", "\U0001FAA8", "Not alive now, and not alive ever. It does not grow, need food or have young.",
         ["A stone was never alive.", "A spoon was never alive."]),

...
LESSON = {
    ...
    "steps": [
        ...
        step("askq", "Build a focused question", "❓", "Question builder", ["2Rq.01"],
             ...
             {"topic": "our crowded playground", "words": ["What", "Where", "Who", "When", "Why", "How many"],
              ...
              "rounds": [
                  ...
                  {"want": "the reason the slide gets so crowded", "pic": "\U0001F6A8", "word": "Why", "end": "crowd", "why": "Why asks for a reason. We can ask the children waiting there."},
        ...
        step("source", "Find it in the picture", "\U0001F3DF️", "Picture finder", ["2Ri.01"],
             ...
             explain(
                 ["A picture is a source.", "This year you do not just look at it: you find the PART that answers your question."],
        ...
        step("text", "Find it in the text", "\U0001F4C4", "Text finder", ["2Ri.01"],
             ...
             explain(
                 ...
                 ["When can we use the field? Find the sentence about the field.", "Where may football be played? Find the sentence about football."],
             ...
             {"title": "Our playground rules",
              "lines": [
                  ...
                  "Grade 1 and Grade 2 may use the sandpit and the quiet corner.",
              ...
              "rounds": [
                  ...
                  {"ask": "Who may use the quiet corner?", "about": "who may use the quiet corner", "line": 3, "why": "Grade 1 and Grade 2 may use the sandpit and the quiet corner. That is us."},
        ...
        step("quiz", "Show what you know", "⭐", "Star researcher", ["2Rq.01", "2Ri.01"],
             ...
             {"items": [
                 ...
                 q("Who may use the quiet corner, according to the rules?", "\U0001F4C4", "Grade 1 and Grade 2", ["only teachers", "nobody", "only footballers"], "The rule said Grade 1 and Grade 2 may use the sandpit and the quiet corner."),
...
LESSON["lecture"] = [
    ...
    part("\U0001F440", "Finding it in a picture",
         "A picture is a source. This year you find the PART of the picture that answers your question. Where do the footballers play? Find the football. Which part is empty? Find the quiet corner."),

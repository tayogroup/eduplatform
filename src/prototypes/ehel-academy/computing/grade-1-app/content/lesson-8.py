    ...
    "steps": [
        ...
        step("quiz", "Show what you know", "⭐", "Star computer scientist", ["1CS.01", "1CS.02", "1CS.03", "1CS.04", "1CS.05", "1CS.06"],
             ...
             {"items": [
                 ...
                 q("What is a robot?", "\U0001F916", "a machine with a computer inside, programmed to move and do a job", ["any toy that moves when you push it", "a person in a costume made of metal", "a very fast bicycle with lights on it"], "A toy has no computer. A person in a costume is a person. A robot needs both a computer and a program."),

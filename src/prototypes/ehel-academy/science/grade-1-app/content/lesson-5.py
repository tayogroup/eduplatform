        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["1Pf.01", "1Pf.02", "1Pf.03"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Does a ball roll when you push it?", "\u26BD", "Yes", ["No"],
                   "A push makes it move."),
                 q("Is a pull a force?", "\U0001FAA2", "Yes", ["No"],
              ...
              "extension": [
                 ...
                 q("You give a toy car the same push on carpet and on a smooth floor. Where does it go further?", "\U0001F697", "the smooth floor", ["the carpet", "exactly the same on both"],
                   "A rough surface rubs against the wheels and slows the car sooner."),
                 q("You hold a ball under the water and let go. Which way does it move, and what moves it?", "\U0001F3D0", "up, because the water pushes it up", ["down, because the Earth pulls it", "it stays exactly where you left it"],
                   "Water pushes up on things that are in it. That push is why some things float."),
              ]
             },
...
LESSON["words"] = [
    ...
    word("slope", "\u26F0\uFE0F", "A surface that starts high and ends low.",
         ["A ball rolls down a slope.", "The steeper the slope, the faster it rolls."]),
    word("slide", "\U0001F6F7", "To move across a surface while touching it.",
         ["A box slides across the floor.", "It slides further on smooth ground."]),
    word("stretch", "\u2194\uFE0F", "To change a shape by pulling, so it gets longer.",
         ["Pull the band and it stretches.", "Stretching is a change you make with a pull."]),
    word("twist", "\U0001F300", "To change a shape by turning its ends different ways.",
         ["Twist the cloth and it wrings out.", "You twist a lid to open a jar."]),
    word("pattern", "\U0001F4C8", "Something that happens again and again, so you can say what usually happens.",
         ["Heavier things sank - that is the pattern.", "Look for a pattern in what you found."]),
    word("results", "\U0001F4CA", "What you found out when you tested something.",
         ["Write your results in the table.", "Our results showed the ball rolled furthest on wood."]),
    word("record", "\U0001F4DD", "To write or draw what you saw, so you do not forget it.",
         ["Record what floated and what sank.", "Scientists record everything they find."]),
    word("compare", "\u2696\uFE0F", "To look at two things and say how they are alike and different.",
         ["Compare how far the ball rolled on each surface.", "We compared two pushes."]),
    word("table", "\U0001F4CB", "A grid of boxes where you write down what you found.",
         ["Fill in the table as you test each object.", "The table shows what floated and what sank."]),
    word("surface", "\U0001F7E6", "The outside of something, the part you touch.",
         ["A smooth surface is easy to slide on.", "The surface of the water was still."]),
]

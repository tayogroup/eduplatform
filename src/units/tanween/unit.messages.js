  ...
  root.PQ_UNIT_MESSAGES = Object.freeze({
      "entry": {
        "lecture": {
          ...
          "text": "Welcome to the Tanween unit. Click Play Lecture and listen carefully before you begin."
        },
        "rules": {
          "audio": "tanween_movement_rules.mp3",
          "text": "You have completed the lecture. You have now entered the Rules step. Learn how Tanween adds the light n sound."
        },
        "listen": {
          "audio": "tanween_movement_step_listen.mp3",
          "text": "You have completed the Rules step. You have now entered the Listen step. Listen carefully to each word."
        },
        "watch": {
      ...
      "completion": {
        ...
        "text": "Congratulations. You have completed the Tanween unit."
      }
    });

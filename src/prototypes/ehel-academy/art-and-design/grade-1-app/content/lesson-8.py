    ...
    "steps": [
        ...
        step("refine", "Make it even better", "🔧", "Gallery mender", ["1TWA.03", "1R.02"],
             ...
             explain(
                 ...
                 ["The pot has a crack: smooth it.", "Nobody can read the label: write it bigger and darker.",
                  "The sky ran: less water, and let it dry."],
                 ["Children think 'better' means 'start again'.", "Change ONE thing."],
                 ["Tap a change and see what it does."]),
             {"rounds": [
                 {"piece": {"title": "The clay pot", "scene": "claypot", "state": "cracked", "fixedState": "smooth", "problem": "A crack has opened in the side.", "fixed": "Smooth and ready for the show."},
                  "needs": "smooth",
                  "changes": [
                      change("smooth", "Wet your fingers and smooth the crack", "💧", "smooth", "The crack closes over. Smooth."),
                      change("lid", "Add a lid", "🫖", "add", "A lid on a cracked pot."),
                      change("paint", "Paint over the crack", "🎨", "colour", "Painted, and still cracked underneath."),
                      change("bigger", "Make the pot bigger", "⭕", "size", "A bigger pot with a bigger crack."),
                  ],
                  "why": "Wet clay mends when it is smoothed."},
                 ...
                 {"piece": {"title": "The house picture", "scene": "housepainting", "state": "runny", "fixedState": "fixed", "problem": "The sky ran down the picture.", "fixed": "The sky stays put, and the sun is out."},
                  "needs": "dry",
                  "changes": [
                      change("less", "Use less water and let it dry flat", "☀️", "dry", "Thicker paint, dried flat. No drips."),
                      change("more", "Add more water", "💧", "worse", "Runnier still."),
                      change("frame", "Put a frame round it", "🖼️", "add", "A frame round a runny sky."),
                      change("red", "Paint the house red", "🟥", "colour", "A red house under a sky that still runs."),
                  ],

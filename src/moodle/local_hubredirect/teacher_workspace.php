...
$PAGE->set_url(new moodle_url('/local/hubredirect/teacher_workspace.php', $urlparams));
...
if ($ready
    ...
    if (!confirm_sesskey()) {
        pqh_access_denied(
            ...
            new moodle_url('/local/hubredirect/teacher_workspace.php', $teacherbaseurlparams),
    ...
    redirect(new moodle_url('/local/hubredirect/teacher_workspace.php', $teacherbaseurlparams + ['result' => 'coaching_acknowledged']));
}
...
if ($ready
    ...
    redirect(new moodle_url('/local/hubredirect/teacher_workspace.php', $teacherbaseurlparams + ['result' => 'plan_acknowledged']));
}
...
.pqltch-shell.pqh-rail-x{padding-left:216px}
.pqltch-shell.pqh-rail-x .pqh-gnav{width:216px}
.pqltch-shell.pqh-rail-x .pqh-gnav__item{flex-direction:row;justify-content:flex-start;gap:11px;padding:10px 12px;font-size:12.5px;text-align:left}
.pqltch-shell.pqh-rail-x .pqh-gnav__brand{margin-left:10px;margin-right:auto}
@media(max-width:900px){.pqltch-shell.pqh-rail-x{padding-left:0}}
</style>
...
<nav class="pqh-gnav" aria-label="Global navigation">
  ...
  <a class="pqh-gnav__item is-active" href="<?php echo (new moodle_url('/local/hubredirect/teacher_workspace.php', $teacherbaseurlparams))->out(false); ?>">
...
<script>
(function(){
  var shell = document.querySelector('.pqltch-shell');

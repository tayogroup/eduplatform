...
label_ct(LESSON, "What goes in?", "Abstraction")
label_ct(LESSON, "Input, step or output?", "Abstraction")
label_ct(LESSON, "Build a word machine", "Algorithmic thinking")
label_ct(LESSON, "Check: inputs and outputs", "Abstraction")
...
# from lecture-video/input-machines.json. The names are content hashes, so a
# re-render gets new ones and must be re-listed here and in app.config.json
# extraPages.
LESSON["video"] = {
    "src": "lecture-video/input-machines.007a424d.mp4",
    "captions": "lecture-video/input-machines.815ef137.vtt",
    "poster": "lecture-video/input-machines.a62ed27e.jpg",

...
LAYERS = [
    ...
    {"id": "mantle", "label": "mantle", "say": "The mantle: a very thick layer of hot rock under the crust, so hot that in places it is soft and slowly flows."},
    {"id": "core", "label": "core", "say": "The core: the centre of the Earth. Metal, and hotter than the surface of the Sun."},
]
    ...
    "steps": [
        step("label", "Crust, mantle, core", "\U0001F30D", "Earth layers", ["4ESp.01"],
             ...
             explain(
                 ...
                 ["The crust: thin, hard rock, where we live.", "The mantle: thick, hot rock, soft enough to flow slowly.", "The core: metal, unbelievably hot, at the centre."],
        ...
        step("demo", "An earthquake", "\U0001F3DA️", "Earthquake", ["4ESp.03", "4ESp.01"],
             ...
             explain(
                 ["The crust is broken into huge pieces, called plates, which move very slowly on the soft mantle.", "Where two plates push against each other they stick, until they slip suddenly. That is an earthquake."],
                 ...
                 ["Press Next through all four."]),
             {"frames": [
                 {"scene": {"id": "quake", "state": 0}, "cap": "The crust is made of huge pieces called <b>plates</b>, floating on the soft mantle.", "say": "The crust is not one shell. It is broken into huge pieces called plates, which sit on the soft, slowly flowing mantle."},
        ...
        step("lookup", "Look it up: volcano features", "\U0001F4DA", "Volcano facts", ["4TWSc.07", "4ESp.02"],
             ...
             {"source": {"title": "The parts of a volcano",
                         "lines": ["Under the volcano is a <b>magma chamber</b>: a pocket of melted rock.",
                                   ...
                                   "Lava that pours out is between 700 and 1,200 degrees. It cools into rock, and layer on layer of it builds the volcano's <b>cone</b> shape.",
        ...
        step("explore", "A model of the Earth to scale", "\U0001F34E", "Scale model", ["4TWSm.02", "4TWSm.01", "4ESp.01"],
             ...
             explain(
                 ...
                 ["Apple skin: the crust.", "The flesh: the mantle.", "The core in the middle: the core.", "And a model always leaves things out: the real mantle is hot enough to glow."],
                 ["Children draw the crust as thick as the mantle.", "It is a skin. The mantle is most of the Earth."],
                 ["Tap all four."]),
             {"items": [
                 ...
                 {"pic": "\U0001F7E1", "label": "the flesh", "sub": "the mantle", "say": "The flesh of the apple is the mantle: nearly all of the inside, thick and hot."},
                 {"pic": "\U0001F7E4", "label": "the core in the middle", "sub": "the core", "say": "The apple's core in the middle is the Earth's core: the metal centre."},
                 {"pic": "\U0001F4D0", "label": "what the model leaves out", "sub": "heat, movement, metal", "say": "The apple shows the layers and their scale. It leaves out the heat, the slow flowing of the mantle, and that the core is metal. No model shows everything, and this one is not meant to."},
             ], "need": 4,
              "then": {"ask": "What does the apple model show well?",
                       "opts": [opt("The scale of the layers: a thin crust, a thick mantle, a core in the middle", True), opt("How hot the inside is", False), opt("That the Earth is made of fruit", False)],
                       "why": "A model shows some things and leaves out others. This one shows scale."}},
             "A thin crust, a thick mantle, a core in the middle. A model to scale, and its limits."),
        ...
        step("context", "How we found out", "\U0001F4DC", "Earth evidence", ["4SIC.01", "4ESp.01", "4ESp.03"],
             ...
             explain(
                 ...
                 ["Long ago, people thought the Earth was solid rock, or hollow.", "Earthquake waves travel differently through liquid and solid, and listening to them mapped the layers.", "Volcanoes bring up rock from below.", "The idea that continents move was laughed at until the evidence piled up."],
                 [],
                 ["Tap each one."]),
             {"items": [
                 ...
                 {"pic": "\U0001F4E1", "label": "earthquake waves", "say": "Earthquakes send waves right through the Earth. Scientists found that the waves bend and slow in ways that only make sense if there is a soft mantle and a metal core. That evidence built the model."},
              ...
              "then": {"ask": "How do we know there is a metal core, if nobody has seen it?",
                       "opts": [opt("Earthquake waves travel through the Earth in a way that only a metal core explains", True), opt("Somebody dug down and looked", False), opt("We do not know; it is a guess", False)],
        ...
        step("questions", "Earth check", "✅", "Earth check", ["4ESp.01", "4ESp.02", "4ESp.03"],
             ...
             {"label": "Question", "items": [
                 ...
                 q("What is lava?", "\U0001F30B", "melted rock that has reached the surface", ["cold rock", "a kind of water"], "Magma, once it is out."),
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4ESp.01", "4ESp.02", "4ESp.03", "4TWSm.02", "4SIC.01"],
             ...
             {"items": [
                 ...
                 q("Which layer is thickest?", "\U0001F7E1", "the mantle", ["the crust", "the core"], "Most of the inside."),
                 ...
                 q("How fast do the plates move?", "\U0001F485\U0001F3FE", "about as fast as your fingernails grow", ["as fast as a car", "they do not move"], "Slowly, all the time."),
                 q("In the apple model, what is the skin?", "\U0001F34E", "the crust", ["the mantle", "the core"], "Thin, like the crust."),
                 q("What evidence showed the Earth has a metal core?", "\U0001F4E1", "the way earthquake waves travel through it", ["a photograph", "a deep hole"], "Enquiry, not a look."),
             ]},
...
LESSON["lecture"] = [
    part("\U0001F30D", "Three layers",
         "Scientists model the Earth as three layers. The crust: a thin shell of hard rock, where we live. The mantle: a very thick layer of hot rock, soft enough in places to flow slowly. The core: metal at the centre, hotter than the surface of the Sun."),
    ...
    part("\U0001F34E", "A model to scale",
         "If the Earth were an apple, the crust would be thinner than the skin, the flesh would be the mantle, and the core in the middle would be the core. The model shows the scale of the layers. It leaves out the heat and the metal."),
    part("\U0001F4E1", "How we know",
         "Nobody has seen the mantle or the core. The model was built from evidence: earthquake waves that bend and slow inside the Earth, rock that volcanoes bring up, continents that fit together. Evidence from enquiry changed what people knew."),
]
...
LESSON["words"] = [
    ...
    word("mantle", "\U0001F7E1", "The thick layer of hot rock under the crust.",
         ["The mantle is most of the inside of the Earth.", "The plates float on the mantle."]),
    word("core", "\U0001F525", "The metal centre of the Earth.",
         ["The core is hotter than the surface of the Sun.", "Earthquake waves told us the core is metal."]),
...
LESSON["home"] = [
    ...
    home("Kitchen volcano", "Bicarbonate of soda, vinegar, a small bottle, a tray, red food colouring, a grown-up",
         ["Stand the bottle on the tray and put two spoons of bicarbonate in it.",
          "Add a drop of colouring, then pour in vinegar.",
          "Watch it erupt over the sides."],

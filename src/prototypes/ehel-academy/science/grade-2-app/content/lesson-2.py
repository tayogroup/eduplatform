    ...
    "steps": [
        ...
        step("sort", "Healthy or not?", "\U0001F5C2️", "Healthy choices", ["2Bp.01", "2TWSc.01"],
             ...
             explain(
                 ...
                 ["Fruit and vegetables: healthy.", "Sweets all day: not.", "Washing hands before eating: healthy.", "Running about outside: healthy.", "Sitting still all day: not."],
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["2Bs.02", "2Bp.01", "2Bp.02"],
             ...
             {"items": [
                 ...
                 q("Which teeth are pointed, for tearing?", "\U0001F9B7", "canines", ["incisors", "molars", "baby teeth"], "Canines are the pointed teeth beside the incisors."),
                 q("How long should you brush your teeth for?", "⏱️", "two minutes", ["five seconds", "an hour", "as long as a song"], "Two minutes, all the way to the back."),
                 ...
                 q("What are the three things a body needs to stay healthy?", "\U0001F4AA", "good food, keeping clean and moving", ["sweets, television and sleep", "only sleep"], "Diet, hygiene and exercise."),

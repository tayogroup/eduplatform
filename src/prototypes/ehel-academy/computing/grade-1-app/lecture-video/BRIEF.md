# Brief: the Grade 1 Computing unit lecture films
...
**This grade has 8 lessons and 7 film(s) to make.**

**Lesson 8, computers-everywhere, already has a film and is NOT one of them.** It is live and is not remade; leave its files alone.
...
| file | what it is |
| --- | --- |
| `src/prototypes/ehel-academy/computing/grade-1-app/lecture-video/<slug>.json` | the storyboard: the script and its cues |
| `tools/lib/film-scenes/computing-g1/<slug>.js` | your pictures (more parts if needed: `<slug>-2.js`, `<slug>-3.js`) |
...
```json
{
  "_comment": "Storyboard for the Grade 1 Computing unit lecture film, Lesson N <Title>. Rendered by tools/create-ehel-unit-lecture.js. See lecture-video/BRIEF.md.",
  "slug": "<slug>",
  "lesson": N,
  "grade": 3,
  "stage": 3,
  "title": "<the lesson's title, exactly as app.config.json has it>",
  "subtitle": "Grade 1 Computing",
  "framework": "Cambridge Primary Computing 0059",
  "renderer": {
    "art": ["computing"],
    "skin": "brown",
    "scenes": ["tools/lib/ehel-film-marks.js", "tools/lib/film-scenes/computing-g1/<slug>.js"]
  },
...
### Language: a Grade 1 child (about 6), and the lesson's own words
...
```bash
T="node tools/create-ehel-unit-lecture.js --app src/prototypes/ehel-academy/computing/grade-1-app --slug <slug>"
...
```bash
node tools/check-ehel-film-cues.js computing 1
```

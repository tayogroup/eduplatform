  ...
  const QS = [
    ...
    /* 2026-09-12: two more, for 6 of 8 = 75% rather than 4 of 6 = 67%. They
       test "All the way round" and "Regular or irregular", which the check had
       not asked about. The side avoids 4, where 2n and n+4 would collide. */
    () => { const n = rnd(5, 9); return { q: "A square has sides of " + n + " cm. How far is it all the way round?", opts: [n * 4 + " cm", n * 2 + " cm", (n + 4) + " cm"], a: n * 4 + " cm", why: "Four equal sides: " + n + " + " + n + " + " + n + " + " + n + " = " + (n * 4) + " cm." }; },
    () => { return { q: "A shape has 5 equal sides and 5 equal angles. What is it?", opts: ["a regular pentagon", "an irregular pentagon", "a regular hexagon"], a: "a regular pentagon", why: "Five sides makes a pentagon, and equal sides and angles make it regular." }; },
  ];
;

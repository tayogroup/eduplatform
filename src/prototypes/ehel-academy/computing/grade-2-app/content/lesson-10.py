...
LESSON = {
    ...
    "steps": [
        ...
        step("label", "The parts of a tablet", "\U0001F4F1", "Tablet labeller", ["2CS.02", "2CS.01"],
             ...
             explain(
                 ["A tablet is designed to be easy to use: a big touchscreen, one home button that always takes you home, buttons you can feel."],
                 ["The touchscreen is the keyboard, the mouse and the screen in one.", "The home button always goes back to the start, so you can never get lost.",
        ...
        step("explore", "Robots in stories, robots at work", "\U0001F916", "Robot comparer", ["2CS.06"],
             ...
             explain(
                 ["In stories, robots talk, joke, have feelings and look like people.", "Real robots are programmed for one job, and most look like arms, boxes or cars."],
                 ["A story robot butler makes jokes. A real factory arm welds the same joint ten thousand times.",
                  "A story robot has feelings. A real robot vacuum has a bump sensor."],
                 [],
                 ["Tap each one and say: story, or real?"]),
             {"items": [
                 {"pic": "\U0001F916\U0001F3A9", "label": "a robot butler that tells jokes", "sub": "story", "say": "A robot butler that chats and tells jokes. A story robot. No real robot understands a joke."},
                 ...
                 {"pic": "\U0001F916", "label": "a robot vacuum", "sub": "real", "say": "A robot vacuum. Real. Its program says: forward until a bump, turn, forward again."},
              ...
              "then": {"ask": "Which is a REAL robot with a real-world job?",
                       "opts": [opt("A factory arm that welds cars", True), opt("A robot butler that tells jokes", False), opt("A robot with feelings", False)],
                       "why": "Real robots are programmed for a job. Jokes and feelings are for stories."}},
             "Story robots talk and feel. Real robots have a job and a program."),
        ...
        step("sort", "Story robot, or real robot?", "\U0001F5C2️", "Fiction or real", ["2CS.06"],
             ...
             explain(
                 ["Ask: does it have a program and a job? Real. Does it think, feel or joke like a person? Story."],
                 [],
                 [],
                 ["Read it, decide, tap."]),
             ...
             "A program and a job: real. Feelings and jokes: a story."),
        ...
        step("quiz", "Show what you know", "⭐", "Star computer scientist", ["2CS.01", "2CS.02", "2CS.03", "2CS.04", "2CS.05", "2CS.06"],
             ...
             {"items": [
                 ...
                 q("A robot that tells jokes and has feelings is...", "\U0001F4D6", "a story robot", ["a real factory robot", "a robot vacuum", "a rover"], "Real robots have programs and jobs, not feelings."),
...
LESSON["lecture"] = [
    ...
    part("\U0001F916", "Story robots and real robots",
         "In stories, robots talk, joke and have feelings. Real robots have a program and a job: an arm that welds cars, a vacuum that turns when it bumps, a rover on Mars. People choose a device for the place and the purpose, and they choose a robot for a job."),
]

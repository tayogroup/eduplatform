...
4TWSm.02 use a model to show relationships; with 4TWSc.01 and 4Pf.03.
"""
    ...
    "steps": [
        ...
        step("sort", "Herbivore, carnivore or omnivore?", "\U0001F5C2️", "Eater sort", ["4Be.03", "4TWSc.01"],
             ...
             explain(
                 ...
                 ["A rabbit eats grass: herbivore.", "A fox eats rabbits: carnivore.", "A bear eats berries AND fish: omnivore.", "You eat vegetables and meat: omnivore."],
             ...
             {"ask": "Herbivore, carnivore or omnivore?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F98A", "label": "fox", "bin": "carn", "why": "Rabbits, mice and birds."},
                  ...
                  {"pic": "\U0001F984", "label": "horse", "bin": "herb", "why": "Grass and hay."},
        ...
        step("explore", "Predator and prey", "\U0001F989", "Hunter and hunted", ["4Be.03"],
             ...
             explain(
                 ...
                 ["The owl is a predator; the mouse is its prey.", "The mouse eats seeds, so it is also a herbivore.", "The frog is a predator of flies and the prey of the heron."],
        ...
        step("build", "A model of who eats whom", "\U0001F527", "Chain model", ["4TWSm.02", "4Be.03", "4Bp.03"],
             ...
             explain(
                 ...
                 ["Grass: the producer, energy from light.", "Rabbit: a herbivore, and the fox's prey.", "Fox: a carnivore, a predator.", "Then take the grass away and watch the relationship break."],
                 ["Children think the model IS the animals.", "It is a model of the relationship. Real foxes eat many things."],
             ...
             {"sim": "foodChain",
              "parts": [
                  ...
                  {"id": "fox", "label": "fox: carnivore, predator", "pic": "\U0001F98A"},
              ]},
             "The model shows the relationship: energy goes from producer to consumer to consumer."),

        step("order", "A sea food chain", "\U0001F30A", "Sea chain", ["4Be.03"],
             "Put this sea food chain in order, producer first.",
             explain(
                 ["The sea has food chains too, starting with tiny plants."],
                 ...
                 ["Children start with the seal.", "Start with the producer. Always."],
                 ["Tap the producer first."]),
             {"items": [
             ...
             "Tiny plants, small fish, bigger fish, seal. Producer first, then consumers."),
        ...
        step("questions", "Energy check", "✅", "Energy check", ["4Bp.03", "4Be.03"],
             ...
             {"label": "Question", "items": [
                 ...
                 q("An animal that eats plants AND animals is...", "\U0001F43B", "an omnivore", ["a herbivore", "a carnivore"], "Omni means all."),
                 q("An animal that hunts others is called...", "\U0001F989", "a predator", ["prey", "a producer"], "The hunter."),
                 q("Why do you need to eat?", "\U0001F37D️", "for the energy to grow, move and stay healthy", ["to keep your teeth busy", "you do not"], "Food is your energy."),
             ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["4Bp.03", "4Be.03", "4TWSm.02"],
             ...
             {"items": [
                 ...
                 q("Which of these is a producer?", "\U0001F33F", "grass", ["a rabbit", "a fox", "a seal"], "Makes food from light."),
                 ...
                 q("In owl → mouse, the mouse is the...", "\U0001F401", "prey", ["predator", "producer"], "Hunted by the owl."),
                 q("Can an animal be predator AND prey?", "\U0001F438", "yes, like a frog that eats flies and is eaten by herons", ["no, never", "only fish"], "Most middle links are both."),
                 q("What did the food chain you built show?", "\U0001F527", "the relationship between the grass, the rabbit and the fox: who eats whom", ["the size of a fox", "how fast rabbits run"], "A model of a relationship."),
                 q("Where did the fox's energy come from, in the very beginning?", "☀️", "the Sun, through the grass and the rabbit", ["the fox made it", "the soil"], "Light, then plant, then rabbit, then fox."),
             ]},
...
LESSON["about"] = [
    ...
    "Build a food chain as a model of who eats whom.",
]
...
LESSON["lecture"] = [
    ...
    part("\U0001F37D️", "Three kinds of eater",
         "A consumer that eats only plants is a herbivore: a rabbit, a horse, an elephant. One that eats only animals is a carnivore: a fox, an owl, a shark. One that eats both is an omnivore: a bear, a pig, and most people."),
...
LESSON["words"] = [
    ...
    word("carnivore", "\U0001F98A", "An animal that eats only other animals.",
         ["A fox is a carnivore.", "Sharks are carnivores."]),

...
LESSON = {
    ...
    "steps": [
        ...
        step("explore", "What each part does", "\U0001F331", "Part jobs", ["3Bs.01"],
             ...
             {"items": [
                 {"pic": "\U0001F33F", "label": "roots", "sub": "anchor, take in water", "say": "Roots anchor the plant so the wind cannot blow it over, and they take in water and minerals from the soil."},
                 ...
                 {"pic": "\U0001F343", "label": "leaves", "sub": "make food from light", "say": "Leaves are wide and flat to catch sunlight. They use the light to make the plant's food. That is why leaves are green and face the Sun."},
        ...
        step("experiment", "Does a plant need warmth?", "\U0001F321️", "Warm or cold", ["3Bp.03", "3TWSp.03", "3TWSa.01", "3TWSa.03"],
             "Two plants, watered the same, in the same light. One stays warm. One goes in the cold. Predict first.",
             explain(
                 ...
                 ["Children think water and light are enough.", "Put a plant in the fridge and watch."],
             ...
             {"sim": "plantWarm",
              ...
              "happened": {"ask": "What happened?",
                           "opts": [opt("The warm plant stayed healthy; the cold plant drooped and went pale", True), opt("Both plants stayed healthy", False), opt("The cold plant grew taller", False)],
        ...
        step("record", "Record what you saw", "\U0001F4CB", "Plant table", ["3TWSc.06", "3Bp.03"],
             ...
             {"ask": "On day five, what was the %s like?",
              ...
              "rows": [
                  ...
                  {"pic": "❄️", "label": "cold plant", "answer": "drooping", "why": "the cold plant drooped and went pale, even with the same water and light."},
              ],
              "choices": [{"id": "healthy", "t": "healthy and green", "pic": "\U0001F331"}, {"id": "drooping", "t": "drooping and pale", "pic": "\U0001F940"}]},
        ...
        step("demo", "Three things a plant needs", "\U0001F4A7", "Plant needs", ["3Bp.03"],
             ...
             {"frames": [
                 ...
                 {"pic": "❄️", "cap": "<b>Too cold</b>: it stops growing and droops.", "say": "Make it too cold and it stops growing and droops. That is what you saw in the fridge."},
        ...
        step("questions", "Plant check", "✅", "Plant check", ["3Bs.01", "3Bp.03"],
             ...
             {"label": "Question", "items": [
                 q("Which part takes in water from the soil?", "\U0001F33F", "the roots", ["the flower", "the leaves", "the stem"], "Roots take in water and minerals."),
                 ...
                 q("A plant has water and light but is kept in a fridge. What happens?", "❄️", "it droops and stops growing", ["it grows well", "it grows faster"], "You saw it. Too cold, and a plant is not healthy."),
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Bs.01", "3Bp.03", "3TWSa.01", "3TWSa.03"],
             ...
             {"items": [
                 ...
                 q("What are the roots for?", "\U0001F33F", "anchoring the plant and taking in water", ["making food", "making seeds"], "Anchor and drink."),
...
LESSON["lecture"] = [
    ...
    part("\U0001F321️", "Warm or cold",
         "A plant needs water and light. But it also needs the right temperature. Today you will keep one plant warm and put one in the cold, with the same water and the same light, and see what happens."),
    part("⚖️", "A fair test",
...
LESSON["words"] = [
    word("roots", "\U0001F33F", "The parts under the soil that anchor a plant and take in water.",
    ...
    word("temperature", "\U0001F321️", "How hot or cold something is.",
         ["Plants need the right temperature.", "The temperature in the fridge is too low for a plant."]),
    ...
    word("wilt", "\U0001F940", "To droop because a plant is short of water or is too cold.",
         ["The plant began to wilt in the fridge.", "Without water, leaves wilt."]),
...
LESSON["home"] = [
    home("The fridge plant", "Two small plants or cuttings in cups, water, a fridge, a warm windowsill",
         ["Water both the same and put one on the windowsill and one in the fridge.",
          "Each day, take the fridge one out for a minute and compare them.",
          "After five days, put them side by side and draw both."],
         "The cold one droops and goes pale. Say the conclusion out loud."),
    home("Celery drinks", "A stick of celery with leaves, a glass of water, food colouring",
         ["Put a few drops of food colouring in the water.",
          "Stand the celery in it overnight.",
          "Cut the stem across and look at the ends."],
         "Coloured dots in the stem: the tubes that carry water up to the leaves."),
    home("Find the four parts", "A weed from the garden, with a grown-up's permission",
         ["Pull it up gently, roots and all.",

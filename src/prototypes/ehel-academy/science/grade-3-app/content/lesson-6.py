        ...
        step("questions", "Chain check", "✅", "Chain check", ["3Be.01"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Does the arrow in a food chain show which way the food goes?", "\u27A1\uFE0F", "Yes", ["No"],
                   "It points from the thing eaten to the eater."),
                 q("Is an owl a producer or a consumer?", "\U0001F989", "a consumer", ["a producer"],
                   "It has to eat other living things."),
              ],
              "extension": [
                 ...
                 q("Two chains: pondweed to snail to frog, and grass to rabbit to fox. What is the same about them?", "\U0001F40C", "both start with a plant that makes its own food from light", ["both have exactly three animals", "nothing at all is the same"],
                   "Water or land, the shape is identical: a producer first, then consumers."),
                 q("A gardener sprays every insect in a garden. Why do the birds go hungry?", "\U0001F426", "the insects were the birds' food", ["the spray frightens the birds", "birds only ever eat seeds"],
                   "Remove a link and everything above it loses a meal. That is why people think hard before spraying."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Be.01", "3TWSm.03", "3SIC.04"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Does a fox eat other animals?", "\U0001F98A", "Yes", ["No"],
                   "A fox is a consumer, and it hunts."),
                 q("Where does a plant get the energy to grow?", "\u2600\uFE0F", "from sunlight", ["from the soil"],
                   "A plant catches sunlight. Everything else in the chain gets it second-hand."),
              ],
              "extension": [
                 ...
                 q("Grass makes its own food and a fox cannot. Which of them could live alone in an empty field?", "\U0001F33E", "the grass, because light and water are all it needs", ["the fox, because it can hunt", "neither of them could"],
                   "A producer needs nothing else alive. Every consumer needs something below it in the chain."),
                 q("Why is 'the Sun' the honest answer to where a fox's energy came from?", "\u2600\uFE0F", "the grass caught sunlight, the rabbit ate the grass, the fox ate the rabbit", ["the fox sits in the sun to warm up", "it is not the honest answer"],
                   "Follow the arrows all the way back and every chain ends at the same place."),
              ]},

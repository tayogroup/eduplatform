    ...
    "steps": [
              ...
              "rounds": [
                  ...
                  {"kind": "work", "who": "amal", "situation": "Amal paints a green stripe right over the hills you just painted. It was a mistake.", "pic": "\U0001F58C️",
                   "opts": [{"t": "It is all right, Amal. Let's paint the hills again together.", "good": True, "log": "You helped Amal paint the hills again."},
                            ...
                            {"t": "I am telling the teacher on you.", "good": False, "why": "Telling on a mistake does not fix the hills. Painting them again does."}],
        ...
        step("quiz", "Show what you know", "⭐", "Star team player", ["1Cc.01", "1Ct.01", "1Fc.01", "1Ft.01"],
             ...
             {"items": [
                 ...
                 q("Amal paints over your hills by mistake. What helps the team?", "\U0001F3A8", "Let's paint them again together.", ["You spoiled it!", "I am telling the teacher.", "Go away."], "Fixing a mistake together keeps the team going."),

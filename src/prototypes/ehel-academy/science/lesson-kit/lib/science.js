  ...
  function unitOverview(o) {
    ...
    /* ON ARRIVAL, not on drawing. The deck draws every step at page load,
       ...
       opened a lesson at 13% (found by the 2026-09-11 re-validation). No
       spoken line either: the slide's own instruction is speaking. */
  ...
  function scienceWorld(o) {
    ...
    /* on arrival, not at page load - see unitOverview */
    ONSHOW[o.finish] = () => finish(o.finish);
  }

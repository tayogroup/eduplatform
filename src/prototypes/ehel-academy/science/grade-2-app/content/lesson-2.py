        ...
        step("questions", "Health check", "✅", "Health check", ["2Bp.01", "2Bp.02", "2Bs.02"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Should you brush your teeth before bed?", "\U0001FAA5", "Yes", ["No"],
                   "Twice a day: morning and before bed."),
                 q("Does sugar feed the germs on your teeth?", "\U0001F36C", "Yes", ["No"],
                   "Germs feed on sugar, and that is what makes holes."),
              ],
              "extension": [
                 ...
                 q("A friend never brushes and has no holes in their teeth yet. Does that prove brushing does not matter?", "\U0001F9B7", "no - holes take time, and one person is not evidence", ["yes, it proves it", "it proves brushing causes holes"],
                   "One person who has been lucky so far tells you nothing about what usually happens."),
                 q("Why does a doctor want to know what you have been eating and drinking?", "\U0001F957", "because your diet is part of what keeps you well or makes you ill", ["to find out if you like vegetables", "it makes no difference at all"],
                   "Diet means everything you eat and drink, and it is one of the three things a body needs."),
              ]},
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["2Bs.02", "2Bp.01", "2Bp.02"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("Do your teeth need cleaning between them as well as on top?", "\U0001F9B7", "Yes", ["No"],
                   "Food sticks between teeth, and that is where germs are hardest to reach."),
                 q("Does moving about help your heart?", "\U0001F3C3", "Yes", ["No"],
                   "The heart is a muscle, and using it makes it stronger."),
              ],
              "extension": [
                 ...
                 q("You lose a baby tooth and the new one takes months to appear. Why not stop brushing that gap?", "\U0001FA78", "the teeth on either side still need it, and the new tooth is coming through there", ["there is nothing to brush", "brushing would hurt the gap"],
                   "The gap has neighbours, and the adult tooth is growing right behind it."),
                 q("Why is washing your hands more useful than holding your breath near somebody with a cold?", "\U0001F9FC", "germs travel on hands and surfaces, not only through the air", ["holding your breath works better", "neither one does anything"],
                   "Most germs reach you from what you touch, which is why washing is the habit that matters."),
              ]},

    ...
    "steps": [
        ...
        step("askq", "Construct your questions about food", "❓", "Question builder", ["4Rq.01"],
             ...
             {"topic": "the journey of our food", "words": ["What", "Where", "Why", "How", "How far", "How many"],
              "ends": [
                  {"id": "wheat", "t": "was the wheat in our bread grown?", "words": ["Where", "How"], "asks": "where the wheat was grown"},
                  {"id": "ship", "t": "do bananas reach shops across the sea?", "words": ["How", "Why"], "asks": "how bananas reach far shops"},
                  ...
                  {"id": "cold", "t": "are bananas kept cold on the ship?", "words": ["Why", "How", "Where"], "asks": "the reason for keeping bananas cold"},
        ...
        step("source", "Locate it in the market", "\U0001F3EA", "Market finder", ["4Ri.01"],
             ...
             {"scene": "market", "need": 5, "caption": "Tap the stalls and signs to see what each one tells us about where food comes from.",
              ...
              "rounds": [
                  {"ask": "Which part shows food that came from another COUNTRY?", "about": "food from another country", "spot": "apples", "why": "The crate says Produce of South Africa."},
                  {"ask": "Which part shows food grown CLOSEST to the market?", "about": "food grown closest", "spot": "bananas", "why": "A farm three kilometres up the road."},
        ...
        step("questions", "Questions and journeys", "\U0001F4AC", "Question judge", ["4Rq.01", "4Ri.01"],
             ...
             {"label": "Question", "items": [
                 q("Amal wants to understand how the bread reached Omar's shop. Which question helps?", "\U0001F9E0", "Where was the wheat in this bread grown?", ["Is bread nice?", "What is my favourite bread?"], "She cannot answer it yet, and it opens the start of the bread's journey."),
        ...
        step("quiz", "Show what you know", "⭐", "Star researcher", ["4Rq.01", "4Ri.01"],
             ...
             {"items": [
                 ...
                 q("Where do bananas grow?", "\U0001F34C", "in hot countries near the equator", ["in the snow", "on the ship", "in the shop"], "The first sentence of the text."),

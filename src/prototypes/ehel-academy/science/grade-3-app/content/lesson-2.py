        ...
        step("questions", "Plant check", "✅", "Plant check", ["3Bs.01", "3Bp.03"],
             ...
             {"label": "Question", "items": [
              ...
              "support": [
                 ...
                 q("Does a plant make its own food?", "\U0001F343", "Yes", ["No"],
                   "In its leaves, out of light. No other living thing can do that."),
              ],
              "extension": [
        ...
        step("quiz", "Show what you know", "⭐", "Star scientist", ["3Bs.01", "3Bp.03", "3TWSa.01", "3TWSa.03"],
             ...
             {"items": [
              ...
              "support": [
                 ...
                 q("How many things does a plant need to be healthy?", "\U0001F522", "three", ["one"],
                   "Water, light and the right warmth. Take any one away and it suffers."),

    ...
    "steps": [
        ...
        step("quiz", "Show what you know", "⭐", "Star idea maker", ["1E.02", "1E.03", "1M.02", "1R.01", "1TWA.01", "1TWA.02", "1TWA.03"],
             ...
             {"items": [
                 ...
                 q("Why add sand to the paint for a beach picture?", "🏖️", "because sand makes it rough, like a real beach", ["because sand makes it shiny", "because sand is yellow paint"], "Sand makes the paint rough. A real beach is rough and gritty."),
                 q("Why is it good to try something new in your art?", "🧪", "because trying is how you find out what works", ["because it is always perfect", "because it is quick"], "You do not know what will happen until you try. Trying is how artists find out."),

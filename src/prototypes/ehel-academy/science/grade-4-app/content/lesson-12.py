    ...
    "steps": [
        ...
        step("explore", "What else is out there", "☄️", "Space objects", ["4ESs.04", "4ESs.03"],
             ...
             explain(
                 ...
                 ["Tap all four."]),
             {"items": [
                 {"pic": "☀️", "label": "a star", "sub": "the Sun, at the centre", "say": "A star is a huge ball of burning gas. Our star is the Sun, and it sits at the centre of the Solar System. Everything else goes round it."},
...
LESSON["lecture"] = [
    ...
    part("☀️", "The Sun at the centre",
         "The Sun is a star: a huge ball of burning gas. It sits at the centre of the Solar System, and eight planets go round it. Mercury, Venus, Earth, Mars, then the giants: Jupiter, Saturn, Uranus, Neptune."),
...
LESSON["words"] = [
    ...
    word("star", "⭐", "A huge ball of burning gas. The Sun is our star.",

    ...
    "steps": [
        ...
        step("quiz", "Show what you know", "⭐", "Star pattern maker", ["1E.01", "1E.03", "1M.01", "1TWA.01"],
             ...
             {"items": [
                 ...
                 q("Why is blue, white, blue, white a pattern?", "🟦", "because the same colours come back in the same order", ["because blue is a nice colour", "because it is long"], "A pattern repeats. Blue, white, and then blue, white again."),
                 ...
                 q("Why do tile makers use the same shape on every tile?", "🔷", "so the tiles fit together and make a pattern", ["because they have only one shape", "so the wall looks plain"], "The same shape, again and again, fits together and covers the wall."),
             ]},

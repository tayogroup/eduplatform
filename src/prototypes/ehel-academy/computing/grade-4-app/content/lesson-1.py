    ...
    "steps": [
        ...
        step("loopalgo", "Follow the loops", "\U0001F463", "Loop follower", ["4CT.01", "4CT.02"],
             ...
             {"rounds": [
                 {"mode": "follow", "task": "brush every tooth",
                  "blocks": [s("paste", "Put paste on the brush", "\U0001F9B7"),
        ...
        step("loopalgo", "Correct the loop", "\U0001F41B", "Loop corrector", ["4CT.01", "4CT.02"],
             ...
             {"rounds": [
                 {"mode": "fix", "task": "water three plants",
                  "blocks": [s("can", "Get the watering can", "\U0001F6BF"),
                             {"kind": "repeat", "times": 3, "body": [s("fill", "Fill the can", "\U0001F4A7"), s("pour", "Pour on a plant", "\U0001F331"), s("tip", "Tip the can upside down", "\U0001F643")]},
                             s("away", "Put the can away", "\U0001F6AA")],
        ...
        step("context", "Repetition makes it concise", "✂️", "Concise thinker", ["4CT.03"],
             ...
             explain(
                 ...
                 ["Fill, pour, walk, three times over, is nine steps written out. Repeat 3 times, fill, pour, walk, is three steps and a count.", "Shorter to read, shorter to write, and one change inside the loop changes every turn."],
                 [],
                 ["Tap all four."]),
             {"items": [
                 {"pic": "\U0001F4CF", "label": "shorter to read", "say": "Shorter to read. Five steps and a count instead of eleven steps. You see the whole algorithm at once."},
        ...
        step("sort", "Repeat, or forever?", "\U0001F5C2️", "Loop sorter", ["4CT.01", "4CT.02"],
             ...
             {"ask": "Count-controlled, or forever?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F9B7", "label": "brush the top and bottom teeth 4 times", "bin": "count", "why": "Four times, then stop."},
                  {"pic": "⏰", "label": "a clock ticking", "bin": "forever", "why": "Until the battery goes."},
                  {"pic": "\U0001F331", "label": "water each of the 3 plants", "bin": "count", "why": "Three, then stop."},
        ...
        step("quiz", "Show what you know", "⭐", "Star computer scientist", ["4CT.01", "4CT.02", "4CT.03"],
             ...
             {"items": [
                 ...
                 q("'Repeat 3 times: fill, pour, walk' unrolled is how many steps?", "\U0001F331", "9", ["3", "4", "6"], "Three steps, three turns."),

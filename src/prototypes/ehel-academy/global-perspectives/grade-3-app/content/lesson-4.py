...
LESSON = {
    ...
    "steps": [
        ...
        step("answer", "Who thinks what?", "\U0001F4AD", "View matcher", ["3Ap.01"],
             ...
             {"asker": YASMIN,
              "rounds": [
                  {"ask": "Who thinks dogs should be on leads because they frighten the ducks?", "about": "leads", "pic": "\U0001F986",
                   "opts": [tagged("Mr Bello, the park keeper", "leads", "\U0001F9D1\U0001F3FE‍\U0001F33E"), tagged("Mrs Adams, the dog owner", "free", "\U0001F469\U0001F3FC"), tagged("Mr Khan, the dad", "fence", "\U0001F468\U0001F3FD")],
                   "why": "The park keeper looks after the ducks and the flower beds, and thinks leads protect them."},
                  {"ask": "Who thinks dogs need to run free to be healthy?", "about": "free", "pic": "\U0001F415",
                   "opts": [tagged("Mrs Adams, the dog owner", "free", "\U0001F469\U0001F3FC"), tagged("Leila, the runner", "path", "\U0001F3C3"), tagged("Mr Bello, the park keeper", "leads", "\U0001F9D1\U0001F3FE‍\U0001F33E")],
                   "why": "Mrs Adams has two dogs and thinks running free keeps them healthy."},
                  {"ask": "Who thinks a fenced dog area would suit everyone?", "about": "fence", "pic": "\U0001F6A7",
                   "opts": [tagged("Mr Khan, the dad", "fence", "\U0001F468\U0001F3FD"), tagged("Mrs Adams, the dog owner", "free", "\U0001F469\U0001F3FC"), tagged("Leila, the runner", "path", "\U0001F3C3")],
                   "why": "Mr Khan has a toddler and thinks a fence keeps dogs and small children apart."},
                  {"ask": "Who thinks dogs off the lead trip runners up on the path?", "about": "path", "pic": "\U0001F3C3",
                   "opts": [tagged("Leila, the runner", "path", "\U0001F3C3"), tagged("Mr Bello, the park keeper", "leads", "\U0001F9D1\U0001F3FE‍\U0001F33E"), tagged("Mr Khan, the dad", "fence", "\U0001F468\U0001F3FD")],
        ...
        step("text", "The park keeper's poster", "\U0001F4CB", "Poster reader", ["3Es.01"],
             ...
             {"title": "A poster by the park gate",
              "lines": [
                  ...
                  "The ducks on our pond are frightened by loose dogs, and three nests were lost this spring.",
        ...
        step("opinion", "What do YOU think of their views?", "\U0001F4AD", "Viewpoint judge", ["3Ea.01"],
             ...
             explain(
                 ...
                 ["I partly agree with Mr Bello, because the ducks do need protecting, and because the flower beds get dug up.",
             ...
             {"reasonsNeeded": 2,
              "rounds": [
                 {"topic": "dogs on leads in the park", "tag": "leads", "pic": "\U0001F9D1\U0001F3FE‍\U0001F33E", "ask": "What do you think of Mr Bello's view?",
                  ...
                  "stances": [{"id": "agree", "t": "I agree with Mr Bello"}, {"id": "part", "t": "I partly agree with Mr Bello"}, {"id": "disagree", "t": "I disagree with Mr Bello"}],
                  "reasons": [tagged("because the ducks and their nests do need protecting", "leads"), tagged("because the flower beds get dug up by loose dogs", "leads"), tagged("because a dog on a lead cannot get enough exercise", "leads"), tagged("because leads everywhere seem unfair on dogs that behave", "leads"),
                 ...
                 {"topic": "dogs running free on the big field", "tag": "free", "pic": "\U0001F469\U0001F3FC", "ask": "What do you think of Mrs Adams's view?",
                  ...
                  "stances": [{"id": "agree", "t": "I agree with Mrs Adams"}, {"id": "part", "t": "I partly agree with Mrs Adams"}, {"id": "disagree", "t": "I disagree with Mrs Adams"}],
                  "reasons": [tagged("because dogs do need to run to stay healthy", "free"), tagged("because the big field is far from the ducks", "free"), tagged("because not every owner can control their dog", "free"), tagged("because small children play on the big field too", "free"),
                 ...
                 {"topic": "a fenced dog area", "tag": "fence", "pic": "\U0001F468\U0001F3FD", "ask": "What do you think of Mr Khan's view?",
                  ...
                  "stances": [{"id": "agree", "t": "I agree with Mr Khan"}, {"id": "part", "t": "I partly agree with Mr Khan"}, {"id": "disagree", "t": "I disagree with Mr Khan"}],
                  "reasons": [tagged("because dogs could run and the ducks would still be safe", "fence"), tagged("because toddlers and dogs would be kept apart", "fence"), tagged("because a fence costs money the park may not have", "fence"), tagged("because a fenced area might be too small for big dogs", "fence"),
        ...
        step("quiz", "Show what you know", "⭐", "Star evaluator", ["3Ap.01", "3Es.01", "3Ea.01"],
             ...
             {"items": [
                 ...
                 q("Who thinks a fenced dog area would suit everyone?", "\U0001F6A7", "Mr Khan, the dad", ["Mr Bello", "Mrs Adams", "Leila"], "He has a toddler, and a fence keeps dogs and children apart."),

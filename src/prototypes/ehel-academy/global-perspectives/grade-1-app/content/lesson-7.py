...
LESSON = {
    ...
    "steps": [
        ...
        step("listen", "Listen, then ask", "\U0001F442", "Good listener", ["1Ml.01"],
             ...
             {"rounds": [
                 {"speaker": AMAL, "talk": ["My family has four people: my mum, my dad, my baby brother and me.", "My baby brother is called Yusuf.", "He is one year old, and he laughs when I make faces."],
                  ...
                  "opts": [tagged("What does Yusuf like to play with?", "brother"), tagged("What is your favourite colour?", "colours"), tagged("Do you have a dog?", "pets")],
                  "why": "Amal talked about her baby brother, so a question about Yusuf is about what she said.",
                  "reply": "He likes his red ball best!"},
                 {"speaker": SAMI, "talk": ["I live with my grandma.", "She cooks the best rice in the world.", "On Sundays we go to the market together to buy vegetables."],
        ...
        step("answer", "Tell them what they asked", "\U0001F5E3️", "Good answerer", ["1Mi.01"],
             "Now it is your turn to talk. A classmate asks about your family. Tap the answer that tells them what they asked.",
             explain(
                 ["A good answer gives the information that was asked for."],
                 ["Who lives in your house? My mum, my dad and my brother. That answers it.",
             ...
             {"rounds": [
                 {"asker": NORA, "ask": "Who lives in your house?", "about": "family", "pic": "\U0001F3E0",
                 ...
                 {"asker": OMAR, "ask": "What does your family do on Saturdays?", "about": "Saturdays", "pic": "\U0001F3DE️",
                  "opts": [tagged("We go to the park and have a picnic.", "Saturdays"), tagged("My dad is very tall.", "dad"), tagged("I have a blue school bag.", "bags")],
                  "why": "Omar asked about Saturdays. The park and the picnic is what you do on Saturdays."},
                 {"asker": TARIQ, "ask": "What is your grandma like?", "about": "grandma", "pic": "\U0001F475\U0001F3FE",
                  ...
                  "why": "Tariq asked about your grandma. Kind and funny is about her."},
                 {"asker": YASMIN, "ask": "Who helps you at home?", "about": "helpers", "pic": "\U0001F64B",
                  "opts": [tagged("My big sister helps me with my reading.", "helpers"), tagged("My favourite colour is green.", "colours"), tagged("We have a goldfish.", "pets")],
                  "why": "Teacher Yasmin asked who helps you. Your sister helping with reading is the answer."},
             ]},
             "Four questions about your family, four answers that told them what they asked."),
        ...
        step("askq", "Ask about a family", "❓", "Family asker", ["1Rq.01", "1Ml.01"],
             ...
             {"topic": "families", "words": ["What", "Where", "Who", "When", "Why", "How"],
              "ends": [
                  {"id": "lives", "t": "lives in your house?", "words": ["Who"], "asks": "the people in the house"},
                  {"id": "sunday", "t": "does your family do on Sundays?", "words": ["What"], "asks": "what the family does"},
                  {"id": "grandma", "t": "does your grandma live?", "words": ["Where"], "asks": "the place grandma lives"},
                  {"id": "cousins", "t": "do you visit your cousins?", "words": ["When", "Why", "How"], "asks": "visiting the cousins"},
                  {"id": "help", "t": "do you help at home?", "words": ["How", "When", "Why"], "asks": "helping at home"},
              ],
              "rounds": [
                  {"want": "which people live in Omar's house", "pic": "\U0001F3E0", "word": "Who", "end": "lives", "why": "Who asks for people."},
                  {"want": "what Nora's family does on Sundays", "pic": "\U0001F4C5", "word": "What", "end": "sunday", "why": "What asks for a thing they do."},
        ...
        step("sort", "Good listening?", "\U0001F442", "Listening judge", ["1Ml.01"],
             ...
             {"ask": "Good listening, or not?",
              ...
              "items": [
                  ...
                  {"pic": "\U0001F9D8", "label": "sitting still", "bin": "good", "why": "Sitting still helps you hear."},
        ...
        step("questions", "Talking and listening", "\U0001F4AC", "Talk judge", ["1Mi.01", "1Ml.01"],
             ...
             {"label": "Question", "items": [
                 q("Amal said she has a baby brother called Yusuf. Which question is about what she said?", "\U0001F476", "What does Yusuf like to play with?", ["What is your favourite colour?", "Do you have a dog?"], "Yusuf is what she talked about."),
                 q("Nora asks: who lives in your house? Which answer tells her?", "\U0001F3E0", "My mum, my dad and my brother.", ["My house has a red door.", "I like ice cream."], "She asked WHO. The people are the answer."),
        ...
        step("quiz", "Show what you know", "⭐", "Star listener", ["1Mi.01", "1Ml.01", "1Rq.01"],
             ...
             {"items": [
                 ...
                 q("Omar asks what your family does on Saturdays. Which answer?", "\U0001F3DE️", "We go to the park and have a picnic.", ["My dad is tall.", "I have a blue bag.", "It is sunny."], "He asked about Saturdays."),
                 ...
                 q("Teacher Yasmin asks who helps you at home. Which answer?", "\U0001F64B", "My big sister helps me read.", ["My favourite colour is green.", "We have a goldfish.", "I am five."], "She asked WHO helps."),
...
LESSON["about"] = [
    ...
    "Answer a question about your family with the information that was asked for.",
...
LESSON["lecture"] = [
    ...
    part("\U0001F5E3️", "Answer what was asked",
         "When it is your turn to talk, answer what was asked. Who lives in your house? My mum, my dad and my brother. Not: my house has a red door. That is true, but it is not who."),
...
LESSON["words"] = [
    ...
    word("answer", "\U0001F5E3️", "What you say back to a question.",
         ["Give an answer about your family.", "Nora's answer was about the people in her house."]),

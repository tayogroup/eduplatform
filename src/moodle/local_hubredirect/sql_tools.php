...
<main class="pqhst-shell">
  <div class="pqhst-wrap">
    <section class="pqhst-top pqh-workspace-top">
      <div>
        <p class="pqhst-kicker">Admin SQL Tools</p>
        <h1 class="pqhst-title pqh-workspace-title">SQL Tools</h1>
        <p class="pqhst-sub pqh-workspace-sub">QA step configuration and non-production cleanup SQL. Production step progress cleanup is blocked.</p>
      </div>
    ...
    <section class="pqhst-card" aria-label="QA step configuration">
      <div class="pqhst-head pqh-workspace-top">
        <div>

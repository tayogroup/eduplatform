// Tashdeed With Haroof Unit - Unit Authoring Config
// ------------------------------------------------------------
// This template is the preferred seed for cloned units.
// Keep it neutral: no source-unit content, no unit-specific media maps,
// and no hardcoded lesson assets outside tashdeed-with-haroof placeholders.
...
const UNIT_CFG = __PQ_NORMALIZE_UNIT_CONFIG__.normalize({
  ...
  identity: {
    lessonId: 'tajweed',
    unitId: 'tashdeed_with_haroof_listen',
    unitKey: 'tashdeed-with-haroof',
    storagePrefix: 'tashdeed_with_haroof_listen',
    keyPrefix: 'twh_'
  },

  moodle: {
    wsGetFunction: 'local_prequran_get_tashdeed_with_haroof_listen_state',
    wsSetFunction: 'local_prequran_set_tashdeed_with_haroof_listen_state'
  },

  release: {
    version: '1.0.0',
    assetVersion: 'tashdeed-haroof-rules-20260601a'
  },
  ...
  assets: {
       "cdnRoot": "/pre_quraan",
       "unitMediaRoot": "/lessons/tashdeed-with-haroof/media",
       "filePrefix": "twh_",
       "mediaPadWidth": 2,
       "audioExt": ".mp3",
       "soundAudioExt": ".mp3",
       "videoFilePrefix": "twh_"
     },
  ...
  match: {
       "messages": {
         "entry": {
           "lecture": {
             "text": "Welcome to the Tashdeed With Haroof unit. Click Play Lecture and listen carefully before you begin."
           },
           "listen1": {
             "text": "Listen 1 is ready. Listen carefully to each Tashdeed With Haroof phrase."
           },
           "listen2": {
             "text": "Listen 2 is ready. Listen again and focus on the haroof maddah with shaddah."
           },
           "listen3": {
         ...
         "completion": {
           "listen3": {
             "text": "Congratulations. You have completed the Tashdeed With Haroof unit."
           }
         }
       }
     },
  ...
  messages: {
    base: '/pre_quraan/messages/unit_steps/tashdeed-with-haroof/',
    manifest: './unit.messages.js',
    version: 'tashdeed-with-haroof-messages-v0.1.0',
    entry: {},
    entryPasses: {},
    completion: {}
  },
  ...
  media: {
       "audioBase": "/pre_quraan/lessons/tashdeed-with-haroof/media/audio/male/",
       "l6Base": "/pre_quraan/lessons/tashdeed-with-haroof/media/audio/male/",
       "fallbackAudioBase": "/pre_quraan/lessons/tashdeed-with-haroof/media/audio/male/",
       "watchBase": "tashdeed-with-haroof-video-not-provided/",
       "fallbackWatchBase": "tashdeed-with-haroof-video-not-provided/",
       "lectureUrl": "/pre_quraan/messages/lectures/tashdeed-with-haroof_lecture.mp4",
       "voiceBases": {
         "child_boy": "/pre_quraan/lessons/tashdeed-with-haroof/media/audio/male/",
         "child_girl": "",
         "adult_male": "/pre_quraan/lessons/tashdeed-with-haroof/media/audio/male/",
         "adult_female": ""
       }
     },
  ...
  write: {
    ...
    minPassesRequired: 1,
    adapter: {
      unitKey: 'tashdeed_with_haroof_listen',
      buttonId: 'btnTrace',
      displayLabel: 'Write'
    },
    canvas: {
  ...
  listenPlus: {
    enabled: false,
    imageBase: '/pre_quraan/lessons/tashdeed-with-haroof/media/listen_plus/animals/images/',
    audioBase: '/pre_quraan/lessons/tashdeed-with-haroof/media/listen_plus/animals/audio/',
    imageExt: '.png',
    audioExt: '.mp3',
    title: 'Listen+',
  ...
  words: {
    enabled: false,
    imageBase: '/pre_quraan/lessons/tashdeed-with-haroof/media/words/images/',
    audioBase: '/pre_quraan/lessons/tashdeed-with-haroof/media/words/audio/',
    imageExt: '.png',
    audioExt: '.mp3',
    title: 'Words',
  ...
  ui: {
      "pageTitle": "PQ Unit - Tashdeed With Haroof Unit",
      "headerTitle": "Tashdeed With Haroof Unit",
      "aboutLabel": "About Tashdeed With Haroof",
  ...
  content: {
    items: [
      {"key":"twh_1","text":"ضَآلًّا","row":1,"displayCol":1,"audio":"twh_01.mp3","video":"twh_01.mp4"},
      {"key":"twh_2","text":"دَابَّةً","row":1,"displayCol":2,"audio":"twh_02.mp3","video":"twh_02.mp4"},
      {"key":"twh_3","text":"حَاجَّكَ","row":1,"displayCol":3,"audio":"twh_03.mp3","video":"twh_03.mp4"},
      {"key":"twh_4","text":"حَاجُّوكَ","row":1,"displayCol":4,"audio":"twh_04.mp3","video":"twh_04.mp4"},
      {"key":"twh_5","text":"لَضَالُّونَ","row":2,"displayCol":1,"audio":"twh_05.mp3","video":"twh_05.mp4"},
      {"key":"twh_6","text":"وَلَا الضَّالِّينَ","row":2,"displayCol":2,"audio":"twh_06.mp3","video":"twh_06.mp4"},
      {"key":"twh_7","text":"أَتُحَاجُّونِّي","row":2,"displayCol":3,"audio":"twh_07.mp3","video":"twh_07.mp4"},
      {"key":"twh_8","text":"وَلَا تَحَاضُّونَ","row":3,"displayCol":1,"audio":"twh_08.mp3","video":"twh_08.mp4"},
      {"key":"twh_9","text":"وَالصَّافَّاتِ","row":3,"displayCol":2,"audio":"twh_09.mp3","video":"twh_09.mp4"},
      {"key":"twh_10","text":"جَاءَتْ","row":3,"displayCol":3,"audio":"twh_10.mp3","video":"twh_10.mp4"},
      {"key":"twh_11","text":"الصَّاخَّةُ","row":4,"displayCol":1,"audio":"twh_11.mp3","video":"twh_11.mp4"},
      {"key":"twh_12","text":"فَإِذَا جَاءَتِ الطَّامَّةُ","row":4,"displayCol":2,"audio":"twh_12.mp3","video":"twh_12.mp4"},
      {"key":"twh_13","text":"الْكُبْرَىٰ","row":5,"displayCol":1,"audio":"twh_13.mp3","video":"twh_13.mp4"}
    ]
  }
});

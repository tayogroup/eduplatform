# Brief: the Grade 4 Mathematics unit lecture films
...
| file | what it is |
| --- | --- |
| `src/prototypes/ehel-academy/mathematics/grade-4-app/lecture-video/<slug>.json` | the storyboard: the script and its cues |
| `tools/lib/film-scenes/math-g4/<slug>.js` | your pictures (more parts if needed: `<slug>-2.js`, `<slug>-3.js`) |
...
**`src/prototypes/ehel-academy/mathematics/grade-4-app/add-lesson-opener.py`** — your lesson's entry has
...
read the lesson page itself — `src/prototypes/ehel-academy/mathematics/grade-4-app/<slug>.html` — for the examples,
...
```json
{
  "_comment": "Storyboard for the Grade 4 Mathematics unit lecture film, <Title>. Rendered by tools/create-ehel-unit-lecture.js. See lecture-video/BRIEF.md.",
  "slug": "<slug>",
  "lesson": N,
  "grade": 4,
  "stage": 4,
  "title": "<the lesson's title, exactly as app.config.json has it>",
  "subtitle": "Grade 4 Mathematics",
  "framework": "Cambridge Primary Mathematics 0096",
  "renderer": {
    "art": ["math"],
    "skin": "brown",
    "scenes": ["tools/lib/ehel-film-marks.js", "tools/lib/film-scenes/math-g4/<slug>.js"]
  },
...
```bash
T="node tools/create-ehel-unit-lecture.js --app src/prototypes/ehel-academy/mathematics/grade-4-app --slug <slug>"
...
```bash
node tools/check-ehel-film-cues.js mathematics 4
```

...
LESSON = {
    ...
    "blurb": "Hear where the word bug came from, run programs that go wrong, find the block that is the bug, fix it and run it again, and hunt bugs in everyday algorithms too.",
    "steps": [
        step("demo", "The first bug", "\U0001F41B", "The first bug", ["1P.04", "1P.07"],
             "Where does the word bug come from? Press <b>Next</b> and find out.",
             explain(
                 ["A program can have a mistake in it.", "A mistake in a program is called a bug.", "Fixing bugs is called debugging."],
                 ["Long ago, a computer was as big as a room.", "One day it stopped working.", "Inside, the programmers found a real insect stuck in the machine.",
                  "They called it a bug, and the name stuck."],
                 ["Children think a bug means the computer is broken.", "Usually the computer is fine. The PROGRAM has a mistake in it."],
                 ["Press Next and meet the first bug."]),
             {"frames": [
                 ...
                 {"pic": "\U0001F41B", "cap": "Inside, they found a real <b>insect</b> stuck in the machine!", "say": "Inside, the programmers found a real insect stuck in the machine. A moth. A bug!", "sound": "pop"},
                 {"pic": "\U0001F4DD\U0001F41B", "cap": "Ever since, a mistake in a program is called a <b>bug</b>.", "say": "Ever since then, a mistake in a program has been called a bug."},
        ...
        step("context", "Real programmers debug", "\U0001F469‍\U0001F4BB", "Real debuggers", ["1P.07", "1P.04"],
             ...
             {"items": [
                 ...
                 {"pic": "\U0001F680", "label": "a rocket", "say": "A rocket's programs are tested hundreds of times before launch, because a bug up there cannot be fixed later."},
             ], "need": 4,
        ...
        step("quiz", "Show what you know", "⭐", "Star computer scientist", ["1P.04", "1P.05", "1P.06", "1P.07"],
             ...
             {"items": [
                 ...
                 q("Where did the word bug come from?", "\U0001F3E2", "a real insect found inside an old computer", ["a bug-shaped button", "a programmer called Bug", "nobody knows"], "A real insect was found stuck in a room-sized computer."),
...
LESSON["lecture"] = [
    part("\U0001F41B", "The first bug",
         "Long ago a computer was as big as a room. One day it stopped working, and inside it the programmers found a real insect. They called it a bug. Ever since, a mistake in a program has been called a bug."),
